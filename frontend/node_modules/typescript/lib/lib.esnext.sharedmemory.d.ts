...
interface***REMOVED***Atomics***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***/**
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*******REMOVED***Performs***REMOVED***a***REMOVED***finite-time***REMOVED***microwait***REMOVED***by***REMOVED***signaling***REMOVED***to***REMOVED***the***REMOVED***operating***REMOVED***system***REMOVED***or
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*******REMOVED***CPU***REMOVED***that***REMOVED***the***REMOVED***current***REMOVED***executing***REMOVED***code***REMOVED***is***REMOVED***in***REMOVED***a***REMOVED***spin-wait***REMOVED***loop.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED****/
***REMOVED******REMOVED******REMOVED******REMOVED***pause(n?:***REMOVED***number):***REMOVED***void;
}
