...
interface***REMOVED***RegExpMatchArray***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***indices?:***REMOVED***RegExpIndicesArray;
}

interface***REMOVED***RegExpExecArray***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***indices?:***REMOVED***RegExpIndicesArray;
}

interface***REMOVED***RegExpIndicesArray***REMOVED***extends***REMOVED***Array<[number,***REMOVED***number]>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***groups?:***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***[key:***REMOVED***string]:***REMOVED***[number,***REMOVED***number];
***REMOVED******REMOVED******REMOVED******REMOVED***};
}

interface***REMOVED***RegExp***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***/**
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*******REMOVED***Returns***REMOVED***a***REMOVED***Boolean***REMOVED***value***REMOVED***indicating***REMOVED***the***REMOVED***state***REMOVED***of***REMOVED***the***REMOVED***hasIndices***REMOVED***flag***REMOVED***(d)***REMOVED***used***REMOVED***with***REMOVED***a***REMOVED***regular***REMOVED***expression.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*******REMOVED***Default***REMOVED***is***REMOVED***false.***REMOVED***Read-only.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED****/
***REMOVED******REMOVED******REMOVED******REMOVED***readonly***REMOVED***hasIndices:***REMOVED***boolean;
}
