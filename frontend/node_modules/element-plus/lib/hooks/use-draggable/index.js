...
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***isDragging***REMOVED***=***REMOVED***vue.ref(false);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***targetRef.value.style.transform***REMOVED***=***REMOVED***`translate(${style.addUnit(moveX)},***REMOVED***${style.addUnit(moveY)})`;
...
***REMOVED******REMOVED******REMOVED******REMOVED***vue.watchEffect(()***REMOVED***=>***REMOVED***{
