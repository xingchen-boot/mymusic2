...
var***REMOVED***buildList***REMOVED***=***REMOVED***require('../builders/build-list.js');
...
const***REMOVED***DynamicSizeList***REMOVED***=***REMOVED***buildList["default"]({
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***size***REMOVED***=***REMOVED***utils.isHorizontal(layout)***REMOVED***?***REMOVED***width***REMOVED***:***REMOVED***height;
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(alignment***REMOVED***===***REMOVED***defaults.SMART_ALIGNMENT)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***alignment***REMOVED***=***REMOVED***defaults.AUTO_ALIGNMENT;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***alignment***REMOVED***=***REMOVED***defaults.CENTERED_ALIGNMENT;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***switch***REMOVED***(alignment)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***case***REMOVED***defaults.START_ALIGNMENT:***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***maxOffset;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***case***REMOVED***defaults.END_ALIGNMENT:***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***minOffset;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***case***REMOVED***defaults.CENTERED_ALIGNMENT:***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***case***REMOVED***defaults.AUTO_ALIGNMENT:
...
***REMOVED******REMOVED***},
***REMOVED******REMOVED***initCache({***REMOVED***estimatedItemSize***REMOVED***=***REMOVED***defaults.DEFAULT_DYNAMIC_LIST_ITEM_SIZE***REMOVED***},***REMOVED***instance)***REMOVED***{
...
exports["default"]***REMOVED***=***REMOVED***DynamicSizeList;
//#***REMOVED***sourceMappingURL=dynamic-size-list.js.map
