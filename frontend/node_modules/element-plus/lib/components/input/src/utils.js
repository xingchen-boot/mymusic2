...
***REMOVED******REMOVED***overflow:***REMOVED***browser.isFirefox()***REMOVED***?***REMOVED***""***REMOVED***:***REMOVED***"hidden",
...
***REMOVED******REMOVED***if***REMOVED***(types.isNumber(minRows))***REMOVED***{
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(types.isNumber(maxRows))***REMOVED***{
...
exports.calcTextareaHeight***REMOVED***=***REMOVED***calcTextareaHeight;
