...
var***REMOVED***browser***REMOVED***=***REMOVED***require('../../../utils/browser.js');
...
***REMOVED******REMOVED***const***REMOVED***prefixArray***REMOVED***=***REMOVED***lodashUnified.castArray(prefix);
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***});
***REMOVED******REMOVED***if***REMOVED***(browser.isFirefox())***REMOVED***{
...
exports.filterOption***REMOVED***=***REMOVED***filterOption;
exports.getCursorPosition***REMOVED***=***REMOVED***getCursorPosition;
exports.getMentionCtx***REMOVED***=***REMOVED***getMentionCtx;
