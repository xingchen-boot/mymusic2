...
var***REMOVED***useProps***REMOVED***=***REMOVED***require('./useProps.js');

function***REMOVED***useAllowCreate(props,***REMOVED***states)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***aliasProps,***REMOVED***getLabel,***REMOVED***getValue***REMOVED***}***REMOVED***=***REMOVED***useProps.useProps(props);
***REMOVED******REMOVED***const***REMOVED***createOptionCount***REMOVED***=***REMOVED***vue.ref(0);
***REMOVED******REMOVED***const***REMOVED***cachedSelectedOption***REMOVED***=***REMOVED***vue.ref();
***REMOVED******REMOVED***const***REMOVED***enableAllowCreateMode***REMOVED***=***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***props.allowCreate***REMOVED***&&***REMOVED***props.filterable;
***REMOVED******REMOVED***});
***REMOVED******REMOVED***vue.watch(()***REMOVED***=>***REMOVED***props.options,***REMOVED***(options)***REMOVED***=>***REMOVED***{
...
exports.useAllowCreate***REMOVED***=***REMOVED***useAllowCreate;
//#***REMOVED***sourceMappingURL=useAllowCreate.js.map
