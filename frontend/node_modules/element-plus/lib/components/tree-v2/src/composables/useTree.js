...
var***REMOVED***useCheck***REMOVED***=***REMOVED***require('./useCheck.js');
var***REMOVED***useFilter***REMOVED***=***REMOVED***require('./useFilter.js');
var***REMOVED***shared***REMOVED***=***REMOVED***require('@vue/shared');

function***REMOVED***useTree(props,***REMOVED***emit)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***expandedKeySet***REMOVED***=***REMOVED***vue.ref(/****REMOVED***@__PURE__***REMOVED****/***REMOVED***new***REMOVED***Set());
***REMOVED******REMOVED***const***REMOVED***currentKey***REMOVED***=***REMOVED***vue.ref();
***REMOVED******REMOVED***const***REMOVED***tree***REMOVED***=***REMOVED***vue.shallowRef();
***REMOVED******REMOVED***const***REMOVED***listRef***REMOVED***=***REMOVED***vue.ref();
...
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***useCheck.useCheck(props,***REMOVED***tree);
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***doFilter,***REMOVED***hiddenNodeKeySet,***REMOVED***isForceHiddenExpandIcon***REMOVED***}***REMOVED***=***REMOVED***useFilter.useFilter(props,***REMOVED***tree);
***REMOVED******REMOVED***const***REMOVED***valueKey***REMOVED***=***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***((_a***REMOVED***=***REMOVED***props.props)***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_a.value)***REMOVED***||***REMOVED***virtualTree.TreeOptionsEnum.KEY;
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***childrenKey***REMOVED***=***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***((_a***REMOVED***=***REMOVED***props.props)***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_a.children)***REMOVED***||***REMOVED***virtualTree.TreeOptionsEnum.CHILDREN;
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***disabledKey***REMOVED***=***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***((_a***REMOVED***=***REMOVED***props.props)***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_a.disabled)***REMOVED***||***REMOVED***virtualTree.TreeOptionsEnum.DISABLED;
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***labelKey***REMOVED***=***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***((_a***REMOVED***=***REMOVED***props.props)***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_a.label)***REMOVED***||***REMOVED***virtualTree.TreeOptionsEnum.LABEL;
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***flattenTree***REMOVED***=***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
...
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***isNotEmpty***REMOVED***=***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***emit(virtualTree.NODE_CLICK,***REMOVED***node.data,***REMOVED***node,***REMOVED***e);
...
***REMOVED******REMOVED******REMOVED******REMOVED***emit(virtualTree.NODE_DROP,***REMOVED***node.data,***REMOVED***node,***REMOVED***e);
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***emit(virtualTree.CURRENT_CHANGE,***REMOVED***node.data,***REMOVED***node);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***emit(virtualTree.NODE_EXPAND,***REMOVED***node.data,***REMOVED***node);
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***emit(virtualTree.NODE_COLLAPSE,***REMOVED***node.data,***REMOVED***node);
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***key***REMOVED***=***REMOVED***shared.isObject(data)***REMOVED***?***REMOVED***getKey(data)***REMOVED***:***REMOVED***data;
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***vue.watch(()***REMOVED***=>***REMOVED***props.currentNodeKey,***REMOVED***(key)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***currentKey.value***REMOVED***=***REMOVED***key;
***REMOVED******REMOVED***},***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***immediate:***REMOVED***true
***REMOVED******REMOVED***});
***REMOVED******REMOVED***vue.watch(()***REMOVED***=>***REMOVED***props.defaultExpandedKeys,***REMOVED***(key)***REMOVED***=>***REMOVED***{
...
//#***REMOVED***sourceMappingURL=useTree.js.map
