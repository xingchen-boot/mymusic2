import***REMOVED***{***REMOVED***ref,***REMOVED***onMounted,***REMOVED***onBeforeUnmount***REMOVED***}***REMOVED***from***REMOVED***'vue';
import***REMOVED***{***REMOVED***FOCUSOUT_PREVENTED,***REMOVED***FOCUSOUT_PREVENTED_OPTS***REMOVED***}***REMOVED***from***REMOVED***'./tokens.mjs';
import***REMOVED***{***REMOVED***focusElement***REMOVED***}***REMOVED***from***REMOVED***'../../../utils/dom/aria.mjs';

const***REMOVED***focusReason***REMOVED***=***REMOVED***ref();
const***REMOVED***lastUserFocusTimestamp***REMOVED***=***REMOVED***ref(0);
const***REMOVED***lastAutomatedFocusTimestamp***REMOVED***=***REMOVED***ref(0);
...
***REMOVED******REMOVED******REMOVED******REMOVED***focusElement(element,***REMOVED***{***REMOVED***preventScroll:***REMOVED***true***REMOVED***});
...
***REMOVED******REMOVED***return***REMOVED***new***REMOVED***CustomEvent(FOCUSOUT_PREVENTED,***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***...FOCUSOUT_PREVENTED_OPTS,
***REMOVED******REMOVED******REMOVED******REMOVED***detail
***REMOVED******REMOVED***});
};

export***REMOVED***{***REMOVED***createFocusOutPreventedEvent,***REMOVED***focusFirstDescendant,***REMOVED***focusableStack,***REMOVED***getEdges,***REMOVED***getVisibleElement,***REMOVED***isFocusCausedByUserEvent,***REMOVED***isHidden,***REMOVED***obtainAllFocusableElements,***REMOVED***tryFocus,***REMOVED***useFocusReason***REMOVED***};
