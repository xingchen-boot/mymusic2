...
***REMOVED******REMOVED***return***REMOVED***isNumber(value)***REMOVED***?***REMOVED***new***REMOVED***Date(value).getTime()***REMOVED***:***REMOVED***value.valueOf();
};
...
export***REMOVED***{***REMOVED***formatTime,***REMOVED***getTime***REMOVED***};
