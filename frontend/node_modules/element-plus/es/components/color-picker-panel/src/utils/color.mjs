...
import***REMOVED***{***REMOVED***hasOwn***REMOVED***}***REMOVED***from***REMOVED***'@vue/shared';

class***REMOVED***Color***REMOVED***{
***REMOVED******REMOVED***constructor(options***REMOVED***=***REMOVED***{})***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***this._hue***REMOVED***=***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED***this._saturation***REMOVED***=***REMOVED***100;
***REMOVED******REMOVED******REMOVED******REMOVED***this._value***REMOVED***=***REMOVED***100;
***REMOVED******REMOVED******REMOVED******REMOVED***this._alpha***REMOVED***=***REMOVED***100;
***REMOVED******REMOVED******REMOVED******REMOVED***this._tiny***REMOVED***=***REMOVED***new***REMOVED***TinyColor();
***REMOVED******REMOVED******REMOVED******REMOVED***this._isValid***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED***this.enableAlpha***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED***this.format***REMOVED***=***REMOVED***"";
***REMOVED******REMOVED******REMOVED******REMOVED***this.value***REMOVED***=***REMOVED***"";
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***set(prop,***REMOVED***value)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***this[`_${prop}`]***REMOVED***=***REMOVED***value;
***REMOVED******REMOVED******REMOVED******REMOVED***this._isValid***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED***this.doOnChange();
***REMOVED******REMOVED***}
***REMOVED******REMOVED***get(prop)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(["hue",***REMOVED***"saturation",***REMOVED***"value",***REMOVED***"alpha"].includes(prop))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***Math.round(this[`_${prop}`]);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***this[`_${prop}`];
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***fromString(value)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***this.doOnChange();
***REMOVED******REMOVED***}
***REMOVED******REMOVED***compare(color)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***this.value***REMOVED***=***REMOVED***this._isValid***REMOVED***?***REMOVED***this._tiny.toString(_format)***REMOVED***:***REMOVED***"";
***REMOVED******REMOVED***}
}

export***REMOVED***{***REMOVED***Color***REMOVED***as***REMOVED***default***REMOVED***};
//#***REMOVED***sourceMappingURL=color.mjs.map
