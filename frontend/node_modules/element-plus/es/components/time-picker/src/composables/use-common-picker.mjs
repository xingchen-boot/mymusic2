...
import***REMOVED***{***REMOVED***valueEquals,***REMOVED***formatter,***REMOVED***parseDate,***REMOVED***dayOrDaysToDate***REMOVED***}***REMOVED***from***REMOVED***'../utils.mjs';
...
***REMOVED******REMOVED***const***REMOVED***pickerVisible***REMOVED***=***REMOVED***ref(false);
***REMOVED******REMOVED***const***REMOVED***pickerActualVisible***REMOVED***=***REMOVED***ref(false);
***REMOVED******REMOVED***const***REMOVED***userInput***REMOVED***=***REMOVED***ref(null);
***REMOVED******REMOVED***const***REMOVED***valueIsEmpty***REMOVED***=***REMOVED***computed(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***modelValue***REMOVED***}***REMOVED***=***REMOVED***props;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***!modelValue***REMOVED***||***REMOVED***isArray(modelValue)***REMOVED***&&***REMOVED***!modelValue.filter(Boolean).length;
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***emitInput***REMOVED***=***REMOVED***(input)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!valueEquals(props.modelValue,***REMOVED***input))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***formatted;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isArray(input))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***formatted***REMOVED***=***REMOVED***input.map((item)***REMOVED***=>***REMOVED***formatter(item,***REMOVED***props.valueFormat,***REMOVED***lang.value));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(input)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***formatted***REMOVED***=***REMOVED***formatter(input,***REMOVED***props.valueFormat,***REMOVED***lang.value);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***emit(UPDATE_MODEL_EVENT,***REMOVED***emitVal,***REMOVED***lang.value);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***parsedValue***REMOVED***=***REMOVED***computed(()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isArray(props.modelValue))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***dayOrDays***REMOVED***=***REMOVED***props.modelValue.map((d)***REMOVED***=>***REMOVED***parseDate(d,***REMOVED***props.valueFormat,***REMOVED***lang.value));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***dayOrDays***REMOVED***=***REMOVED***parseDate((_a***REMOVED***=***REMOVED***props.modelValue)***REMOVED***!=***REMOVED***null***REMOVED***?***REMOVED***_a***REMOVED***:***REMOVED***"",***REMOVED***props.valueFormat,***REMOVED***lang.value);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!isEqual(availableResult,***REMOVED***dayOrDays))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***emitInput(dayOrDaysToDate(dayOrDays));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isArray(dayOrDays)***REMOVED***&&***REMOVED***dayOrDays.some((day)***REMOVED***=>***REMOVED***!day))***REMOVED***{
...
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***pickerOptions***REMOVED***=***REMOVED***ref({});
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isArray(date))***REMOVED***{
...
export***REMOVED***{***REMOVED***useCommonPicker***REMOVED***};
//#***REMOVED***sourceMappingURL=use-common-picker.mjs.map
