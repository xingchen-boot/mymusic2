import***REMOVED***{***REMOVED***ref,***REMOVED***getCurrentInstance,***REMOVED***watch,***REMOVED***nextTick***REMOVED***}***REMOVED***from***REMOVED***'vue';
import***REMOVED***{***REMOVED***NODE_CHECK,***REMOVED***NODE_CHECK_CHANGE,***REMOVED***SetOperationEnum***REMOVED***}***REMOVED***from***REMOVED***'../virtual-tree.mjs';

function***REMOVED***useCheck(props,***REMOVED***tree)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***checkedKeys***REMOVED***=***REMOVED***ref(/****REMOVED***@__PURE__***REMOVED****/***REMOVED***new***REMOVED***Set());
***REMOVED******REMOVED***const***REMOVED***indeterminateKeys***REMOVED***=***REMOVED***ref(/****REMOVED***@__PURE__***REMOVED****/***REMOVED***new***REMOVED***Set());
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***emit***REMOVED***}***REMOVED***=***REMOVED***getCurrentInstance();
***REMOVED******REMOVED***watch([()***REMOVED***=>***REMOVED***tree.value,***REMOVED***()***REMOVED***=>***REMOVED***props.defaultCheckedKeys],***REMOVED***()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***checkedKeySet[checked***REMOVED***?***REMOVED***SetOperationEnum.ADD***REMOVED***:***REMOVED***SetOperationEnum.DELETE](node2.key);
...
//#***REMOVED***sourceMappingURL=useCheck.mjs.map
