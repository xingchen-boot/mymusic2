...
import***REMOVED***{***REMOVED***useVModel***REMOVED***}***REMOVED***from***REMOVED***'@vueuse/core';
import***REMOVED***{***REMOVED***genFileId***REMOVED***}***REMOVED***from***REMOVED***'./upload.mjs';
import***REMOVED***{***REMOVED***debugWarn,***REMOVED***throwError***REMOVED***}***REMOVED***from***REMOVED***'../../../utils/error.mjs';
...
***REMOVED******REMOVED***const***REMOVED***uploadFiles***REMOVED***=***REMOVED***useVModel(props,***REMOVED***"fileList",***REMOVED***void***REMOVED***0,***REMOVED***{***REMOVED***passive:***REMOVED***true***REMOVED***});
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isNil(file.uid))
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***file.uid***REMOVED***=***REMOVED***genFileId();
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***debugWarn(SCOPE,***REMOVED***err.message);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***throwError(SCOPE,***REMOVED***"file***REMOVED***to***REMOVED***be***REMOVED***removed***REMOVED***not***REMOVED***found");
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED***}
***REMOVED******REMOVED***watch(()***REMOVED***=>***REMOVED***props.listType,***REMOVED***(val)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED***});
***REMOVED******REMOVED***watch(uploadFiles,***REMOVED***(files)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(const***REMOVED***file***REMOVED***of***REMOVED***files)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***file.uid***REMOVED***||***REMOVED***(file.uid***REMOVED***=***REMOVED***genFileId());
...
export***REMOVED***{***REMOVED***useHandlers***REMOVED***};
//#***REMOVED***sourceMappingURL=use-handlers.mjs.map
