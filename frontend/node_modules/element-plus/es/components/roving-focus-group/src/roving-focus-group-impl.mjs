import***REMOVED***{***REMOVED***defineComponent,***REMOVED***ref,***REMOVED***inject,***REMOVED***computed,***REMOVED***provide,***REMOVED***readonly,***REMOVED***toRef,***REMOVED***unref,***REMOVED***watch,***REMOVED***renderSlot***REMOVED***}***REMOVED***from***REMOVED***'vue';
import***REMOVED***{***REMOVED***useEventListener***REMOVED***}***REMOVED***from***REMOVED***'@vueuse/core';
import***REMOVED***{***REMOVED***rovingFocusGroupProps,***REMOVED***ROVING_FOCUS_COLLECTION_INJECTION_KEY***REMOVED***as***REMOVED***COLLECTION_INJECTION_KEY***REMOVED***}***REMOVED***from***REMOVED***'./roving-focus-group.mjs';
import***REMOVED***{***REMOVED***ROVING_FOCUS_GROUP_INJECTION_KEY***REMOVED***}***REMOVED***from***REMOVED***'./tokens.mjs';
import***REMOVED***{***REMOVED***focusFirst***REMOVED***}***REMOVED***from***REMOVED***'./utils.mjs';
import***REMOVED***_export_sfc***REMOVED***from***REMOVED***'../../../_virtual/plugin-vue_export-helper.mjs';
import***REMOVED***{***REMOVED***composeEventHandlers***REMOVED***}***REMOVED***from***REMOVED***'../../../utils/dom/event.mjs';
...
***REMOVED******REMOVED***props:***REMOVED***rovingFocusGroupProps,
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***currentTabbedId***REMOVED***=***REMOVED***ref((_a***REMOVED***=***REMOVED***props.currentTabId***REMOVED***||***REMOVED***props.defaultCurrentTabId)***REMOVED***!=***REMOVED***null***REMOVED***?***REMOVED***_a***REMOVED***:***REMOVED***null);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isBackingOut***REMOVED***=***REMOVED***ref(false);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isClickFocus***REMOVED***=***REMOVED***ref(false);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***rovingFocusGroupRef***REMOVED***=***REMOVED***ref();
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***getItems***REMOVED***}***REMOVED***=***REMOVED***inject(COLLECTION_INJECTION_KEY,***REMOVED***void***REMOVED***0);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***rovingFocusGroupRootStyle***REMOVED***=***REMOVED***computed(()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***onMousedown***REMOVED***=***REMOVED***composeEventHandlers((e)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***onFocus***REMOVED***=***REMOVED***composeEventHandlers((e)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a2;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isKeyboardFocus***REMOVED***=***REMOVED***!unref(isClickFocus);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(target***REMOVED***===***REMOVED***currentTarget***REMOVED***&&***REMOVED***isKeyboardFocus***REMOVED***&&***REMOVED***!unref(isBackingOut))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***currentItem***REMOVED***=***REMOVED***items.find((item)***REMOVED***=>***REMOVED***item.id***REMOVED***===***REMOVED***unref(currentTabbedId));
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***focusFirst(candidateNodes);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***isClickFocus.value***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***onBlur***REMOVED***=***REMOVED***composeEventHandlers((e)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a2;
...
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***provide(ROVING_FOCUS_GROUP_INJECTION_KEY,***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***currentTabbedId:***REMOVED***readonly(currentTabbedId),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***loop:***REMOVED***toRef(props,***REMOVED***"loop"),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***tabIndex:***REMOVED***computed(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***unref(isBackingOut)***REMOVED***?***REMOVED***-1***REMOVED***:***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}),
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***orientation:***REMOVED***toRef(props,***REMOVED***"orientation"),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***dir:***REMOVED***toRef(props,***REMOVED***"dir"),
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***watch(()***REMOVED***=>***REMOVED***props.currentTabId,***REMOVED***(val)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***useEventListener(rovingFocusGroupRef,***REMOVED***ENTRY_FOCUS_EVT,***REMOVED***handleEntryFocus);
***REMOVED******REMOVED***}
});
function***REMOVED***_sfc_render(_ctx,***REMOVED***_cache,***REMOVED***$props,***REMOVED***$setup,***REMOVED***$data,***REMOVED***$options)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***renderSlot(_ctx.$slots,***REMOVED***"default");
}
var***REMOVED***ElRovingFocusGroupImpl***REMOVED***=***REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***_export_sfc(_sfc_main,***REMOVED***[["render",***REMOVED***_sfc_render],***REMOVED***["__file",***REMOVED***"roving-focus-group-impl.vue"]]);

export***REMOVED***{***REMOVED***ElRovingFocusGroupImpl***REMOVED***as***REMOVED***default***REMOVED***};
//#***REMOVED***sourceMappingURL=roving-focus-group-impl.mjs.map
