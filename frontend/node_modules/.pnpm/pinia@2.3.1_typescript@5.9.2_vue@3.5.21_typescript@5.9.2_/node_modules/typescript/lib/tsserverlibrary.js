...
if***REMOVED***(typeof***REMOVED***module***REMOVED***!==***REMOVED***"undefined"***REMOVED***&&***REMOVED***module.exports)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***module.exports***REMOVED***=***REMOVED***require("./typescript.js");
}
else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***throw***REMOVED***new***REMOVED***Error("tsserverlibrary***REMOVED***requires***REMOVED***CommonJS;***REMOVED***use***REMOVED***typescript.js***REMOVED***instead");
}
