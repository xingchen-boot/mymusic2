...
interface***REMOVED***ErrorConstructor***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***/**
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*******REMOVED***Indicates***REMOVED***whether***REMOVED***the***REMOVED***argument***REMOVED***provided***REMOVED***is***REMOVED***a***REMOVED***built-in***REMOVED***Error***REMOVED***instance***REMOVED***or***REMOVED***not.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED****/
***REMOVED******REMOVED******REMOVED******REMOVED***isError(error:***REMOVED***unknown):***REMOVED***error***REMOVED***is***REMOVED***Error;
}
