...
interface***REMOVED***String***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***/**
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*******REMOVED***Returns***REMOVED***true***REMOVED***if***REMOVED***all***REMOVED***leading***REMOVED***surrogates***REMOVED***and***REMOVED***trailing***REMOVED***surrogates***REMOVED***appear***REMOVED***paired***REMOVED***and***REMOVED***in***REMOVED***order.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED****/
***REMOVED******REMOVED******REMOVED******REMOVED***isWellFormed():***REMOVED***boolean;

***REMOVED******REMOVED******REMOVED******REMOVED***/**
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*******REMOVED***Returns***REMOVED***a***REMOVED***string***REMOVED***where***REMOVED***all***REMOVED***lone***REMOVED***or***REMOVED***out-of-order***REMOVED***surrogates***REMOVED***have***REMOVED***been***REMOVED***replaced***REMOVED***by***REMOVED***the***REMOVED***Unicode***REMOVED***replacement***REMOVED***character***REMOVED***(U+FFFD).
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED****/
***REMOVED******REMOVED******REMOVED******REMOVED***toWellFormed():***REMOVED***string;
}
