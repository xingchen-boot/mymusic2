...
const***REMOVED***fs***REMOVED***=***REMOVED***require('node:fs');
const***REMOVED***vite***REMOVED***=***REMOVED***require('vite');
const***REMOVED***vue***REMOVED***=***REMOVED***require('vue');
const***REMOVED***node_module***REMOVED***=***REMOVED***require('node:module');
const***REMOVED***path***REMOVED***=***REMOVED***require('node:path');
const***REMOVED***node_crypto***REMOVED***=***REMOVED***require('node:crypto');
const***REMOVED***require$$0***REMOVED***=***REMOVED***require('tty');
const***REMOVED***require$$1***REMOVED***=***REMOVED***require('util');

var***REMOVED***_documentCurrentScript***REMOVED***=***REMOVED***typeof***REMOVED***document***REMOVED***!==***REMOVED***'undefined'***REMOVED***?***REMOVED***document.currentScript***REMOVED***:***REMOVED***null;
function***REMOVED***_interopDefaultCompat***REMOVED***(e)***REMOVED***{***REMOVED***return***REMOVED***e***REMOVED***&&***REMOVED***typeof***REMOVED***e***REMOVED***===***REMOVED***'object'***REMOVED***&&***REMOVED***'default'***REMOVED***in***REMOVED***e***REMOVED***?***REMOVED***e.default***REMOVED***:***REMOVED***e;***REMOVED***}

const***REMOVED***fs__default***REMOVED***=***REMOVED***/*#__PURE__*/_interopDefaultCompat(fs);
const***REMOVED***path__default***REMOVED***=***REMOVED***/*#__PURE__*/_interopDefaultCompat(path);
const***REMOVED***require$$0__default***REMOVED***=***REMOVED***/*#__PURE__*/_interopDefaultCompat(require$$0);
const***REMOVED***require$$1__default***REMOVED***=***REMOVED***/*#__PURE__*/_interopDefaultCompat(require$$1);
...
const***REMOVED***_require***REMOVED***=***REMOVED***node_module.createRequire((typeof***REMOVED***document***REMOVED***===***REMOVED***'undefined'***REMOVED***?***REMOVED***require('u'***REMOVED***+***REMOVED***'rl').pathToFileURL(__filename).href***REMOVED***:***REMOVED***(_documentCurrentScript***REMOVED***&&***REMOVED***_documentCurrentScript.src***REMOVED***||***REMOVED***new***REMOVED***URL('index.cjs',***REMOVED***document.baseURI).href)));
...
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***normalizedPath***REMOVED***=***REMOVED***slash(path__default.normalize(path__default.relative(root,***REMOVED***filename)));
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***code***REMOVED***??***REMOVED***fs__default.readFileSync(filename,***REMOVED***"utf-8"),
...
***REMOVED******REMOVED***return***REMOVED***node_crypto.createHash("sha256").update(text).digest("hex").substring(0,***REMOVED***8);
}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***base:***REMOVED***(options.devServer.config.server?.origin***REMOVED***??***REMOVED***"")***REMOVED***+***REMOVED***devBase***REMOVED***+***REMOVED***slash(path__default.relative(options.root,***REMOVED***path__default.dirname(filename))),
...
function***REMOVED***requireNode***REMOVED***()***REMOVED***{
	...
	(function***REMOVED***(module,***REMOVED***exports)***REMOVED***{
		const***REMOVED***tty***REMOVED***=***REMOVED***require$$0__default;
		const***REMOVED***util***REMOVED***=***REMOVED***require$$1__default;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***(m)***REMOVED***=>***REMOVED***vite.isCSSRequest(m.url)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
...
***REMOVED******REMOVED***if***REMOVED***(fs__default.existsSync(filename))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***JSON.stringify(isProduction***REMOVED***?***REMOVED***path__default.basename(filename)***REMOVED***:***REMOVED***filename)
***REMOVED******REMOVED******REMOVED******REMOVED***]);
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***normalizedFilename***REMOVED***=***REMOVED***vite.normalizePath(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***path__default.relative(options.root,***REMOVED***filename)
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***output.push(
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***code:***REMOVED***code2,***REMOVED***map***REMOVED***}***REMOVED***=***REMOVED***await***REMOVED***vite.transformWithEsbuild(
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***langFallback***REMOVED***=***REMOVED***script.src***REMOVED***&&***REMOVED***path__default.extname(src).slice(1)***REMOVED***||***REMOVED***"js";
...
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***null;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***map***REMOVED***=***REMOVED***result.map***REMOVED***?***REMOVED***await***REMOVED***vite.formatPostcssSourceMap(
...
***REMOVED******REMOVED***const***REMOVED***options***REMOVED***=***REMOVED***vue.shallowRef({
...
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***filter***REMOVED***=***REMOVED***vue.computed(
***REMOVED******REMOVED******REMOVED******REMOVED***()***REMOVED***=>***REMOVED***vite.createFilter(options.value.include,***REMOVED***options.value.exclude)
***REMOVED******REMOVED***);
***REMOVED******REMOVED***const***REMOVED***customElementFilter***REMOVED***=***REMOVED***vue.computed(
***REMOVED******REMOVED******REMOVED******REMOVED***()***REMOVED***=>***REMOVED***typeof***REMOVED***options.value.customElement***REMOVED***===***REMOVED***"boolean"***REMOVED***?***REMOVED***()***REMOVED***=>***REMOVED***options.value.customElement***REMOVED***:***REMOVED***vite.createFilter(options.value.customElement)
***REMOVED******REMOVED***);
***REMOVED******REMOVED***const***REMOVED***refTransformFilter***REMOVED***=***REMOVED***vue.computed(
***REMOVED******REMOVED******REMOVED******REMOVED***()***REMOVED***=>***REMOVED***options.value.reactivityTransform***REMOVED***===***REMOVED***false***REMOVED***?***REMOVED***()***REMOVED***=>***REMOVED***false***REMOVED***:***REMOVED***options.value.reactivityTransform***REMOVED***===***REMOVED***true***REMOVED***?***REMOVED***vite.createFilter(/\.(j|t)sx?$/,***REMOVED***/node_modules/)***REMOVED***:***REMOVED***vite.createFilter(options.value.reactivityTransform)
***REMOVED******REMOVED***);
***REMOVED******REMOVED***return***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***fs__default.readFileSync(filename,***REMOVED***"utf-8");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
module.exports***REMOVED***=***REMOVED***vuePlugin;
module.exports.default***REMOVED***=***REMOVED***vuePlugin;
module.exports.parseVueRequest***REMOVED***=***REMOVED***parseVueRequest;