...
/**
***REMOVED*******REMOVED***Gets***REMOVED***all***REMOVED***but***REMOVED***the***REMOVED***last***REMOVED***element***REMOVED***of***REMOVED***`array`.
***REMOVED****
...
***REMOVED****
***REMOVED*******REMOVED***_.initial([1,***REMOVED***2,***REMOVED***3]);
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***[1,***REMOVED***2]
***REMOVED****/
function***REMOVED***initial(array)***REMOVED***{
...
***REMOVED******REMOVED***return***REMOVED***length***REMOVED***?***REMOVED***baseSlice(array,***REMOVED***0,***REMOVED***-1)***REMOVED***:***REMOVED***[];
}

module.exports***REMOVED***=***REMOVED***initial;
