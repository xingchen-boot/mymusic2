var***REMOVED***baseSortedIndex***REMOVED***=***REMOVED***require('./_baseSortedIndex'),
***REMOVED******REMOVED******REMOVED******REMOVED***eq***REMOVED***=***REMOVED***require('./eq');

/**
***REMOVED*******REMOVED***This***REMOVED***method***REMOVED***is***REMOVED***like***REMOVED***`_.lastIndexOf`***REMOVED***except***REMOVED***that***REMOVED***it***REMOVED***performs***REMOVED***a***REMOVED***binary
...
***REMOVED****
***REMOVED*******REMOVED***_.sortedLastIndexOf([4,***REMOVED***5,***REMOVED***5,***REMOVED***5,***REMOVED***6],***REMOVED***5);
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***3
***REMOVED****/
function***REMOVED***sortedLastIndexOf(array,***REMOVED***value)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***index***REMOVED***=***REMOVED***baseSortedIndex(array,***REMOVED***value,***REMOVED***true)***REMOVED***-***REMOVED***1;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(eq(array[index],***REMOVED***value))***REMOVED***{
...
module.exports***REMOVED***=***REMOVED***sortedLastIndexOf;
