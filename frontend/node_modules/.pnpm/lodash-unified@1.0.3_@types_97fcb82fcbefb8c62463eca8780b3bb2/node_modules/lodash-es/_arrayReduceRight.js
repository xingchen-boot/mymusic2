/**
***REMOVED*******REMOVED***A***REMOVED***specialized***REMOVED***version***REMOVED***of***REMOVED***`_.reduceRight`***REMOVED***for***REMOVED***arrays***REMOVED***without***REMOVED***support***REMOVED***for
...
***REMOVED*******REMOVED***@param***REMOVED***{boolean}***REMOVED***[initAccum]***REMOVED***Specify***REMOVED***using***REMOVED***the***REMOVED***last***REMOVED***element***REMOVED***of***REMOVED***`array`***REMOVED***as
...
***REMOVED****/
function***REMOVED***arrayReduceRight(array,***REMOVED***iteratee,***REMOVED***accumulator,***REMOVED***initAccum)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***accumulator***REMOVED***=***REMOVED***array[--length];
***REMOVED******REMOVED***}
***REMOVED******REMOVED***while***REMOVED***(length--)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***accumulator***REMOVED***=***REMOVED***iteratee(accumulator,***REMOVED***array[length],***REMOVED***length,***REMOVED***array);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***accumulator;
}

export***REMOVED***default***REMOVED***arrayReduceRight;
