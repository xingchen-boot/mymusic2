/**
***REMOVED*******REMOVED***Performs***REMOVED***a
***REMOVED*******REMOVED***[`SameValueZero`](http://ecma-international.org/ecma-262/7.0/#sec-samevaluezero)
***REMOVED*******REMOVED***comparison***REMOVED***between***REMOVED***two***REMOVED***values***REMOVED***to***REMOVED***determine***REMOVED***if***REMOVED***they***REMOVED***are***REMOVED***equivalent.
***REMOVED****
...
***REMOVED****
***REMOVED*******REMOVED***_.eq(object,***REMOVED***object);
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***true
***REMOVED****
***REMOVED*******REMOVED***_.eq(object,***REMOVED***other);
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***false
***REMOVED****
***REMOVED*******REMOVED***_.eq('a',***REMOVED***'a');
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***true
***REMOVED****
***REMOVED*******REMOVED***_.eq('a',***REMOVED***Object('a'));
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***false
***REMOVED****
***REMOVED*******REMOVED***_.eq(NaN,***REMOVED***NaN);
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***true
***REMOVED****/
function***REMOVED***eq(value,***REMOVED***other)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***value***REMOVED***===***REMOVED***other***REMOVED***||***REMOVED***(value***REMOVED***!==***REMOVED***value***REMOVED***&&***REMOVED***other***REMOVED***!==***REMOVED***other);
}

module.exports***REMOVED***=***REMOVED***eq;
