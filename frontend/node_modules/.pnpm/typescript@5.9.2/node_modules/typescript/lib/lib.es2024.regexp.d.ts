...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*******REMOVED***Returns***REMOVED***a***REMOVED***Boolean***REMOVED***value***REMOVED***indicating***REMOVED***the***REMOVED***state***REMOVED***of***REMOVED***the***REMOVED***unicodeSets***REMOVED***flag***REMOVED***(v)***REMOVED***used***REMOVED***with***REMOVED***a***REMOVED***regular***REMOVED***expression.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*******REMOVED***Default***REMOVED***is***REMOVED***false.***REMOVED***Read-only.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED****/
***REMOVED******REMOVED******REMOVED******REMOVED***readonly***REMOVED***unicodeSets:***REMOVED***boolean;
}
