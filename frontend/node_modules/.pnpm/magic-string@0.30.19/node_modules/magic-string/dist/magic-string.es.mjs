import***REMOVED***{***REMOVED***encode***REMOVED***}***REMOVED***from***REMOVED***'@jridgewell/sourcemap-codec';
...
export***REMOVED***{***REMOVED***Bundle,***REMOVED***SourceMap,***REMOVED***MagicString***REMOVED***as***REMOVED***default***REMOVED***};
//#***REMOVED***sourceMappingURL=magic-string.es.mjs.map
