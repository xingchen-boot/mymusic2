...
exports.mostReadable***REMOVED***=***REMOVED***exports.isReadable***REMOVED***=***REMOVED***exports.readability***REMOVED***=***REMOVED***void***REMOVED***0;
...
***REMOVED****/
function***REMOVED***readability(color1,***REMOVED***color2)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***c1***REMOVED***=***REMOVED***new***REMOVED***index_js_1.TinyColor(color1);
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***c2***REMOVED***=***REMOVED***new***REMOVED***index_js_1.TinyColor(color2);
...
exports.readability***REMOVED***=***REMOVED***readability;
/**
...
***REMOVED*******REMOVED***```
***REMOVED****/
function***REMOVED***isReadable(color1,***REMOVED***color2,***REMOVED***wcag2)***REMOVED***{
...
exports.isReadable***REMOVED***=***REMOVED***isReadable;
/**
...
***REMOVED*******REMOVED***```
***REMOVED****/
function***REMOVED***mostReadable(baseColor,***REMOVED***colorList,***REMOVED***args)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***bestColor***REMOVED***=***REMOVED***new***REMOVED***index_js_1.TinyColor(color);
...
exports.mostReadable***REMOVED***=***REMOVED***mostReadable;
