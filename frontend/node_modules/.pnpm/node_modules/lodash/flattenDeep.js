...
/**
***REMOVED*******REMOVED***Recursively***REMOVED***flattens***REMOVED***`array`.
***REMOVED****
...
***REMOVED****
***REMOVED*******REMOVED***_.flattenDeep([1,***REMOVED***[2,***REMOVED***[3,***REMOVED***[4]],***REMOVED***5]]);
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***[1,***REMOVED***2,***REMOVED***3,***REMOVED***4,***REMOVED***5]
***REMOVED****/
function***REMOVED***flattenDeep(array)***REMOVED***{
...
***REMOVED******REMOVED***return***REMOVED***length***REMOVED***?***REMOVED***baseFlatten(array,***REMOVED***INFINITY)***REMOVED***:***REMOVED***[];
}

module.exports***REMOVED***=***REMOVED***flattenDeep;
