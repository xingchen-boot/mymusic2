...
/**
***REMOVED*******REMOVED***This***REMOVED***method***REMOVED***is***REMOVED***like***REMOVED***`_.indexOf`***REMOVED***except***REMOVED***that***REMOVED***it***REMOVED***performs***REMOVED***a***REMOVED***binary
***REMOVED*******REMOVED***search***REMOVED***on***REMOVED***a***REMOVED***sorted***REMOVED***`array`.
***REMOVED****
...
***REMOVED****
***REMOVED*******REMOVED***_.sortedIndexOf([4,***REMOVED***5,***REMOVED***5,***REMOVED***5,***REMOVED***6],***REMOVED***5);
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***1
***REMOVED****/
function***REMOVED***sortedIndexOf(array,***REMOVED***value)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***index***REMOVED***=***REMOVED***baseSortedIndex(array,***REMOVED***value);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(index***REMOVED***<***REMOVED***length***REMOVED***&&***REMOVED***eq(array[index],***REMOVED***value))***REMOVED***{
...
export***REMOVED***default***REMOVED***sortedIndexOf;
