...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(dep.version***REMOVED***===***REMOVED***0***REMOVED***||***REMOVED***shared.hasChanged(value,***REMOVED***computed._value))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***shared.extend(e,***REMOVED***options);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***try***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***targetIsArray***REMOVED***=***REMOVED***shared.isArray(target);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isArrayIndex***REMOVED***=***REMOVED***targetIsArray***REMOVED***&&***REMOVED***shared.isIntegerKey(key);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(key2***REMOVED***===***REMOVED***"length"***REMOVED***||***REMOVED***key2***REMOVED***===***REMOVED***ARRAY_ITERATE_KEY***REMOVED***||***REMOVED***!shared.isSymbol(key2)***REMOVED***&&***REMOVED***key2***REMOVED***>=***REMOVED***newLength)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isMap(target))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isMap(target))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***run(depsMap.get(ITERATE_KEY));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***break;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***...args.map((x)***REMOVED***=>***REMOVED***shared.isArray(x)***REMOVED***?***REMOVED***reactiveReadArray(x)***REMOVED***:***REMOVED***x)
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED***},
...
const***REMOVED***isNonTrackableKeys***REMOVED***=***REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***shared.makeMap(`__proto__,__v_isRef,__isVue`);
const***REMOVED***builtInSymbols***REMOVED***=***REMOVED***new***REMOVED***Set(
***REMOVED******REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***Object.getOwnPropertyNames(Symbol).filter((key)***REMOVED***=>***REMOVED***key***REMOVED***!==***REMOVED***"arguments"***REMOVED***&&***REMOVED***key***REMOVED***!==***REMOVED***"caller").map((key)***REMOVED***=>***REMOVED***Symbol[key]).filter(shared.isSymbol)
);
function***REMOVED***hasOwnProperty(key)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(!shared.isSymbol(key))***REMOVED***key***REMOVED***=***REMOVED***String(key);
...
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isSymbol(key)***REMOVED***?***REMOVED***builtInSymbols.has(key)***REMOVED***:***REMOVED***isNonTrackableKeys(key))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***targetIsArray***REMOVED***&&***REMOVED***shared.isIntegerKey(key)***REMOVED***?***REMOVED***res***REMOVED***:***REMOVED***res.value;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isObject(res))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!shared.isArray(target)***REMOVED***&&***REMOVED***isRef(oldValue)***REMOVED***&&***REMOVED***!isRef(value))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***hadKey***REMOVED***=***REMOVED***shared.isArray(target)***REMOVED***&&***REMOVED***shared.isIntegerKey(key)***REMOVED***?***REMOVED***Number(key)***REMOVED***<***REMOVED***target.length***REMOVED***:***REMOVED***shared.hasOwn(target,***REMOVED***key);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.hasChanged(value,***REMOVED***oldValue))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***trigger(target,***REMOVED***"set",***REMOVED***key,***REMOVED***value);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***result;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***deleteProperty(target,***REMOVED***key)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***hadKey***REMOVED***=***REMOVED***shared.hasOwn(target,***REMOVED***key);
***REMOVED******REMOVED******REMOVED******REMOVED***target[key];
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***trigger(target,***REMOVED***"delete",***REMOVED***key,***REMOVED***void***REMOVED***0);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***result;
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!shared.isSymbol(key)***REMOVED***||***REMOVED***!builtInSymbols.has(key))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.isArray(target)***REMOVED***?***REMOVED***"length"***REMOVED***:***REMOVED***ITERATE_KEY
***REMOVED******REMOVED******REMOVED******REMOVED***);
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***targetIsMap***REMOVED***=***REMOVED***shared.isMap(rawTarget);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.hasChanged(key,***REMOVED***rawKey))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.hasChanged(value,***REMOVED***oldValue))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***trigger(target,***REMOVED***"set",***REMOVED***key,***REMOVED***value);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***this;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hadKey***REMOVED***=***REMOVED***has.call(target,***REMOVED***key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***get***REMOVED***?***REMOVED***get.call(target,***REMOVED***key)***REMOVED***:***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***result***REMOVED***=***REMOVED***target.delete(key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(hadKey)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***trigger(target,***REMOVED***"delete",***REMOVED***key,***REMOVED***void***REMOVED***0);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.hasOwn(instrumentations,***REMOVED***key)***REMOVED***&&***REMOVED***key***REMOVED***in***REMOVED***target***REMOVED***?***REMOVED***instrumentations***REMOVED***:***REMOVED***target,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***key,
...
***REMOVED******REMOVED***return***REMOVED***value["__v_skip"]***REMOVED***||***REMOVED***!Object.isExtensible(value)***REMOVED***?***REMOVED***0***REMOVED***/****REMOVED***INVALID***REMOVED****/***REMOVED***:***REMOVED***targetTypeMap(shared.toRawType(value));
}
...
***REMOVED******REMOVED***if***REMOVED***(!shared.isObject(target))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***target;
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED***if***REMOVED***(!shared.hasOwn(value,***REMOVED***"__v_skip")***REMOVED***&&***REMOVED***Object.isExtensible(value))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***shared.def(value,***REMOVED***"__v_skip",***REMOVED***true);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***value;
}
const***REMOVED***toReactive***REMOVED***=***REMOVED***(value)***REMOVED***=>***REMOVED***shared.isObject(value)***REMOVED***?***REMOVED***reactive(value)***REMOVED***:***REMOVED***value;
const***REMOVED***toReadonly***REMOVED***=***REMOVED***(value)***REMOVED***=>***REMOVED***shared.isObject(value)***REMOVED***?***REMOVED***readonly(value)***REMOVED***:***REMOVED***value;
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.hasChanged(newValue,***REMOVED***oldValue))***REMOVED***{
...
***REMOVED******REMOVED***return***REMOVED***shared.isFunction(source)***REMOVED***?***REMOVED***source()***REMOVED***:***REMOVED***unref(source);
}
...
***REMOVED******REMOVED***const***REMOVED***ret***REMOVED***=***REMOVED***shared.isArray(object)***REMOVED***?***REMOVED***new***REMOVED***Array(object.length)***REMOVED***:***REMOVED***{};
...
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isFunction(source))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***new***REMOVED***GetterRefImpl(source);
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isObject(source)***REMOVED***&&***REMOVED***arguments.length***REMOVED***>***REMOVED***1)***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(shared.isFunction(getterOrOptions))***REMOVED***{
...
function***REMOVED***watch(source,***REMOVED***cb,***REMOVED***options***REMOVED***=***REMOVED***shared.EMPTY_OBJ)***REMOVED***{
...
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isArray(source))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isFunction(s))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***getter***REMOVED***=***REMOVED***shared.NOOP;
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.remove(scope.effects,***REMOVED***effect);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(deep***REMOVED***||***REMOVED***forceTrigger***REMOVED***||***REMOVED***(isMultiSource***REMOVED***?***REMOVED***newValue.some((v,***REMOVED***i)***REMOVED***=>***REMOVED***shared.hasChanged(v,***REMOVED***oldValue[i]))***REMOVED***:***REMOVED***shared.hasChanged(newValue,***REMOVED***oldValue)))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(cleanup)***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(depth***REMOVED***<=***REMOVED***0***REMOVED***||***REMOVED***!shared.isObject(value)***REMOVED***||***REMOVED***value["__v_skip"])***REMOVED***{
...
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isArray(value))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isSet(value)***REMOVED***||***REMOVED***shared.isMap(value))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isPlainObject(value))***REMOVED***{
...
exports.ARRAY_ITERATE_KEY***REMOVED***=***REMOVED***ARRAY_ITERATE_KEY;
exports.EffectFlags***REMOVED***=***REMOVED***EffectFlags;
exports.EffectScope***REMOVED***=***REMOVED***EffectScope;
exports.ITERATE_KEY***REMOVED***=***REMOVED***ITERATE_KEY;
exports.MAP_KEY_ITERATE_KEY***REMOVED***=***REMOVED***MAP_KEY_ITERATE_KEY;
exports.ReactiveEffect***REMOVED***=***REMOVED***ReactiveEffect;
exports.ReactiveFlags***REMOVED***=***REMOVED***ReactiveFlags;
exports.TrackOpTypes***REMOVED***=***REMOVED***TrackOpTypes;
exports.TriggerOpTypes***REMOVED***=***REMOVED***TriggerOpTypes;
exports.WatchErrorCodes***REMOVED***=***REMOVED***WatchErrorCodes;
exports.computed***REMOVED***=***REMOVED***computed;
exports.customRef***REMOVED***=***REMOVED***customRef;
exports.effect***REMOVED***=***REMOVED***effect;
exports.effectScope***REMOVED***=***REMOVED***effectScope;
exports.enableTracking***REMOVED***=***REMOVED***enableTracking;
exports.getCurrentScope***REMOVED***=***REMOVED***getCurrentScope;
exports.getCurrentWatcher***REMOVED***=***REMOVED***getCurrentWatcher;
exports.isProxy***REMOVED***=***REMOVED***isProxy;
exports.isReactive***REMOVED***=***REMOVED***isReactive;
exports.isReadonly***REMOVED***=***REMOVED***isReadonly;
exports.isRef***REMOVED***=***REMOVED***isRef;
exports.isShallow***REMOVED***=***REMOVED***isShallow;
exports.markRaw***REMOVED***=***REMOVED***markRaw;
exports.onEffectCleanup***REMOVED***=***REMOVED***onEffectCleanup;
exports.onScopeDispose***REMOVED***=***REMOVED***onScopeDispose;
exports.onWatcherCleanup***REMOVED***=***REMOVED***onWatcherCleanup;
exports.pauseTracking***REMOVED***=***REMOVED***pauseTracking;
exports.proxyRefs***REMOVED***=***REMOVED***proxyRefs;
exports.reactive***REMOVED***=***REMOVED***reactive;
exports.reactiveReadArray***REMOVED***=***REMOVED***reactiveReadArray;
exports.readonly***REMOVED***=***REMOVED***readonly;
exports.ref***REMOVED***=***REMOVED***ref;
exports.resetTracking***REMOVED***=***REMOVED***resetTracking;
exports.shallowReactive***REMOVED***=***REMOVED***shallowReactive;
exports.shallowReadArray***REMOVED***=***REMOVED***shallowReadArray;
exports.shallowReadonly***REMOVED***=***REMOVED***shallowReadonly;
exports.shallowRef***REMOVED***=***REMOVED***shallowRef;
exports.stop***REMOVED***=***REMOVED***stop;
exports.toRaw***REMOVED***=***REMOVED***toRaw;
exports.toReactive***REMOVED***=***REMOVED***toReactive;
exports.toReadonly***REMOVED***=***REMOVED***toReadonly;
exports.toRef***REMOVED***=***REMOVED***toRef;
exports.toRefs***REMOVED***=***REMOVED***toRefs;
exports.toValue***REMOVED***=***REMOVED***toValue;
exports.track***REMOVED***=***REMOVED***track;
exports.traverse***REMOVED***=***REMOVED***traverse;
exports.trigger***REMOVED***=***REMOVED***trigger;
exports.triggerRef***REMOVED***=***REMOVED***triggerRef;
