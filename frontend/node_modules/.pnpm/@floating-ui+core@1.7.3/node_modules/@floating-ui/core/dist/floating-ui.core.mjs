import***REMOVED***{***REMOVED***getSideAxis,***REMOVED***getAlignmentAxis,***REMOVED***getAxisLength,***REMOVED***getSide,***REMOVED***getAlignment,***REMOVED***evaluate,***REMOVED***getPaddingObject,***REMOVED***rectToClientRect,***REMOVED***min,***REMOVED***clamp,***REMOVED***placements,***REMOVED***getAlignmentSides,***REMOVED***getOppositeAlignmentPlacement,***REMOVED***getOppositePlacement,***REMOVED***getExpandedPlacements,***REMOVED***getOppositeAxisPlacements,***REMOVED***sides,***REMOVED***max,***REMOVED***getOppositeAxis***REMOVED***}***REMOVED***from***REMOVED***'@floating-ui/utils';
export***REMOVED***{***REMOVED***rectToClientRect***REMOVED***}***REMOVED***from***REMOVED***'@floating-ui/utils';
...
export***REMOVED***{***REMOVED***arrow,***REMOVED***autoPlacement,***REMOVED***computePosition,***REMOVED***detectOverflow,***REMOVED***flip,***REMOVED***hide,***REMOVED***inline,***REMOVED***limitShift,***REMOVED***offset,***REMOVED***shift,***REMOVED***size***REMOVED***};
