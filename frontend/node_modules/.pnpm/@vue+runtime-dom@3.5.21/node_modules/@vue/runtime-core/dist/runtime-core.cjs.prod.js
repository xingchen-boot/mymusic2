/**
****REMOVED***@vue/runtime-core***REMOVED***v3.5.21
...
var***REMOVED***reactivity***REMOVED***=***REMOVED***require('@vue/reactivity');
var***REMOVED***shared***REMOVED***=***REMOVED***require('@vue/shared');

function***REMOVED***pushWarningContext(vnode)***REMOVED***{
}
function***REMOVED***popWarningContext()***REMOVED***{
}
function***REMOVED***assertNumber(val,***REMOVED***type)***REMOVED***{
***REMOVED******REMOVED***return;
}

const***REMOVED***ErrorCodes***REMOVED***=***REMOVED***{
***REMOVED******REMOVED***"SETUP_FUNCTION":***REMOVED***0,
***REMOVED******REMOVED***"0":***REMOVED***"SETUP_FUNCTION",
***REMOVED******REMOVED***"RENDER_FUNCTION":***REMOVED***1,
***REMOVED******REMOVED***"1":***REMOVED***"RENDER_FUNCTION",
***REMOVED******REMOVED***"NATIVE_EVENT_HANDLER":***REMOVED***5,
***REMOVED******REMOVED***"5":***REMOVED***"NATIVE_EVENT_HANDLER",
***REMOVED******REMOVED***"COMPONENT_EVENT_HANDLER":***REMOVED***6,
***REMOVED******REMOVED***"6":***REMOVED***"COMPONENT_EVENT_HANDLER",
***REMOVED******REMOVED***"VNODE_HOOK":***REMOVED***7,
***REMOVED******REMOVED***"7":***REMOVED***"VNODE_HOOK",
***REMOVED******REMOVED***"DIRECTIVE_HOOK":***REMOVED***8,
***REMOVED******REMOVED***"8":***REMOVED***"DIRECTIVE_HOOK",
***REMOVED******REMOVED***"TRANSITION_HOOK":***REMOVED***9,
***REMOVED******REMOVED***"9":***REMOVED***"TRANSITION_HOOK",
***REMOVED******REMOVED***"APP_ERROR_HANDLER":***REMOVED***10,
***REMOVED******REMOVED***"10":***REMOVED***"APP_ERROR_HANDLER",
***REMOVED******REMOVED***"APP_WARN_HANDLER":***REMOVED***11,
***REMOVED******REMOVED***"11":***REMOVED***"APP_WARN_HANDLER",
***REMOVED******REMOVED***"FUNCTION_REF":***REMOVED***12,
***REMOVED******REMOVED***"12":***REMOVED***"FUNCTION_REF",
***REMOVED******REMOVED***"ASYNC_COMPONENT_LOADER":***REMOVED***13,
***REMOVED******REMOVED***"13":***REMOVED***"ASYNC_COMPONENT_LOADER",
***REMOVED******REMOVED***"SCHEDULER":***REMOVED***14,
***REMOVED******REMOVED***"14":***REMOVED***"SCHEDULER",
***REMOVED******REMOVED***"COMPONENT_UPDATE":***REMOVED***15,
***REMOVED******REMOVED***"15":***REMOVED***"COMPONENT_UPDATE",
***REMOVED******REMOVED***"APP_UNMOUNT_CLEANUP":***REMOVED***16,
***REMOVED******REMOVED***"16":***REMOVED***"APP_UNMOUNT_CLEANUP"
};
const***REMOVED***ErrorTypeStrings$1***REMOVED***=***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(shared.isFunction(fn))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(res***REMOVED***&&***REMOVED***shared.isPromise(res))***REMOVED***{
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(shared.isArray(fn))***REMOVED***{
...
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***errorHandler,***REMOVED***throwUnhandledErrorInProduction***REMOVED***}***REMOVED***=***REMOVED***instance***REMOVED***&&***REMOVED***instance.appContext.config***REMOVED***||***REMOVED***shared.EMPTY_OBJ;
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***errorInfo***REMOVED***=***REMOVED***`https://vuejs.org/error-reference/#runtime-${type}`;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***reactivity.pauseTracking();
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***reactivity.resetTracking();
...
***REMOVED******REMOVED***if***REMOVED***(throwInProd)***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(!shared.isArray(cb))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(false)***REMOVED***;
...
***REMOVED******REMOVED******REMOVED******REMOVED***flushPostFlushCbs();
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***flushJobs();
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
}
...
function***REMOVED***setCurrentRenderingInstance(instance)***REMOVED***{
...
function***REMOVED***pushScopeId(id)***REMOVED***{
***REMOVED******REMOVED***currentScopeId***REMOVED***=***REMOVED***id;
}
function***REMOVED***popScopeId()***REMOVED***{
***REMOVED******REMOVED***currentScopeId***REMOVED***=***REMOVED***null;
}
const***REMOVED***withScopeId***REMOVED***=***REMOVED***(_id)***REMOVED***=>***REMOVED***withCtx;
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***prevInstance***REMOVED***=***REMOVED***setCurrentRenderingInstance(ctx);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setCurrentRenderingInstance(prevInstance);
...
function***REMOVED***withDirectives(vnode,***REMOVED***directives)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(currentRenderingInstance***REMOVED***===***REMOVED***null)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***vnode;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***instance***REMOVED***=***REMOVED***getComponentPublicInstance(currentRenderingInstance);
***REMOVED******REMOVED***const***REMOVED***bindings***REMOVED***=***REMOVED***vnode.dirs***REMOVED***||***REMOVED***(vnode.dirs***REMOVED***=***REMOVED***[]);
***REMOVED******REMOVED***for***REMOVED***(let***REMOVED***i***REMOVED***=***REMOVED***0;***REMOVED***i***REMOVED***<***REMOVED***directives.length;***REMOVED***i++)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***[dir,***REMOVED***value,***REMOVED***arg,***REMOVED***modifiers***REMOVED***=***REMOVED***shared.EMPTY_OBJ]***REMOVED***=***REMOVED***directives[i];
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(dir)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isFunction(dir))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***dir***REMOVED***=***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mounted:***REMOVED***dir,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***updated:***REMOVED***dir
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(dir.deep)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***reactivity.traverse(value);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***bindings.push({
...
const***REMOVED***isTeleportDisabled***REMOVED***=***REMOVED***(props)***REMOVED***=>***REMOVED***props***REMOVED***&&***REMOVED***(props.disabled***REMOVED***||***REMOVED***props.disabled***REMOVED***===***REMOVED***"");
const***REMOVED***isTeleportDeferred***REMOVED***=***REMOVED***(props)***REMOVED***=>***REMOVED***props***REMOVED***&&***REMOVED***(props.defer***REMOVED***||***REMOVED***props.defer***REMOVED***===***REMOVED***"");
const***REMOVED***isTargetSVG***REMOVED***=***REMOVED***(target)***REMOVED***=>***REMOVED***typeof***REMOVED***SVGElement***REMOVED***!==***REMOVED***"undefined"***REMOVED***&&***REMOVED***target***REMOVED***instanceof***REMOVED***SVGElement;
const***REMOVED***isTargetMathML***REMOVED***=***REMOVED***(target)***REMOVED***=>***REMOVED***typeof***REMOVED***MathMLElement***REMOVED***===***REMOVED***"function"***REMOVED***&&***REMOVED***target***REMOVED***instanceof***REMOVED***MathMLElement;
const***REMOVED***resolveTarget***REMOVED***=***REMOVED***(props,***REMOVED***select)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***targetSelector***REMOVED***=***REMOVED***props***REMOVED***&&***REMOVED***props.to;
***REMOVED******REMOVED***if***REMOVED***(shared.isString(targetSelector))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!select)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***target***REMOVED***=***REMOVED***select(targetSelector);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***target;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***targetSelector;
***REMOVED******REMOVED***}
};
const***REMOVED***TeleportImpl***REMOVED***=***REMOVED***{
***REMOVED******REMOVED***name:***REMOVED***"Teleport",
***REMOVED******REMOVED***__isTeleport:***REMOVED***true,
***REMOVED******REMOVED***process(n1,***REMOVED***n2,***REMOVED***container,***REMOVED***anchor,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***namespace,***REMOVED***slotScopeIds,***REMOVED***optimized,***REMOVED***internals)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mc:***REMOVED***mountChildren,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pc:***REMOVED***patchChildren,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pbc:***REMOVED***patchBlockChildren,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***o:***REMOVED***{***REMOVED***insert,***REMOVED***querySelector,***REMOVED***createText,***REMOVED***createComment***REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***=***REMOVED***internals;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***disabled***REMOVED***=***REMOVED***isTeleportDisabled(n2.props);
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***{***REMOVED***shapeFlag,***REMOVED***children,***REMOVED***dynamicChildren***REMOVED***}***REMOVED***=***REMOVED***n2;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(n1***REMOVED***==***REMOVED***null)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***placeholder***REMOVED***=***REMOVED***n2.el***REMOVED***=***REMOVED***createText("");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***mainAnchor***REMOVED***=***REMOVED***n2.anchor***REMOVED***=***REMOVED***createText("");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***insert(placeholder,***REMOVED***container,***REMOVED***anchor);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***insert(mainAnchor,***REMOVED***container,***REMOVED***anchor);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***mount***REMOVED***=***REMOVED***(container2,***REMOVED***anchor2)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shapeFlag***REMOVED***&***REMOVED***16)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(parentComponent***REMOVED***&&***REMOVED***parentComponent.isCE)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent.ce._teleportTarget***REMOVED***=***REMOVED***container2;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor2,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***mountToTarget***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***target***REMOVED***=***REMOVED***n2.target***REMOVED***=***REMOVED***resolveTarget(n2.props,***REMOVED***querySelector);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***targetAnchor***REMOVED***=***REMOVED***prepareAnchor(target,***REMOVED***n2,***REMOVED***createText,***REMOVED***insert);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(target)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(namespace***REMOVED***!==***REMOVED***"svg"***REMOVED***&&***REMOVED***isTargetSVG(target))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(namespace***REMOVED***!==***REMOVED***"mathml"***REMOVED***&&***REMOVED***isTargetMathML(target))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace***REMOVED***=***REMOVED***"mathml";
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!disabled)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mount(target,***REMOVED***targetAnchor);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***updateCssVars(n2,***REMOVED***false);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(disabled)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mount(container,***REMOVED***mainAnchor);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***updateCssVars(n2,***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isTeleportDeferred(n2.props))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2.el.__isMounted***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***queuePostRenderEffect(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mountToTarget();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***delete***REMOVED***n2.el.__isMounted;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***parentSuspense);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mountToTarget();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isTeleportDeferred(n2.props)***REMOVED***&&***REMOVED***n1.el.__isMounted***REMOVED***===***REMOVED***false)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***queuePostRenderEffect(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***TeleportImpl.process(
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2.targetStart***REMOVED***=***REMOVED***n1.targetStart;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***mainAnchor***REMOVED***=***REMOVED***n2.anchor***REMOVED***=***REMOVED***n1.anchor;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***target***REMOVED***=***REMOVED***n2.target***REMOVED***=***REMOVED***n1.target;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***targetAnchor***REMOVED***=***REMOVED***n2.targetAnchor***REMOVED***=***REMOVED***n1.targetAnchor;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***wasDisabled***REMOVED***=***REMOVED***isTeleportDisabled(n1.props);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***currentContainer***REMOVED***=***REMOVED***wasDisabled***REMOVED***?***REMOVED***container***REMOVED***:***REMOVED***target;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***currentAnchor***REMOVED***=***REMOVED***wasDisabled***REMOVED***?***REMOVED***mainAnchor***REMOVED***:***REMOVED***targetAnchor;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(namespace***REMOVED***===***REMOVED***"svg"***REMOVED***||***REMOVED***isTargetSVG(target))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace***REMOVED***=***REMOVED***"svg";
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(namespace***REMOVED***===***REMOVED***"mathml"***REMOVED***||***REMOVED***isTargetMathML(target))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace***REMOVED***=***REMOVED***"mathml";
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(dynamicChildren)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***currentContainer,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***traverseStaticChildren(n1,***REMOVED***n2,***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(!optimized)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***currentContainer,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***currentAnchor,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(disabled)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!wasDisabled)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***moveTeleport(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mainAnchor,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***internals,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(n2.props***REMOVED***&&***REMOVED***n1.props***REMOVED***&&***REMOVED***n2.props.to***REMOVED***!==***REMOVED***n1.props.to)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2.props.to***REMOVED***=***REMOVED***n1.props.to;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***((n2.props***REMOVED***&&***REMOVED***n2.props.to)***REMOVED***!==***REMOVED***(n1.props***REMOVED***&&***REMOVED***n1.props.to))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***nextTarget***REMOVED***=***REMOVED***n2.target***REMOVED***=***REMOVED***resolveTarget(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2.props,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***querySelector
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(nextTarget)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***moveTeleport(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextTarget,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***internals,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(wasDisabled)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***moveTeleport(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***target,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***targetAnchor,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***internals,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***1
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***updateCssVars(n2,***REMOVED***disabled);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***},
***REMOVED******REMOVED***remove(vnode,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***{***REMOVED***um:***REMOVED***unmount,***REMOVED***o:***REMOVED***{***REMOVED***remove:***REMOVED***hostRemove***REMOVED***}***REMOVED***},***REMOVED***doRemove)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***targetStart,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***targetAnchor,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hostRemove(targetStart);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hostRemove(targetAnchor);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***doRemove***REMOVED***&&***REMOVED***hostRemove(anchor);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shapeFlag***REMOVED***&***REMOVED***16)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***shouldRemove***REMOVED***=***REMOVED***doRemove***REMOVED***||***REMOVED***!isTeleportDisabled(props);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***unmount(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***child,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shouldRemove,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***!!child.dynamicChildren
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***},
***REMOVED******REMOVED***move:***REMOVED***moveTeleport,
***REMOVED******REMOVED***hydrate:***REMOVED***hydrateTeleport
};
function***REMOVED***moveTeleport(vnode,***REMOVED***container,***REMOVED***parentAnchor,***REMOVED***{***REMOVED***o:***REMOVED***{***REMOVED***insert***REMOVED***},***REMOVED***m:***REMOVED***move***REMOVED***},***REMOVED***moveType***REMOVED***=***REMOVED***2)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(moveType***REMOVED***===***REMOVED***0)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***insert(vnode.targetAnchor,***REMOVED***container,***REMOVED***parentAnchor);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***el,***REMOVED***anchor,***REMOVED***shapeFlag,***REMOVED***children,***REMOVED***props***REMOVED***}***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED***const***REMOVED***isReorder***REMOVED***=***REMOVED***moveType***REMOVED***===***REMOVED***2;
***REMOVED******REMOVED***if***REMOVED***(isReorder)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***insert(el,***REMOVED***container,***REMOVED***parentAnchor);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(!isReorder***REMOVED***||***REMOVED***isTeleportDisabled(props))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shapeFlag***REMOVED***&***REMOVED***16)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(let***REMOVED***i***REMOVED***=***REMOVED***0;***REMOVED***i***REMOVED***<***REMOVED***children.length;***REMOVED***i++)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***move(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***children[i],
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(isReorder)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***insert(anchor,***REMOVED***container,***REMOVED***parentAnchor);
***REMOVED******REMOVED***}
}
function***REMOVED***hydrateTeleport(node,***REMOVED***vnode,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***slotScopeIds,***REMOVED***optimized,***REMOVED***{
***REMOVED******REMOVED***o:***REMOVED***{***REMOVED***nextSibling,***REMOVED***parentNode,***REMOVED***querySelector,***REMOVED***insert,***REMOVED***createText***REMOVED***}
},***REMOVED***hydrateChildren)***REMOVED***{
***REMOVED******REMOVED***function***REMOVED***hydrateDisabledTeleport(node2,***REMOVED***vnode2,***REMOVED***targetStart,***REMOVED***targetAnchor)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***vnode2.anchor***REMOVED***=***REMOVED***hydrateChildren(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextSibling(node2),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentNode(node2),
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***vnode2.targetStart***REMOVED***=***REMOVED***targetStart;
***REMOVED******REMOVED******REMOVED******REMOVED***vnode2.targetAnchor***REMOVED***=***REMOVED***targetAnchor;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***target***REMOVED***=***REMOVED***vnode.target***REMOVED***=***REMOVED***resolveTarget(
***REMOVED******REMOVED******REMOVED******REMOVED***vnode.props,
***REMOVED******REMOVED******REMOVED******REMOVED***querySelector
***REMOVED******REMOVED***);
***REMOVED******REMOVED***const***REMOVED***disabled***REMOVED***=***REMOVED***isTeleportDisabled(vnode.props);
***REMOVED******REMOVED***if***REMOVED***(target)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***targetNode***REMOVED***=***REMOVED***target._lpa***REMOVED***||***REMOVED***target.firstChild;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(vnode.shapeFlag***REMOVED***&***REMOVED***16)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(disabled)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrateDisabledTeleport(
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***targetNode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***targetNode***REMOVED***&&***REMOVED***nextSibling(targetNode)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.anchor***REMOVED***=***REMOVED***nextSibling(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***targetAnchor***REMOVED***=***REMOVED***targetNode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***while***REMOVED***(targetAnchor)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(targetAnchor***REMOVED***&&***REMOVED***targetAnchor.nodeType***REMOVED***===***REMOVED***8)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(targetAnchor.data***REMOVED***===***REMOVED***"teleport***REMOVED***start***REMOVED***anchor")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.targetStart***REMOVED***=***REMOVED***targetAnchor;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(targetAnchor.data***REMOVED***===***REMOVED***"teleport***REMOVED***anchor")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.targetAnchor***REMOVED***=***REMOVED***targetAnchor;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***target._lpa***REMOVED***=***REMOVED***vnode.targetAnchor***REMOVED***&&***REMOVED***nextSibling(vnode.targetAnchor);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***break;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***targetAnchor***REMOVED***=***REMOVED***nextSibling(targetAnchor);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!vnode.targetAnchor)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***prepareAnchor(target,***REMOVED***vnode,***REMOVED***createText,***REMOVED***insert);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrateChildren(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***targetNode***REMOVED***&&***REMOVED***nextSibling(targetNode),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***updateCssVars(vnode,***REMOVED***disabled);
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(disabled)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(vnode.shapeFlag***REMOVED***&***REMOVED***16)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrateDisabledTeleport(node,***REMOVED***vnode,***REMOVED***node,***REMOVED***nextSibling(node));
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***vnode.anchor***REMOVED***&&***REMOVED***nextSibling(vnode.anchor);
}
const***REMOVED***Teleport***REMOVED***=***REMOVED***TeleportImpl;
function***REMOVED***updateCssVars(vnode,***REMOVED***isDisabled)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***ctx***REMOVED***=***REMOVED***vnode.ctx;
***REMOVED******REMOVED***if***REMOVED***(ctx***REMOVED***&&***REMOVED***ctx.ut)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***node,***REMOVED***anchor;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isDisabled)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node***REMOVED***=***REMOVED***vnode.el;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor***REMOVED***=***REMOVED***vnode.anchor;
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node***REMOVED***=***REMOVED***vnode.targetStart;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor***REMOVED***=***REMOVED***vnode.targetAnchor;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***while***REMOVED***(node***REMOVED***&&***REMOVED***node***REMOVED***!==***REMOVED***anchor)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(node.nodeType***REMOVED***===***REMOVED***1)***REMOVED***node.setAttribute("data-v-owner",***REMOVED***ctx.uid);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node***REMOVED***=***REMOVED***node.nextSibling;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***ctx.ut();
***REMOVED******REMOVED***}
}
function***REMOVED***prepareAnchor(target,***REMOVED***vnode,***REMOVED***createText,***REMOVED***insert)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***targetStart***REMOVED***=***REMOVED***vnode.targetStart***REMOVED***=***REMOVED***createText("");
***REMOVED******REMOVED***const***REMOVED***targetAnchor***REMOVED***=***REMOVED***vnode.targetAnchor***REMOVED***=***REMOVED***createText("");
***REMOVED******REMOVED***targetStart[TeleportEndKey]***REMOVED***=***REMOVED***targetAnchor;
***REMOVED******REMOVED***if***REMOVED***(target)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***insert(targetStart,***REMOVED***target);
***REMOVED******REMOVED******REMOVED******REMOVED***insert(targetAnchor,***REMOVED***target);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***targetAnchor;
}

const***REMOVED***leaveCbKey***REMOVED***=***REMOVED***Symbol("_leaveCb");
const***REMOVED***enterCbKey***REMOVED***=***REMOVED***Symbol("_enterCb");
function***REMOVED***useTransitionState()***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***state***REMOVED***=***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***isMounted:***REMOVED***false,
***REMOVED******REMOVED******REMOVED******REMOVED***isLeaving:***REMOVED***false,
***REMOVED******REMOVED******REMOVED******REMOVED***isUnmounting:***REMOVED***false,
***REMOVED******REMOVED******REMOVED******REMOVED***leavingVNodes:***REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***new***REMOVED***Map()
***REMOVED******REMOVED***};
***REMOVED******REMOVED***onMounted(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***state.isMounted***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED***});
***REMOVED******REMOVED***onBeforeUnmount(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***state.isUnmounting***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED***});
***REMOVED******REMOVED***return***REMOVED***state;
}
const***REMOVED***TransitionHookValidator***REMOVED***=***REMOVED***[Function,***REMOVED***Array];
const***REMOVED***BaseTransitionPropsValidators***REMOVED***=***REMOVED***{
***REMOVED******REMOVED***mode:***REMOVED***String,
***REMOVED******REMOVED***appear:***REMOVED***Boolean,
***REMOVED******REMOVED***persisted:***REMOVED***Boolean,
***REMOVED******REMOVED***//***REMOVED***enter
***REMOVED******REMOVED***onBeforeEnter:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***onEnter:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***onAfterEnter:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***onEnterCancelled:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***//***REMOVED***leave
***REMOVED******REMOVED***onBeforeLeave:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***onLeave:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***onAfterLeave:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***onLeaveCancelled:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***//***REMOVED***appear
***REMOVED******REMOVED***onBeforeAppear:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***onAppear:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***onAfterAppear:***REMOVED***TransitionHookValidator,
***REMOVED******REMOVED***onAppearCancelled:***REMOVED***TransitionHookValidator
};
const***REMOVED***recursiveGetSubtree***REMOVED***=***REMOVED***(instance)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***subTree***REMOVED***=***REMOVED***instance.subTree;
***REMOVED******REMOVED***return***REMOVED***subTree.component***REMOVED***?***REMOVED***recursiveGetSubtree(subTree.component)***REMOVED***:***REMOVED***subTree;
};
const***REMOVED***BaseTransitionImpl***REMOVED***=***REMOVED***{
***REMOVED******REMOVED***name:***REMOVED***`BaseTransition`,
***REMOVED******REMOVED***props:***REMOVED***BaseTransitionPropsValidators,
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***state***REMOVED***=***REMOVED***useTransitionState();
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***children***REMOVED***=***REMOVED***slots.default***REMOVED***&&***REMOVED***getTransitionRawChildren(slots.default(),***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!children***REMOVED***||***REMOVED***!children.length)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***child***REMOVED***=***REMOVED***findNonCommentChild(children);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***rawProps***REMOVED***=***REMOVED***reactivity.toRaw(props);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***mode***REMOVED***}***REMOVED***=***REMOVED***rawProps;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(state.isLeaving)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***emptyPlaceholder(child);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***innerChild***REMOVED***=***REMOVED***getInnerChild$1(child);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!innerChild)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***emptyPlaceholder(child);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***enterHooks***REMOVED***=***REMOVED***resolveTransitionHooks(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***innerChild,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***rawProps,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***state,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***#11061,***REMOVED***ensure***REMOVED***enterHooks***REMOVED***is***REMOVED***fresh***REMOVED***after***REMOVED***clone
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***(hooks)***REMOVED***=>***REMOVED***enterHooks***REMOVED***=***REMOVED***hooks
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(innerChild.type***REMOVED***!==***REMOVED***Comment)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setTransitionHooks(innerChild,***REMOVED***enterHooks);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***oldInnerChild***REMOVED***=***REMOVED***instance.subTree***REMOVED***&&***REMOVED***getInnerChild$1(instance.subTree);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(oldInnerChild***REMOVED***&&***REMOVED***oldInnerChild.type***REMOVED***!==***REMOVED***Comment***REMOVED***&&***REMOVED***!isSameVNodeType(oldInnerChild,***REMOVED***innerChild)***REMOVED***&&***REMOVED***recursiveGetSubtree(instance).type***REMOVED***!==***REMOVED***Comment)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***leavingHooks***REMOVED***=***REMOVED***resolveTransitionHooks(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***oldInnerChild,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***rawProps,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setTransitionHooks(oldInnerChild,***REMOVED***leavingHooks);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(mode***REMOVED***===***REMOVED***"out-in"***REMOVED***&&***REMOVED***innerChild.type***REMOVED***!==***REMOVED***Comment)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***state.isLeaving***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***leavingHooks.afterLeave***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***state.isLeaving***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!(instance.job.flags***REMOVED***&***REMOVED***8))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance.update();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***delete***REMOVED***leavingHooks.afterLeave;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***oldInnerChild***REMOVED***=***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***emptyPlaceholder(child);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(mode***REMOVED***===***REMOVED***"in-out"***REMOVED***&&***REMOVED***innerChild.type***REMOVED***!==***REMOVED***Comment)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***leavingHooks.delayLeave***REMOVED***=***REMOVED***(el,***REMOVED***earlyRemove,***REMOVED***delayedLeave)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***leavingVNodesCache***REMOVED***=***REMOVED***getLeavingNodesForType(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***state,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***oldInnerChild
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***leavingVNodesCache[String(oldInnerChild.key)]***REMOVED***=***REMOVED***oldInnerChild;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el[leaveCbKey]***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***earlyRemove();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el[leaveCbKey]***REMOVED***=***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***delete***REMOVED***enterHooks.delayedLeave;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***oldInnerChild***REMOVED***=***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***enterHooks.delayedLeave***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***delayedLeave();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***delete***REMOVED***enterHooks.delayedLeave;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***oldInnerChild***REMOVED***=***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***oldInnerChild***REMOVED***=***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(oldInnerChild)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***oldInnerChild***REMOVED***=***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***child;
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED***}
};
function***REMOVED***findNonCommentChild(children)***REMOVED***{
***REMOVED******REMOVED***let***REMOVED***child***REMOVED***=***REMOVED***children[0];
***REMOVED******REMOVED***if***REMOVED***(children.length***REMOVED***>***REMOVED***1)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(const***REMOVED***c***REMOVED***of***REMOVED***children)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(c.type***REMOVED***!==***REMOVED***Comment)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***child***REMOVED***=***REMOVED***c;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***break;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***child;
}
const***REMOVED***BaseTransition***REMOVED***=***REMOVED***BaseTransitionImpl;
function***REMOVED***getLeavingNodesForType(state,***REMOVED***vnode)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***leavingVNodes***REMOVED***}***REMOVED***=***REMOVED***state;
***REMOVED******REMOVED***let***REMOVED***leavingVNodesCache***REMOVED***=***REMOVED***leavingVNodes.get(vnode.type);
***REMOVED******REMOVED***if***REMOVED***(!leavingVNodesCache)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***leavingVNodesCache***REMOVED***=***REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***Object.create(null);
***REMOVED******REMOVED******REMOVED******REMOVED***leavingVNodes.set(vnode.type,***REMOVED***leavingVNodesCache);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***leavingVNodesCache;
}
function***REMOVED***resolveTransitionHooks(vnode,***REMOVED***props,***REMOVED***state,***REMOVED***instance,***REMOVED***postClone)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***appear,
***REMOVED******REMOVED******REMOVED******REMOVED***mode,
***REMOVED******REMOVED******REMOVED******REMOVED***persisted***REMOVED***=***REMOVED***false,
***REMOVED******REMOVED******REMOVED******REMOVED***onBeforeEnter,
***REMOVED******REMOVED******REMOVED******REMOVED***onEnter,
***REMOVED******REMOVED******REMOVED******REMOVED***onAfterEnter,
***REMOVED******REMOVED******REMOVED******REMOVED***onEnterCancelled,
***REMOVED******REMOVED******REMOVED******REMOVED***onBeforeLeave,
***REMOVED******REMOVED******REMOVED******REMOVED***onLeave,
***REMOVED******REMOVED******REMOVED******REMOVED***onAfterLeave,
***REMOVED******REMOVED******REMOVED******REMOVED***onLeaveCancelled,
***REMOVED******REMOVED******REMOVED******REMOVED***onBeforeAppear,
***REMOVED******REMOVED******REMOVED******REMOVED***onAppear,
***REMOVED******REMOVED******REMOVED******REMOVED***onAfterAppear,
***REMOVED******REMOVED******REMOVED******REMOVED***onAppearCancelled
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***props;
***REMOVED******REMOVED***const***REMOVED***key***REMOVED***=***REMOVED***String(vnode.key);
***REMOVED******REMOVED***const***REMOVED***leavingVNodesCache***REMOVED***=***REMOVED***getLeavingNodesForType(state,***REMOVED***vnode);
***REMOVED******REMOVED***const***REMOVED***callHook***REMOVED***=***REMOVED***(hook,***REMOVED***args)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***hook***REMOVED***&&***REMOVED***callWithAsyncErrorHandling(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hook,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***9,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***args
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***callAsyncHook***REMOVED***=***REMOVED***(hook,***REMOVED***args)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***done***REMOVED***=***REMOVED***args[1];
***REMOVED******REMOVED******REMOVED******REMOVED***callHook(hook,***REMOVED***args);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isArray(hook))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(hook.every((hook2)***REMOVED***=>***REMOVED***hook2.length***REMOVED***<=***REMOVED***1))***REMOVED***done();
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(hook.length***REMOVED***<=***REMOVED***1)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***done();
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***hooks***REMOVED***=***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***mode,
***REMOVED******REMOVED******REMOVED******REMOVED***persisted,
***REMOVED******REMOVED******REMOVED******REMOVED***beforeEnter(el)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***hook***REMOVED***=***REMOVED***onBeforeEnter;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!state.isMounted)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(appear)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hook***REMOVED***=***REMOVED***onBeforeAppear***REMOVED***||***REMOVED***onBeforeEnter;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(el[leaveCbKey])***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el[leaveCbKey](
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***true
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***/****REMOVED***cancelled***REMOVED****/
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***leavingVNode***REMOVED***=***REMOVED***leavingVNodesCache[key];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(leavingVNode***REMOVED***&&***REMOVED***isSameVNodeType(vnode,***REMOVED***leavingVNode)***REMOVED***&&***REMOVED***leavingVNode.el[leaveCbKey])***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***leavingVNode.el[leaveCbKey]();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***callHook(hook,***REMOVED***[el]);
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***enter(el)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***hook***REMOVED***=***REMOVED***onEnter;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***afterHook***REMOVED***=***REMOVED***onAfterEnter;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***cancelHook***REMOVED***=***REMOVED***onEnterCancelled;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!state.isMounted)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(appear)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hook***REMOVED***=***REMOVED***onAppear***REMOVED***||***REMOVED***onEnter;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***afterHook***REMOVED***=***REMOVED***onAfterAppear***REMOVED***||***REMOVED***onAfterEnter;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***cancelHook***REMOVED***=***REMOVED***onAppearCancelled***REMOVED***||***REMOVED***onEnterCancelled;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***called***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***done***REMOVED***=***REMOVED***el[enterCbKey]***REMOVED***=***REMOVED***(cancelled)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(called)***REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***called***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(cancelled)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***callHook(cancelHook,***REMOVED***[el]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***callHook(afterHook,***REMOVED***[el]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(hooks.delayedLeave)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hooks.delayedLeave();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el[enterCbKey]***REMOVED***=***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(hook)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***callAsyncHook(hook,***REMOVED***[el,***REMOVED***done]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***done();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***leave(el,***REMOVED***remove)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***key2***REMOVED***=***REMOVED***String(vnode.key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(el[enterCbKey])***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el[enterCbKey](
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***true
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***/****REMOVED***cancelled***REMOVED****/
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(state.isUnmounting)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***remove();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***callHook(onBeforeLeave,***REMOVED***[el]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***called***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***done***REMOVED***=***REMOVED***el[leaveCbKey]***REMOVED***=***REMOVED***(cancelled)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(called)***REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***called***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***remove();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(cancelled)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***callHook(onLeaveCancelled,***REMOVED***[el]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***callHook(onAfterLeave,***REMOVED***[el]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el[leaveCbKey]***REMOVED***=***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(leavingVNodesCache[key2]***REMOVED***===***REMOVED***vnode)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***delete***REMOVED***leavingVNodesCache[key2];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***leavingVNodesCache[key2]***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(onLeave)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***callAsyncHook(onLeave,***REMOVED***[el,***REMOVED***done]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***done();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***clone(vnode2)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***hooks2***REMOVED***=***REMOVED***resolveTransitionHooks(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***props,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***state,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***postClone
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(postClone)***REMOVED***postClone(hooks2);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***hooks2;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***return***REMOVED***hooks;
}
function***REMOVED***emptyPlaceholder(vnode)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(isKeepAlive(vnode))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***vnode***REMOVED***=***REMOVED***cloneVNode(vnode);
***REMOVED******REMOVED******REMOVED******REMOVED***vnode.children***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***vnode;
***REMOVED******REMOVED***}
}
function***REMOVED***getInnerChild$1(vnode)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(!isKeepAlive(vnode))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isTeleport(vnode.type)***REMOVED***&&***REMOVED***vnode.children)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***findNonCommentChild(vnode.children);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***vnode;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(vnode.component)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***vnode.component.subTree;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***shapeFlag,***REMOVED***children***REMOVED***}***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED***if***REMOVED***(children)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shapeFlag***REMOVED***&***REMOVED***16)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***children[0];
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shapeFlag***REMOVED***&***REMOVED***32***REMOVED***&&***REMOVED***shared.isFunction(children.default))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***children.default();
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
}
...
function***REMOVED***getTransitionRawChildren(children,***REMOVED***keepComment***REMOVED***=***REMOVED***false,***REMOVED***parentKey)***REMOVED***{
***REMOVED******REMOVED***let***REMOVED***ret***REMOVED***=***REMOVED***[];
***REMOVED******REMOVED***let***REMOVED***keyedFragmentCount***REMOVED***=***REMOVED***0;
***REMOVED******REMOVED***for***REMOVED***(let***REMOVED***i***REMOVED***=***REMOVED***0;***REMOVED***i***REMOVED***<***REMOVED***children.length;***REMOVED***i++)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***child***REMOVED***=***REMOVED***children[i];
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***key***REMOVED***=***REMOVED***parentKey***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***child.key***REMOVED***:***REMOVED***String(parentKey)***REMOVED***+***REMOVED***String(child.key***REMOVED***!=***REMOVED***null***REMOVED***?***REMOVED***child.key***REMOVED***:***REMOVED***i);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(child.type***REMOVED***===***REMOVED***Fragment)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(child.patchFlag***REMOVED***&***REMOVED***128)***REMOVED***keyedFragmentCount++;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret***REMOVED***=***REMOVED***ret.concat(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***getTransitionRawChildren(child.children,***REMOVED***keepComment,***REMOVED***key)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(keepComment***REMOVED***||***REMOVED***child.type***REMOVED***!==***REMOVED***Comment)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret.push(key***REMOVED***!=***REMOVED***null***REMOVED***?***REMOVED***cloneVNode(child,***REMOVED***{***REMOVED***key***REMOVED***})***REMOVED***:***REMOVED***child);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(keyedFragmentCount***REMOVED***>***REMOVED***1)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(let***REMOVED***i***REMOVED***=***REMOVED***0;***REMOVED***i***REMOVED***<***REMOVED***ret.length;***REMOVED***i++)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret[i].patchFlag***REMOVED***=***REMOVED***-2;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
...
function***REMOVED***defineComponent(options,***REMOVED***extraOptions)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***shared.isFunction(options)***REMOVED***?***REMOVED***(
***REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***#8236:***REMOVED***extend***REMOVED***call***REMOVED***and***REMOVED***options.name***REMOVED***access***REMOVED***are***REMOVED***considered***REMOVED***side-effects
***REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***by***REMOVED***Rollup,***REMOVED***so***REMOVED***we***REMOVED***have***REMOVED***to***REMOVED***wrap***REMOVED***it***REMOVED***in***REMOVED***a***REMOVED***pure-annotated***REMOVED***IIFE.
***REMOVED******REMOVED******REMOVED******REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***(()***REMOVED***=>***REMOVED***shared.extend({***REMOVED***name:***REMOVED***options.name***REMOVED***},***REMOVED***extraOptions,***REMOVED***{***REMOVED***setup:***REMOVED***options***REMOVED***}))()
***REMOVED******REMOVED***)***REMOVED***:***REMOVED***options;
}

function***REMOVED***useId()***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***i***REMOVED***=***REMOVED***getCurrentInstance();
***REMOVED******REMOVED***if***REMOVED***(i)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***(i.appContext.config.idPrefix***REMOVED***||***REMOVED***"v")***REMOVED***+***REMOVED***"-"***REMOVED***+***REMOVED***i.ids[0]***REMOVED***+***REMOVED***i.ids[1]++;
***REMOVED******REMOVED***}
...
function***REMOVED***useTemplateRef(key)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***i***REMOVED***=***REMOVED***getCurrentInstance();
***REMOVED******REMOVED***const***REMOVED***r***REMOVED***=***REMOVED***reactivity.shallowRef(null);
***REMOVED******REMOVED***if***REMOVED***(i)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***refs***REMOVED***=***REMOVED***i.refs***REMOVED***===***REMOVED***shared.EMPTY_OBJ***REMOVED***?***REMOVED***i.refs***REMOVED***=***REMOVED***{}***REMOVED***:***REMOVED***i.refs;
***REMOVED******REMOVED******REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***Object.defineProperty(refs,***REMOVED***key,***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***enumerable:***REMOVED***true,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***get:***REMOVED***()***REMOVED***=>***REMOVED***r.value,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***set:***REMOVED***(val)***REMOVED***=>***REMOVED***r.value***REMOVED***=***REMOVED***val
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***ret***REMOVED***=***REMOVED***r;
***REMOVED******REMOVED***return***REMOVED***ret;
}
...
***REMOVED******REMOVED***if***REMOVED***(shared.isArray(rawRef))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***oldRawRef***REMOVED***&&***REMOVED***(shared.isArray(oldRawRef)***REMOVED***?***REMOVED***oldRawRef[i]***REMOVED***:***REMOVED***oldRawRef),
...
***REMOVED******REMOVED***const***REMOVED***refs***REMOVED***=***REMOVED***owner.refs***REMOVED***===***REMOVED***shared.EMPTY_OBJ***REMOVED***?***REMOVED***owner.refs***REMOVED***=***REMOVED***{}***REMOVED***:***REMOVED***owner.refs;
***REMOVED******REMOVED***const***REMOVED***setupState***REMOVED***=***REMOVED***owner.setupState;
***REMOVED******REMOVED***const***REMOVED***rawSetupState***REMOVED***=***REMOVED***reactivity.toRaw(setupState);
***REMOVED******REMOVED***const***REMOVED***canSetSetupRef***REMOVED***=***REMOVED***setupState***REMOVED***===***REMOVED***shared.EMPTY_OBJ***REMOVED***?***REMOVED***shared.NO***REMOVED***:***REMOVED***(key)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***shared.hasOwn(rawSetupState,***REMOVED***key);
***REMOVED******REMOVED***};
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isString(oldRef))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(reactivity.isRef(oldRef))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(shared.isFunction(ref))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***callWithErrorHandling(ref,***REMOVED***owner,***REMOVED***12,***REMOVED***[value,***REMOVED***refs]);
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***_isString***REMOVED***=***REMOVED***shared.isString(ref);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***_isRef***REMOVED***=***REMOVED***reactivity.isRef(ref);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***existing***REMOVED***=***REMOVED***_isString***REMOVED***?***REMOVED***canSetSetupRef(ref)***REMOVED***?***REMOVED***setupState[ref]***REMOVED***:***REMOVED***refs[ref]***REMOVED***:***REMOVED***ref.value***REMOVED***;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isUnmount)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.isArray(existing)***REMOVED***&&***REMOVED***shared.remove(existing,***REMOVED***refValue);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!shared.isArray(existing))***REMOVED***{
...
let***REMOVED***hasLoggedMismatchError***REMOVED***=***REMOVED***false;
const***REMOVED***logMismatchError***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(hasLoggedMismatchError)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***console.error("Hydration***REMOVED***completed***REMOVED***but***REMOVED***contains***REMOVED***mismatches.");
***REMOVED******REMOVED***hasLoggedMismatchError***REMOVED***=***REMOVED***true;
};
const***REMOVED***isSVGContainer***REMOVED***=***REMOVED***(container)***REMOVED***=>***REMOVED***container.namespaceURI.includes("svg")***REMOVED***&&***REMOVED***container.tagName***REMOVED***!==***REMOVED***"foreignObject";
const***REMOVED***isMathMLContainer***REMOVED***=***REMOVED***(container)***REMOVED***=>***REMOVED***container.namespaceURI.includes("MathML");
const***REMOVED***getContainerType***REMOVED***=***REMOVED***(container)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(container.nodeType***REMOVED***!==***REMOVED***1)***REMOVED***return***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED***if***REMOVED***(isSVGContainer(container))***REMOVED***return***REMOVED***"svg";
***REMOVED******REMOVED***if***REMOVED***(isMathMLContainer(container))***REMOVED***return***REMOVED***"mathml";
***REMOVED******REMOVED***return***REMOVED***void***REMOVED***0;
};
const***REMOVED***isComment***REMOVED***=***REMOVED***(node)***REMOVED***=>***REMOVED***node.nodeType***REMOVED***===***REMOVED***8;
function***REMOVED***createHydrationFunctions(rendererInternals)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***mt:***REMOVED***mountComponent,
***REMOVED******REMOVED******REMOVED******REMOVED***p:***REMOVED***patch,
***REMOVED******REMOVED******REMOVED******REMOVED***o:***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patchProp,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***createText,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextSibling,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentNode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***remove,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***insert,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***createComment
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***rendererInternals;
***REMOVED******REMOVED***const***REMOVED***hydrate***REMOVED***=***REMOVED***(vnode,***REMOVED***container)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!container.hasChildNodes())***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(null,***REMOVED***vnode,***REMOVED***container);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***flushPostFlushCbs();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container._vnode***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***hydrateNode(container.firstChild,***REMOVED***vnode,***REMOVED***null,***REMOVED***null,***REMOVED***null);
***REMOVED******REMOVED******REMOVED******REMOVED***flushPostFlushCbs();
***REMOVED******REMOVED******REMOVED******REMOVED***container._vnode***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***hydrateNode***REMOVED***=***REMOVED***(node,***REMOVED***vnode,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***slotScopeIds,***REMOVED***optimized***REMOVED***=***REMOVED***false)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***optimized***REMOVED***=***REMOVED***optimized***REMOVED***||***REMOVED***!!vnode.dynamicChildren;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isFragmentStart***REMOVED***=***REMOVED***isComment(node)***REMOVED***&&***REMOVED***node.data***REMOVED***===***REMOVED***"[";
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***onMismatch***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***handleMismatch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***isFragmentStart
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***type,***REMOVED***ref,***REMOVED***shapeFlag,***REMOVED***patchFlag***REMOVED***}***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***domType***REMOVED***=***REMOVED***node.nodeType;
***REMOVED******REMOVED******REMOVED******REMOVED***vnode.el***REMOVED***=***REMOVED***node;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.dynamicChildren***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***nextNode***REMOVED***=***REMOVED***null;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(domType***REMOVED***!==***REMOVED***3)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(vnode.children***REMOVED***===***REMOVED***"")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***insert(vnode.el***REMOVED***=***REMOVED***createText(""),***REMOVED***parentNode(node),***REMOVED***node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***node;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***onMismatch();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(node.data***REMOVED***!==***REMOVED***vnode.children)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***logMismatchError();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node.data***REMOVED***=***REMOVED***vnode.children;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***nextSibling(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***break;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***case***REMOVED***Comment:
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isTemplateNode(node))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***nextSibling(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***replaceNode(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.el***REMOVED***=***REMOVED***node.content.firstChild,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(domType***REMOVED***!==***REMOVED***8***REMOVED***||***REMOVED***isFragmentStart)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***onMismatch();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***nextSibling(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***break;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***case***REMOVED***Static:
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isFragmentStart)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node***REMOVED***=***REMOVED***nextSibling(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***domType***REMOVED***=***REMOVED***node.nodeType;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(domType***REMOVED***===***REMOVED***1***REMOVED***||***REMOVED***domType***REMOVED***===***REMOVED***3)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***node;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***needToAdoptContent***REMOVED***=***REMOVED***!vnode.children.length;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(let***REMOVED***i***REMOVED***=***REMOVED***0;***REMOVED***i***REMOVED***<***REMOVED***vnode.staticCount;***REMOVED***i++)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(needToAdoptContent)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.children***REMOVED***+=***REMOVED***nextNode.nodeType***REMOVED***===***REMOVED***1***REMOVED***?***REMOVED***nextNode.outerHTML***REMOVED***:***REMOVED***nextNode.data;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(i***REMOVED***===***REMOVED***vnode.staticCount***REMOVED***-***REMOVED***1)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.anchor***REMOVED***=***REMOVED***nextNode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***nextSibling(nextNode);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***isFragmentStart***REMOVED***?***REMOVED***nextSibling(nextNode)***REMOVED***:***REMOVED***nextNode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***onMismatch();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***break;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***onMismatch();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***hydrateFragment(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***((domType***REMOVED***!==***REMOVED***1***REMOVED***||***REMOVED***vnode.type.toLowerCase()***REMOVED***!==***REMOVED***node.tagName.toLowerCase())***REMOVED***&&***REMOVED***!isTemplateNode(node))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***onMismatch();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***hydrateElement(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.slotScopeIds***REMOVED***=***REMOVED***slotScopeIds;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***container***REMOVED***=***REMOVED***parentNode(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isFragmentStart)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***locateClosingAnchor(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(isComment(node)***REMOVED***&&***REMOVED***node.data***REMOVED***===***REMOVED***"teleport***REMOVED***start")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***locateClosingAnchor(node,***REMOVED***node.data,***REMOVED***"teleport***REMOVED***end");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***nextSibling(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mountComponent(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***getContainerType(container),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isAsyncWrapper(vnode)***REMOVED***&&***REMOVED***!vnode.type.__asyncResolved)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***subTree;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isFragmentStart)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***subTree***REMOVED***=***REMOVED***createVNode(Fragment);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***subTree.anchor***REMOVED***=***REMOVED***nextNode***REMOVED***?***REMOVED***nextNode.previousSibling***REMOVED***:***REMOVED***container.lastChild;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***subTree***REMOVED***=***REMOVED***node.nodeType***REMOVED***===***REMOVED***3***REMOVED***?***REMOVED***createTextVNode("")***REMOVED***:***REMOVED***createVNode("div");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***subTree.el***REMOVED***=***REMOVED***node;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.component.subTree***REMOVED***=***REMOVED***subTree;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(domType***REMOVED***!==***REMOVED***8)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***onMismatch();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***vnode.type.hydrate(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***rendererInternals,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrateChildren
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextNode***REMOVED***=***REMOVED***vnode.type.hydrate(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***getContainerType(parentNode(node)),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***rendererInternals,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrateNode
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(ref***REMOVED***!=***REMOVED***null)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setRef(ref,***REMOVED***null,***REMOVED***parentSuspense,***REMOVED***vnode);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***nextNode;
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***hydrateElement***REMOVED***=***REMOVED***(el,***REMOVED***vnode,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***slotScopeIds,***REMOVED***optimized)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***optimized***REMOVED***=***REMOVED***optimized***REMOVED***||***REMOVED***!!vnode.dynamicChildren;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***type,***REMOVED***props,***REMOVED***patchFlag,***REMOVED***shapeFlag,***REMOVED***dirs,***REMOVED***transition***REMOVED***}***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***forcePatch***REMOVED***=***REMOVED***type***REMOVED***===***REMOVED***"input"***REMOVED***||***REMOVED***type***REMOVED***===***REMOVED***"option";
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(forcePatch***REMOVED***||***REMOVED***patchFlag***REMOVED***!==***REMOVED***-1)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(dirs)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***invokeDirectiveHook(vnode,***REMOVED***null,***REMOVED***parentComponent,***REMOVED***"created");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***needCallTransitionHooks***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isTemplateNode(el))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***needCallTransitionHooks***REMOVED***=***REMOVED***needTransition(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***no***REMOVED***need***REMOVED***check***REMOVED***parentSuspense***REMOVED***in***REMOVED***hydration
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***transition
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***)***REMOVED***&&***REMOVED***parentComponent***REMOVED***&&***REMOVED***parentComponent.vnode.props***REMOVED***&&***REMOVED***parentComponent.vnode.props.appear;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***content***REMOVED***=***REMOVED***el.content.firstChild;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(needCallTransitionHooks)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***cls***REMOVED***=***REMOVED***content.getAttribute("class");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(cls)***REMOVED***content.$cls***REMOVED***=***REMOVED***cls;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***transition.beforeEnter(content);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***replaceNode(content,***REMOVED***el,***REMOVED***parentComponent);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.el***REMOVED***=***REMOVED***el***REMOVED***=***REMOVED***content;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shapeFlag***REMOVED***&***REMOVED***16***REMOVED***&&***REMOVED***//***REMOVED***skip***REMOVED***if***REMOVED***element***REMOVED***has***REMOVED***innerHTML***REMOVED***/***REMOVED***textContent
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***!(props***REMOVED***&&***REMOVED***(props.innerHTML***REMOVED***||***REMOVED***props.textContent)))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***next***REMOVED***=***REMOVED***hydrateChildren(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el.firstChild,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***while***REMOVED***(next)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!isMismatchAllowed(el,***REMOVED***1***REMOVED***/****REMOVED***CHILDREN***REMOVED****/))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***logMismatchError();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***cur***REMOVED***=***REMOVED***next;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***next***REMOVED***=***REMOVED***next.nextSibling;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***remove(cur);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shapeFlag***REMOVED***&***REMOVED***8)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***clientText***REMOVED***=***REMOVED***vnode.children;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(clientText[0]***REMOVED***===***REMOVED***"\n"***REMOVED***&&***REMOVED***(el.tagName***REMOVED***===***REMOVED***"PRE"***REMOVED***||***REMOVED***el.tagName***REMOVED***===***REMOVED***"TEXTAREA"))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***clientText***REMOVED***=***REMOVED***clientText.slice(1);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(el.textContent***REMOVED***!==***REMOVED***clientText)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!isMismatchAllowed(el,***REMOVED***0***REMOVED***/****REMOVED***TEXT***REMOVED****/))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***logMismatchError();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el.textContent***REMOVED***=***REMOVED***vnode.children;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(props)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(forcePatch***REMOVED***||***REMOVED***!optimized***REMOVED***||***REMOVED***patchFlag***REMOVED***&***REMOVED***(16***REMOVED***|***REMOVED***32))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isCustomElement***REMOVED***=***REMOVED***el.tagName.includes("-");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(const***REMOVED***key***REMOVED***in***REMOVED***props)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(forcePatch***REMOVED***&&***REMOVED***(key.endsWith("value")***REMOVED***||***REMOVED***key***REMOVED***===***REMOVED***"indeterminate")***REMOVED***||***REMOVED***shared.isOn(key)***REMOVED***&&***REMOVED***!shared.isReservedProp(key)***REMOVED***||***REMOVED***//***REMOVED***force***REMOVED***hydrate***REMOVED***v-bind***REMOVED***with***REMOVED***.prop***REMOVED***modifiers
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***key[0]***REMOVED***===***REMOVED***"."***REMOVED***||***REMOVED***isCustomElement)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patchProp(el,***REMOVED***key,***REMOVED***null,***REMOVED***props[key],***REMOVED***void***REMOVED***0,***REMOVED***parentComponent);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(props.onClick)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patchProp(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***"onClick",
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***props.onClick,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***void***REMOVED***0,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(patchFlag***REMOVED***&***REMOVED***4***REMOVED***&&***REMOVED***reactivity.isReactive(props.style))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(const***REMOVED***key***REMOVED***in***REMOVED***props.style)***REMOVED***props.style[key];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***vnodeHooks;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(vnodeHooks***REMOVED***=***REMOVED***props***REMOVED***&&***REMOVED***props.onVnodeBeforeMount)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***invokeVNodeHook(vnodeHooks,***REMOVED***parentComponent,***REMOVED***vnode);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(dirs)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***invokeDirectiveHook(vnode,***REMOVED***null,***REMOVED***parentComponent,***REMOVED***"beforeMount");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***((vnodeHooks***REMOVED***=***REMOVED***props***REMOVED***&&***REMOVED***props.onVnodeMounted)***REMOVED***||***REMOVED***dirs***REMOVED***||***REMOVED***needCallTransitionHooks)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***queueEffectWithSuspense(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnodeHooks***REMOVED***&&***REMOVED***invokeVNodeHook(vnodeHooks,***REMOVED***parentComponent,***REMOVED***vnode);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***needCallTransitionHooks***REMOVED***&&***REMOVED***transition.enter(el);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***dirs***REMOVED***&&***REMOVED***invokeDirectiveHook(vnode,***REMOVED***null,***REMOVED***parentComponent,***REMOVED***"mounted");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***parentSuspense);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***el.nextSibling;
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***hydrateChildren***REMOVED***=***REMOVED***(node,***REMOVED***parentVNode,***REMOVED***container,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***slotScopeIds,***REMOVED***optimized)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***optimized***REMOVED***=***REMOVED***optimized***REMOVED***||***REMOVED***!!parentVNode.dynamicChildren;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***children***REMOVED***=***REMOVED***parentVNode.children;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***l***REMOVED***=***REMOVED***children.length;
***REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(let***REMOVED***i***REMOVED***=***REMOVED***0;***REMOVED***i***REMOVED***<***REMOVED***l;***REMOVED***i++)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***vnode***REMOVED***=***REMOVED***optimized***REMOVED***?***REMOVED***children[i]***REMOVED***:***REMOVED***children[i]***REMOVED***=***REMOVED***normalizeVNode(children[i]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isText***REMOVED***=***REMOVED***vnode.type***REMOVED***===***REMOVED***Text;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(node)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isText***REMOVED***&&***REMOVED***!optimized)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(i***REMOVED***+***REMOVED***1***REMOVED***<***REMOVED***l***REMOVED***&&***REMOVED***normalizeVNode(children[i***REMOVED***+***REMOVED***1]).type***REMOVED***===***REMOVED***Text)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***insert(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***createText(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node.data.slice(vnode.children.length)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextSibling(node)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node.data***REMOVED***=***REMOVED***vnode.children;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node***REMOVED***=***REMOVED***hydrateNode(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(isText***REMOVED***&&***REMOVED***!vnode.children)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***insert(vnode.el***REMOVED***=***REMOVED***createText(""),***REMOVED***container);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!isMismatchAllowed(container,***REMOVED***1***REMOVED***/****REMOVED***CHILDREN***REMOVED****/))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***logMismatchError();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***getContainerType(container),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***hydrateFragment***REMOVED***=***REMOVED***(node,***REMOVED***vnode,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***slotScopeIds,***REMOVED***optimized)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***slotScopeIds:***REMOVED***fragmentSlotScopeIds***REMOVED***}***REMOVED***=***REMOVED***vnode;
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***container***REMOVED***=***REMOVED***parentNode(node);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***next***REMOVED***=***REMOVED***hydrateChildren(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***nextSibling(node),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(next***REMOVED***&&***REMOVED***isComment(next)***REMOVED***&&***REMOVED***next.data***REMOVED***===***REMOVED***"]")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***nextSibling(vnode.anchor***REMOVED***=***REMOVED***next);
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***logMismatchError();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***insert(vnode.anchor***REMOVED***=***REMOVED***createComment(`]`),***REMOVED***container,***REMOVED***next);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***next;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***handleMismatch***REMOVED***=***REMOVED***(node,***REMOVED***vnode,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***slotScopeIds,***REMOVED***isFragment)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!isMismatchAllowed(node.parentElement,***REMOVED***1***REMOVED***/****REMOVED***CHILDREN***REMOVED****/))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***logMismatchError();
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***vnode.el***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isFragment)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***end***REMOVED***=***REMOVED***locateClosingAnchor(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***while***REMOVED***(true)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***next2***REMOVED***=***REMOVED***nextSibling(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(next2***REMOVED***&&***REMOVED***next2***REMOVED***!==***REMOVED***end)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***remove(next2);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***break;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***next***REMOVED***=***REMOVED***nextSibling(node);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***container***REMOVED***=***REMOVED***parentNode(node);
***REMOVED******REMOVED******REMOVED******REMOVED***remove(node);
***REMOVED******REMOVED******REMOVED******REMOVED***patch(
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***getContainerType(container),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(parentComponent)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent.vnode.el***REMOVED***=***REMOVED***vnode.el;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***updateHOCHostEl(parentComponent,***REMOVED***vnode.el);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***next;
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***locateClosingAnchor***REMOVED***=***REMOVED***(node,***REMOVED***open***REMOVED***=***REMOVED***"[",***REMOVED***close***REMOVED***=***REMOVED***"]")***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***match***REMOVED***=***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED***while***REMOVED***(node)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***node***REMOVED***=***REMOVED***nextSibling(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(node***REMOVED***&&***REMOVED***isComment(node))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(node.data***REMOVED***===***REMOVED***open)***REMOVED***match++;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(node.data***REMOVED***===***REMOVED***close)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(match***REMOVED***===***REMOVED***0)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***nextSibling(node);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***match--;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***node;
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***replaceNode***REMOVED***=***REMOVED***(newNode,***REMOVED***oldNode,***REMOVED***parentComponent)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***parentNode2***REMOVED***=***REMOVED***oldNode.parentNode;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(parentNode2)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentNode2.replaceChild(newNode,***REMOVED***oldNode);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***parent***REMOVED***=***REMOVED***parentComponent;
***REMOVED******REMOVED******REMOVED******REMOVED***while***REMOVED***(parent)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(parent.vnode.el***REMOVED***===***REMOVED***oldNode)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parent.vnode.el***REMOVED***=***REMOVED***parent.subTree.el***REMOVED***=***REMOVED***newNode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parent***REMOVED***=***REMOVED***parent.parent;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***isTemplateNode***REMOVED***=***REMOVED***(node)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***node.nodeType***REMOVED***===***REMOVED***1***REMOVED***&&***REMOVED***node.tagName***REMOVED***===***REMOVED***"TEMPLATE";
***REMOVED******REMOVED***};
***REMOVED******REMOVED***return***REMOVED***[hydrate,***REMOVED***hydrateNode];
}
const***REMOVED***allowMismatchAttr***REMOVED***=***REMOVED***"data-allow-mismatch";
const***REMOVED***MismatchTypeString***REMOVED***=***REMOVED***{
***REMOVED******REMOVED***[0***REMOVED***/****REMOVED***TEXT***REMOVED****/]:***REMOVED***"text",
***REMOVED******REMOVED***[1***REMOVED***/****REMOVED***CHILDREN***REMOVED****/]:***REMOVED***"children",
***REMOVED******REMOVED***[2***REMOVED***/****REMOVED***CLASS***REMOVED****/]:***REMOVED***"class",
***REMOVED******REMOVED***[3***REMOVED***/****REMOVED***STYLE***REMOVED****/]:***REMOVED***"style",
***REMOVED******REMOVED***[4***REMOVED***/****REMOVED***ATTRIBUTE***REMOVED****/]:***REMOVED***"attribute"
};
function***REMOVED***isMismatchAllowed(el,***REMOVED***allowedType)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(allowedType***REMOVED***===***REMOVED***0***REMOVED***/****REMOVED***TEXT***REMOVED****/***REMOVED***||***REMOVED***allowedType***REMOVED***===***REMOVED***1***REMOVED***/****REMOVED***CHILDREN***REMOVED****/)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***while***REMOVED***(el***REMOVED***&&***REMOVED***!el.hasAttribute(allowMismatchAttr))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el***REMOVED***=***REMOVED***el.parentElement;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***allowedAttr***REMOVED***=***REMOVED***el***REMOVED***&&***REMOVED***el.getAttribute(allowMismatchAttr);
***REMOVED******REMOVED***if***REMOVED***(allowedAttr***REMOVED***==***REMOVED***null)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(allowedAttr***REMOVED***===***REMOVED***"")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***true;
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***list***REMOVED***=***REMOVED***allowedAttr.split(",");
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(allowedType***REMOVED***===***REMOVED***0***REMOVED***/****REMOVED***TEXT***REMOVED****/***REMOVED***&&***REMOVED***list.includes("children"))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***list.includes(MismatchTypeString[allowedType]);
***REMOVED******REMOVED***}
}

const***REMOVED***requestIdleCallback***REMOVED***=***REMOVED***shared.getGlobalThis().requestIdleCallback***REMOVED***||***REMOVED***((cb)***REMOVED***=>***REMOVED***setTimeout(cb,***REMOVED***1));
const***REMOVED***cancelIdleCallback***REMOVED***=***REMOVED***shared.getGlobalThis().cancelIdleCallback***REMOVED***||***REMOVED***((id)***REMOVED***=>***REMOVED***clearTimeout(id));
const***REMOVED***hydrateOnIdle***REMOVED***=***REMOVED***(timeout***REMOVED***=***REMOVED***1e4)***REMOVED***=>***REMOVED***(hydrate)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***id***REMOVED***=***REMOVED***requestIdleCallback(hydrate,***REMOVED***{***REMOVED***timeout***REMOVED***});
***REMOVED******REMOVED***return***REMOVED***()***REMOVED***=>***REMOVED***cancelIdleCallback(id);
};
function***REMOVED***elementIsVisibleInViewport(el)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***top,***REMOVED***left,***REMOVED***bottom,***REMOVED***right***REMOVED***}***REMOVED***=***REMOVED***el.getBoundingClientRect();
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***innerHeight,***REMOVED***innerWidth***REMOVED***}***REMOVED***=***REMOVED***window;
***REMOVED******REMOVED***return***REMOVED***(top***REMOVED***>***REMOVED***0***REMOVED***&&***REMOVED***top***REMOVED***<***REMOVED***innerHeight***REMOVED***||***REMOVED***bottom***REMOVED***>***REMOVED***0***REMOVED***&&***REMOVED***bottom***REMOVED***<***REMOVED***innerHeight)***REMOVED***&&***REMOVED***(left***REMOVED***>***REMOVED***0***REMOVED***&&***REMOVED***left***REMOVED***<***REMOVED***innerWidth***REMOVED***||***REMOVED***right***REMOVED***>***REMOVED***0***REMOVED***&&***REMOVED***right***REMOVED***<***REMOVED***innerWidth);
}
const***REMOVED***hydrateOnVisible***REMOVED***=***REMOVED***(opts)***REMOVED***=>***REMOVED***(hydrate,***REMOVED***forEach)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***ob***REMOVED***=***REMOVED***new***REMOVED***IntersectionObserver((entries)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(const***REMOVED***e***REMOVED***of***REMOVED***entries)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!e.isIntersecting)***REMOVED***continue;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ob.disconnect();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrate();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***break;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***},***REMOVED***opts);
***REMOVED******REMOVED***forEach((el)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!(el***REMOVED***instanceof***REMOVED***Element))***REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(elementIsVisibleInViewport(el))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrate();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ob.disconnect();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***ob.observe(el);
***REMOVED******REMOVED***});
***REMOVED******REMOVED***return***REMOVED***()***REMOVED***=>***REMOVED***ob.disconnect();
};
const***REMOVED***hydrateOnMediaQuery***REMOVED***=***REMOVED***(query)***REMOVED***=>***REMOVED***(hydrate)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(query)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***mql***REMOVED***=***REMOVED***matchMedia(query);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(mql.matches)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrate();
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mql.addEventListener("change",***REMOVED***hydrate,***REMOVED***{***REMOVED***once:***REMOVED***true***REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***()***REMOVED***=>***REMOVED***mql.removeEventListener("change",***REMOVED***hydrate);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
};
const***REMOVED***hydrateOnInteraction***REMOVED***=***REMOVED***(interactions***REMOVED***=***REMOVED***[])***REMOVED***=>***REMOVED***(hydrate,***REMOVED***forEach)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(shared.isString(interactions))***REMOVED***interactions***REMOVED***=***REMOVED***[interactions];
***REMOVED******REMOVED***let***REMOVED***hasHydrated***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED***const***REMOVED***doHydrate***REMOVED***=***REMOVED***(e)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!hasHydrated)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hasHydrated***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***teardown();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrate();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***e.target.dispatchEvent(new***REMOVED***e.constructor(e.type,***REMOVED***e));
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***teardown***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***forEach((el)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(const***REMOVED***i***REMOVED***of***REMOVED***interactions)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el.removeEventListener(i,***REMOVED***doHydrate);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED***};
***REMOVED******REMOVED***forEach((el)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(const***REMOVED***i***REMOVED***of***REMOVED***interactions)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el.addEventListener(i,***REMOVED***doHydrate,***REMOVED***{***REMOVED***once:***REMOVED***true***REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***});
***REMOVED******REMOVED***return***REMOVED***teardown;
};
function***REMOVED***forEachElement(node,***REMOVED***cb)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(isComment(node)***REMOVED***&&***REMOVED***node.data***REMOVED***===***REMOVED***"[")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***depth***REMOVED***=***REMOVED***1;
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***next***REMOVED***=***REMOVED***node.nextSibling;
***REMOVED******REMOVED******REMOVED******REMOVED***while***REMOVED***(next)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(next.nodeType***REMOVED***===***REMOVED***1)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***result***REMOVED***=***REMOVED***cb(next);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(result***REMOVED***===***REMOVED***false)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***break;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(isComment(next))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(next.data***REMOVED***===***REMOVED***"]")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(--depth***REMOVED***===***REMOVED***0)***REMOVED***break;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(next.data***REMOVED***===***REMOVED***"[")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***depth++;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***next***REMOVED***=***REMOVED***next.nextSibling;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***cb(node);
***REMOVED******REMOVED***}
}

const***REMOVED***isAsyncWrapper***REMOVED***=***REMOVED***(i)***REMOVED***=>***REMOVED***!!i.type.__asyncLoader;
//***REMOVED***@__NO_SIDE_EFFECTS__
function***REMOVED***defineAsyncComponent(source)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(shared.isFunction(source))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***source***REMOVED***=***REMOVED***{***REMOVED***loader:***REMOVED***source***REMOVED***};
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***loader,
***REMOVED******REMOVED******REMOVED******REMOVED***loadingComponent,
***REMOVED******REMOVED******REMOVED******REMOVED***errorComponent,
***REMOVED******REMOVED******REMOVED******REMOVED***delay***REMOVED***=***REMOVED***200,
***REMOVED******REMOVED******REMOVED******REMOVED***hydrate:***REMOVED***hydrateStrategy,
***REMOVED******REMOVED******REMOVED******REMOVED***timeout,
***REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***undefined***REMOVED***=***REMOVED***never***REMOVED***times***REMOVED***out
***REMOVED******REMOVED******REMOVED******REMOVED***suspensible***REMOVED***=***REMOVED***true,
***REMOVED******REMOVED******REMOVED******REMOVED***onError:***REMOVED***userOnError
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***source;
***REMOVED******REMOVED***let***REMOVED***pendingRequest***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED***let***REMOVED***resolvedComp;
***REMOVED******REMOVED***let***REMOVED***retries***REMOVED***=***REMOVED***0;
***REMOVED******REMOVED***const***REMOVED***retry***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***retries++;
***REMOVED******REMOVED******REMOVED******REMOVED***pendingRequest***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***load();
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***load***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***thisRequest;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***pendingRequest***REMOVED***||***REMOVED***(thisRequest***REMOVED***=***REMOVED***pendingRequest***REMOVED***=***REMOVED***loader().catch((err)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***err***REMOVED***=***REMOVED***err***REMOVED***instanceof***REMOVED***Error***REMOVED***?***REMOVED***err***REMOVED***:***REMOVED***new***REMOVED***Error(String(err));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(userOnError)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***userRetry***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***resolve(retry());
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***userFail***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***reject(err);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***userOnError(err,***REMOVED***userRetry,***REMOVED***userFail,***REMOVED***retries***REMOVED***+***REMOVED***1);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***throw***REMOVED***err;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}).then((comp)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(thisRequest***REMOVED***!==***REMOVED***pendingRequest***REMOVED***&&***REMOVED***pendingRequest)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***pendingRequest;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(comp***REMOVED***&&***REMOVED***(comp.__esModule***REMOVED***||***REMOVED***comp[Symbol.toStringTag]***REMOVED***===***REMOVED***"Module"))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***comp***REMOVED***=***REMOVED***comp.default;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***resolvedComp***REMOVED***=***REMOVED***comp;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***comp;
***REMOVED******REMOVED******REMOVED******REMOVED***}));
***REMOVED******REMOVED***};
***REMOVED******REMOVED***return***REMOVED***defineComponent({
***REMOVED******REMOVED******REMOVED******REMOVED***name:***REMOVED***"AsyncComponentWrapper",
***REMOVED******REMOVED******REMOVED******REMOVED***__asyncLoader:***REMOVED***load,
***REMOVED******REMOVED******REMOVED******REMOVED***__asyncHydrate(el,***REMOVED***instance,***REMOVED***hydrate)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***patched***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***(instance.bu***REMOVED***||***REMOVED***(instance.bu***REMOVED***=***REMOVED***[])).push(()***REMOVED***=>***REMOVED***patched***REMOVED***=***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***performHydrate***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(patched)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrate();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***doHydrate***REMOVED***=***REMOVED***hydrateStrategy***REMOVED***?***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***teardown***REMOVED***=***REMOVED***hydrateStrategy(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***performHydrate,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***(cb)***REMOVED***=>***REMOVED***forEachElement(el,***REMOVED***cb)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(teardown)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***(instance.bum***REMOVED***||***REMOVED***(instance.bum***REMOVED***=***REMOVED***[])).push(teardown);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***:***REMOVED***performHydrate;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(resolvedComp)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***doHydrate();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***load().then(()***REMOVED***=>***REMOVED***!instance.isUnmounted***REMOVED***&&***REMOVED***doHydrate());
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***get***REMOVED***__asyncResolved()***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***resolvedComp;
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***setup()***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***instance***REMOVED***=***REMOVED***currentInstance;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***markAsyncBoundary(instance);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(resolvedComp)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***()***REMOVED***=>***REMOVED***createInnerComp(resolvedComp,***REMOVED***instance);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***onError***REMOVED***=***REMOVED***(err)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pendingRequest***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***handleError(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***err,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***13,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***!errorComponent
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(suspensible***REMOVED***&&***REMOVED***instance.suspense***REMOVED***||***REMOVED***isInSSRComponentSetup)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***load().then((comp)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***()***REMOVED***=>***REMOVED***createInnerComp(comp,***REMOVED***instance);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}).catch((err)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***onError(err);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***()***REMOVED***=>***REMOVED***errorComponent***REMOVED***?***REMOVED***createVNode(errorComponent,***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***error:***REMOVED***err
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***})***REMOVED***:***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***loaded***REMOVED***=***REMOVED***reactivity.ref(false);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***error***REMOVED***=***REMOVED***reactivity.ref();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***delayed***REMOVED***=***REMOVED***reactivity.ref(!!delay);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(delay)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setTimeout(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***delayed.value***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***delay);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(timeout***REMOVED***!=***REMOVED***null)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setTimeout(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!loaded.value***REMOVED***&&***REMOVED***!error.value)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***err***REMOVED***=***REMOVED***new***REMOVED***Error(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***`Async***REMOVED***component***REMOVED***timed***REMOVED***out***REMOVED***after***REMOVED***${timeout}ms.`
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***onError(err);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***error.value***REMOVED***=***REMOVED***err;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***timeout);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***load().then(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***loaded.value***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(instance.parent***REMOVED***&&***REMOVED***isKeepAlive(instance.parent.vnode))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance.parent.update();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}).catch((err)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***onError(err);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(loaded.value***REMOVED***&&***REMOVED***resolvedComp)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***createInnerComp(resolvedComp,***REMOVED***instance);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(error.value***REMOVED***&&***REMOVED***errorComponent)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***createVNode(errorComponent,***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***error:***REMOVED***error.value
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(loadingComponent***REMOVED***&&***REMOVED***!delayed.value)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***createVNode(loadingComponent);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***});
}
function***REMOVED***createInnerComp(comp,***REMOVED***parent)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***ref:***REMOVED***ref2,***REMOVED***props,***REMOVED***children,***REMOVED***ce***REMOVED***}***REMOVED***=***REMOVED***parent.vnode;
***REMOVED******REMOVED***const***REMOVED***vnode***REMOVED***=***REMOVED***createVNode(comp,***REMOVED***props,***REMOVED***children);
***REMOVED******REMOVED***vnode.ref***REMOVED***=***REMOVED***ref2;
***REMOVED******REMOVED***vnode.ce***REMOVED***=***REMOVED***ce;
***REMOVED******REMOVED***delete***REMOVED***parent.vnode.ce;
***REMOVED******REMOVED***return***REMOVED***vnode;
}

const***REMOVED***isKeepAlive***REMOVED***=***REMOVED***(vnode)***REMOVED***=>***REMOVED***vnode.type.__isKeepAlive;
const***REMOVED***KeepAliveImpl***REMOVED***=***REMOVED***{
***REMOVED******REMOVED***name:***REMOVED***`KeepAlive`,
***REMOVED******REMOVED***//***REMOVED***Marker***REMOVED***for***REMOVED***special***REMOVED***handling***REMOVED***inside***REMOVED***the***REMOVED***renderer.***REMOVED***We***REMOVED***are***REMOVED***not***REMOVED***using***REMOVED***a***REMOVED***===
***REMOVED******REMOVED***//***REMOVED***check***REMOVED***directly***REMOVED***on***REMOVED***KeepAlive***REMOVED***in***REMOVED***the***REMOVED***renderer,***REMOVED***because***REMOVED***importing***REMOVED***it***REMOVED***directly
***REMOVED******REMOVED***//***REMOVED***would***REMOVED***prevent***REMOVED***it***REMOVED***from***REMOVED***being***REMOVED***tree-shaken.
***REMOVED******REMOVED***__isKeepAlive:***REMOVED***true,
***REMOVED******REMOVED***props:***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***include:***REMOVED***[String,***REMOVED***RegExp,***REMOVED***Array],
***REMOVED******REMOVED******REMOVED******REMOVED***exclude:***REMOVED***[String,***REMOVED***RegExp,***REMOVED***Array],
***REMOVED******REMOVED******REMOVED******REMOVED***max:***REMOVED***[String,***REMOVED***Number]
***REMOVED******REMOVED***},
***REMOVED******REMOVED***setup(props,***REMOVED***{***REMOVED***slots***REMOVED***})***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***instance***REMOVED***=***REMOVED***getCurrentInstance();
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***sharedContext***REMOVED***=***REMOVED***instance.ctx;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!sharedContext.renderer)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***children***REMOVED***=***REMOVED***slots.default***REMOVED***&&***REMOVED***slots.default();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***children***REMOVED***&&***REMOVED***children.length***REMOVED***===***REMOVED***1***REMOVED***?***REMOVED***children[0]***REMOVED***:***REMOVED***children;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***cache***REMOVED***=***REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***new***REMOVED***Map();
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***keys***REMOVED***=***REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***new***REMOVED***Set();
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***current***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***parentSuspense***REMOVED***=***REMOVED***instance.suspense;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***renderer:***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***p:***REMOVED***patch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***m:***REMOVED***move,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***um:***REMOVED***_unmount,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***o:***REMOVED***{***REMOVED***createElement***REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***=***REMOVED***sharedContext;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***storageContainer***REMOVED***=***REMOVED***createElement("div");
***REMOVED******REMOVED******REMOVED******REMOVED***sharedContext.activate***REMOVED***=***REMOVED***(vnode,***REMOVED***container,***REMOVED***anchor,***REMOVED***namespace,***REMOVED***optimized)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***instance2***REMOVED***=***REMOVED***vnode.component;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***move(vnode,***REMOVED***container,***REMOVED***anchor,***REMOVED***0,***REMOVED***parentSuspense);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance2.vnode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.slotScopeIds,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance2.isDeactivated***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(instance2.a)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.invokeArrayFns(instance2.a);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***vnodeHook***REMOVED***=***REMOVED***vnode.props***REMOVED***&&***REMOVED***vnode.props.onVnodeMounted;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(vnodeHook)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***invokeVNodeHook(vnodeHook,***REMOVED***instance2.parent,***REMOVED***vnode);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***parentSuspense);
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***sharedContext.deactivate***REMOVED***=***REMOVED***(vnode)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***instance2***REMOVED***=***REMOVED***vnode.component;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***invalidateMount(instance2.m);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***invalidateMount(instance2.a);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***move(vnode,***REMOVED***storageContainer,***REMOVED***null,***REMOVED***1,***REMOVED***parentSuspense);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***queuePostRenderEffect(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(instance2.da)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.invokeArrayFns(instance2.da);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***vnodeHook***REMOVED***=***REMOVED***vnode.props***REMOVED***&&***REMOVED***vnode.props.onVnodeUnmounted;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(vnodeHook)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***invokeVNodeHook(vnodeHook,***REMOVED***instance2.parent,***REMOVED***vnode);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance2.isDeactivated***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***parentSuspense);
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***function***REMOVED***unmount(vnode)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***resetShapeFlag(vnode);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***_unmount(vnode,***REMOVED***instance,***REMOVED***parentSuspense,***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***function***REMOVED***pruneCache(filter)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***cache.forEach((vnode,***REMOVED***key)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***name***REMOVED***=***REMOVED***getComponentName(vnode.type);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(name***REMOVED***&&***REMOVED***!filter(name))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pruneCacheEntry(key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***function***REMOVED***pruneCacheEntry(key)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***cached***REMOVED***=***REMOVED***cache.get(key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(cached***REMOVED***&&***REMOVED***(!current***REMOVED***||***REMOVED***!isSameVNodeType(cached,***REMOVED***current)))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***unmount(cached);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(current)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***resetShapeFlag(current);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***cache.delete(key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***keys.delete(key);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***watch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***()***REMOVED***=>***REMOVED***[props.include,***REMOVED***props.exclude],
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***([include,***REMOVED***exclude])***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***include***REMOVED***&&***REMOVED***pruneCache((name)***REMOVED***=>***REMOVED***matches(include,***REMOVED***name));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***exclude***REMOVED***&&***REMOVED***pruneCache((name)***REMOVED***=>***REMOVED***!matches(exclude,***REMOVED***name));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***prune***REMOVED***post-render***REMOVED***after***REMOVED***`current`***REMOVED***has***REMOVED***been***REMOVED***updated
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{***REMOVED***flush:***REMOVED***"post",***REMOVED***deep:***REMOVED***true***REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***pendingCacheKey***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***cacheSubtree***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(pendingCacheKey***REMOVED***!=***REMOVED***null)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isSuspense(instance.subTree.type))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***queuePostRenderEffect(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***cache.set(pendingCacheKey,***REMOVED***getInnerChild(instance.subTree));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***instance.subTree.suspense);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***cache.set(pendingCacheKey,***REMOVED***getInnerChild(instance.subTree));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***onMounted(cacheSubtree);
***REMOVED******REMOVED******REMOVED******REMOVED***onUpdated(cacheSubtree);
***REMOVED******REMOVED******REMOVED******REMOVED***onBeforeUnmount(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***cache.forEach((cached)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***subTree,***REMOVED***suspense***REMOVED***}***REMOVED***=***REMOVED***instance;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***vnode***REMOVED***=***REMOVED***getInnerChild(subTree);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(cached.type***REMOVED***===***REMOVED***vnode.type***REMOVED***&&***REMOVED***cached.key***REMOVED***===***REMOVED***vnode.key)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***resetShapeFlag(vnode);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***da***REMOVED***=***REMOVED***vnode.component.da;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***da***REMOVED***&&***REMOVED***queuePostRenderEffect(da,***REMOVED***suspense);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***unmount(cached);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pendingCacheKey***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!slots.default)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***current***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***children***REMOVED***=***REMOVED***slots.default();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***rawVNode***REMOVED***=***REMOVED***children[0];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(children.length***REMOVED***>***REMOVED***1)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***current***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***children;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(!isVNode(rawVNode)***REMOVED***||***REMOVED***!(rawVNode.shapeFlag***REMOVED***&***REMOVED***4)***REMOVED***&&***REMOVED***!(rawVNode.shapeFlag***REMOVED***&***REMOVED***128))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***current***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***rawVNode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***vnode***REMOVED***=***REMOVED***getInnerChild(rawVNode);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(vnode.type***REMOVED***===***REMOVED***Comment)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***current***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***vnode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***comp***REMOVED***=***REMOVED***vnode.type;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***name***REMOVED***=***REMOVED***getComponentName(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***isAsyncWrapper(vnode)***REMOVED***?***REMOVED***vnode.type.__asyncResolved***REMOVED***||***REMOVED***{}***REMOVED***:***REMOVED***comp
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***include,***REMOVED***exclude,***REMOVED***max***REMOVED***}***REMOVED***=***REMOVED***props;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(include***REMOVED***&&***REMOVED***(!name***REMOVED***||***REMOVED***!matches(include,***REMOVED***name))***REMOVED***||***REMOVED***exclude***REMOVED***&&***REMOVED***name***REMOVED***&&***REMOVED***matches(exclude,***REMOVED***name))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.shapeFlag***REMOVED***&=***REMOVED***-257;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***current***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***rawVNode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***key***REMOVED***=***REMOVED***vnode.key***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***comp***REMOVED***:***REMOVED***vnode.key;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***cachedVNode***REMOVED***=***REMOVED***cache.get(key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(vnode.el)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode***REMOVED***=***REMOVED***cloneVNode(vnode);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(rawVNode.shapeFlag***REMOVED***&***REMOVED***128)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***rawVNode.ssContent***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pendingCacheKey***REMOVED***=***REMOVED***key;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(cachedVNode)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.el***REMOVED***=***REMOVED***cachedVNode.el;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.component***REMOVED***=***REMOVED***cachedVNode.component;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(vnode.transition)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setTransitionHooks(vnode,***REMOVED***vnode.transition);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.shapeFlag***REMOVED***|=***REMOVED***512;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***keys.delete(key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***keys.add(key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***keys.add(key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(max***REMOVED***&&***REMOVED***keys.size***REMOVED***>***REMOVED***parseInt(max,***REMOVED***10))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pruneCacheEntry(keys.values().next().value);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.shapeFlag***REMOVED***|=***REMOVED***256;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***current***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***isSuspense(rawVNode.type)***REMOVED***?***REMOVED***rawVNode***REMOVED***:***REMOVED***vnode;
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED***}
};
const***REMOVED***KeepAlive***REMOVED***=***REMOVED***KeepAliveImpl;
function***REMOVED***matches(pattern,***REMOVED***name)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(shared.isArray(pattern))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***pattern.some((p)***REMOVED***=>***REMOVED***matches(p,***REMOVED***name));
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isString(pattern))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***pattern.split(",").includes(name);
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isRegExp(pattern))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***pattern.lastIndex***REMOVED***=***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***pattern.test(name);
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***shared.remove(keepAliveRoot[type],***REMOVED***injected);
***REMOVED******REMOVED***},***REMOVED***target);
}
function***REMOVED***resetShapeFlag(vnode)***REMOVED***{
***REMOVED******REMOVED***vnode.shapeFlag***REMOVED***&=***REMOVED***-257;
***REMOVED******REMOVED***vnode.shapeFlag***REMOVED***&=***REMOVED***-513;
}
function***REMOVED***getInnerChild(vnode)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***vnode.shapeFlag***REMOVED***&***REMOVED***128***REMOVED***?***REMOVED***vnode.ssContent***REMOVED***:***REMOVED***vnode;
}
...
const***REMOVED***COMPONENTS***REMOVED***=***REMOVED***"components";
const***REMOVED***DIRECTIVES***REMOVED***=***REMOVED***"directives";
function***REMOVED***resolveComponent(name,***REMOVED***maybeSelfReference)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***resolveAsset(COMPONENTS,***REMOVED***name,***REMOVED***true,***REMOVED***maybeSelfReference)***REMOVED***||***REMOVED***name;
}
const***REMOVED***NULL_DYNAMIC_COMPONENT***REMOVED***=***REMOVED***Symbol.for("v-ndc");
function***REMOVED***resolveDynamicComponent(component)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(shared.isString(component))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***resolveAsset(COMPONENTS,***REMOVED***component,***REMOVED***false)***REMOVED***||***REMOVED***component;
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***component***REMOVED***||***REMOVED***NULL_DYNAMIC_COMPONENT;
***REMOVED******REMOVED***}
}
function***REMOVED***resolveDirective(name)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***resolveAsset(DIRECTIVES,***REMOVED***name);
}
function***REMOVED***resolveAsset(type,***REMOVED***name,***REMOVED***warnMissing***REMOVED***=***REMOVED***true,***REMOVED***maybeSelfReference***REMOVED***=***REMOVED***false)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***instance***REMOVED***=***REMOVED***currentRenderingInstance***REMOVED***||***REMOVED***currentInstance;
***REMOVED******REMOVED***if***REMOVED***(instance)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***Component***REMOVED***=***REMOVED***instance.type;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(type***REMOVED***===***REMOVED***COMPONENTS)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***selfName***REMOVED***=***REMOVED***getComponentName(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***Component,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***false
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(selfName***REMOVED***&&***REMOVED***(selfName***REMOVED***===***REMOVED***name***REMOVED***||***REMOVED***selfName***REMOVED***===***REMOVED***shared.camelize(name)***REMOVED***||***REMOVED***selfName***REMOVED***===***REMOVED***shared.capitalize(shared.camelize(name))))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***Component;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***res***REMOVED***=***REMOVED***(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***local***REMOVED***registration
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***check***REMOVED***instance[type]***REMOVED***first***REMOVED***which***REMOVED***is***REMOVED***resolved***REMOVED***for***REMOVED***options***REMOVED***API
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***resolve(instance[type]***REMOVED***||***REMOVED***Component[type],***REMOVED***name)***REMOVED***||***REMOVED***//***REMOVED***global***REMOVED***registration
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***resolve(instance.appContext[type],***REMOVED***name)
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!res***REMOVED***&&***REMOVED***maybeSelfReference)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***Component;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***res;
***REMOVED******REMOVED***}
}
function***REMOVED***resolve(registry,***REMOVED***name)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***registry***REMOVED***&&***REMOVED***(registry[name]***REMOVED***||***REMOVED***registry[shared.camelize(name)]***REMOVED***||***REMOVED***registry[shared.capitalize(shared.camelize(name))]);
}

function***REMOVED***renderList(source,***REMOVED***renderItem,***REMOVED***cache,***REMOVED***index)***REMOVED***{
***REMOVED******REMOVED***let***REMOVED***ret;
***REMOVED******REMOVED***const***REMOVED***cached***REMOVED***=***REMOVED***cache***REMOVED***&&***REMOVED***cache[index];
***REMOVED******REMOVED***const***REMOVED***sourceIsArray***REMOVED***=***REMOVED***shared.isArray(source);
***REMOVED******REMOVED***if***REMOVED***(sourceIsArray***REMOVED***||***REMOVED***shared.isString(source))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***sourceIsReactiveArray***REMOVED***=***REMOVED***sourceIsArray***REMOVED***&&***REMOVED***reactivity.isReactive(source);
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***needsWrap***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***isReadonlySource***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(sourceIsReactiveArray)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***needsWrap***REMOVED***=***REMOVED***!reactivity.isShallow(source);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***isReadonlySource***REMOVED***=***REMOVED***reactivity.isReadonly(source);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***source***REMOVED***=***REMOVED***reactivity.shallowReadArray(source);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***ret***REMOVED***=***REMOVED***new***REMOVED***Array(source.length);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret[i]***REMOVED***=***REMOVED***renderItem(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***needsWrap***REMOVED***?***REMOVED***isReadonlySource***REMOVED***?***REMOVED***reactivity.toReadonly(reactivity.toReactive(source[i]))***REMOVED***:***REMOVED***reactivity.toReactive(source[i])***REMOVED***:***REMOVED***source[i],
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***cached***REMOVED***&&***REMOVED***cached[i]
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(typeof***REMOVED***source***REMOVED***===***REMOVED***"number")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***ret***REMOVED***=***REMOVED***new***REMOVED***Array(source);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret[i]***REMOVED***=***REMOVED***renderItem(i***REMOVED***+***REMOVED***1,***REMOVED***i,***REMOVED***void***REMOVED***0,***REMOVED***cached***REMOVED***&&***REMOVED***cached[i]);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isObject(source))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(source[Symbol.iterator])***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret***REMOVED***=***REMOVED***Array.from(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***source,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***(item,***REMOVED***i)***REMOVED***=>***REMOVED***renderItem(item,***REMOVED***i,***REMOVED***void***REMOVED***0,***REMOVED***cached***REMOVED***&&***REMOVED***cached[i])
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***keys***REMOVED***=***REMOVED***Object.keys(source);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret***REMOVED***=***REMOVED***new***REMOVED***Array(keys.length);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret[i]***REMOVED***=***REMOVED***renderItem(source[key],***REMOVED***key,***REMOVED***i,***REMOVED***cached***REMOVED***&&***REMOVED***cached[i]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***ret***REMOVED***=***REMOVED***[];
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(cache)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***cache[index]***REMOVED***=***REMOVED***ret;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***ret;
}

function***REMOVED***createSlots(slots,***REMOVED***dynamicSlots)***REMOVED***{
***REMOVED******REMOVED***for***REMOVED***(let***REMOVED***i***REMOVED***=***REMOVED***0;***REMOVED***i***REMOVED***<***REMOVED***dynamicSlots.length;***REMOVED***i++)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***slot***REMOVED***=***REMOVED***dynamicSlots[i];
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isArray(slot))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(let***REMOVED***j***REMOVED***=***REMOVED***0;***REMOVED***j***REMOVED***<***REMOVED***slot.length;***REMOVED***j++)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slots[slot[j].name]***REMOVED***=***REMOVED***slot[j].fn;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(slot)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slots[slot.name]***REMOVED***=***REMOVED***slot.key***REMOVED***?***REMOVED***(...args)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***res***REMOVED***=***REMOVED***slot.fn(...args);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(res)***REMOVED***res.key***REMOVED***=***REMOVED***slot.key;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***res;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***:***REMOVED***slot.fn;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***slots;
}

function***REMOVED***renderSlot(slots,***REMOVED***name,***REMOVED***props***REMOVED***=***REMOVED***{},***REMOVED***fallback,***REMOVED***noSlotted)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(currentRenderingInstance.ce***REMOVED***||***REMOVED***currentRenderingInstance.parent***REMOVED***&&***REMOVED***isAsyncWrapper(currentRenderingInstance.parent)***REMOVED***&&***REMOVED***currentRenderingInstance.parent.ce)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(name***REMOVED***!==***REMOVED***"default")***REMOVED***props.name***REMOVED***=***REMOVED***name;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***openBlock(),***REMOVED***createBlock(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***Fragment,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***[createVNode("slot",***REMOVED***props,***REMOVED***fallback***REMOVED***&&***REMOVED***fallback())],
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***64
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***let***REMOVED***slot***REMOVED***=***REMOVED***slots[name];
***REMOVED******REMOVED***if***REMOVED***(slot***REMOVED***&&***REMOVED***slot._c)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***slot._d***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***openBlock();
***REMOVED******REMOVED***const***REMOVED***validSlotContent***REMOVED***=***REMOVED***slot***REMOVED***&&***REMOVED***ensureValidVNode(slot(props));
***REMOVED******REMOVED***const***REMOVED***slotKey***REMOVED***=***REMOVED***props.key***REMOVED***||***REMOVED***//***REMOVED***slot***REMOVED***content***REMOVED***array***REMOVED***of***REMOVED***a***REMOVED***dynamic***REMOVED***conditional***REMOVED***slot***REMOVED***may***REMOVED***have***REMOVED***a***REMOVED***branch
***REMOVED******REMOVED***//***REMOVED***key***REMOVED***attached***REMOVED***in***REMOVED***the***REMOVED***`createSlots`***REMOVED***helper,***REMOVED***respect***REMOVED***that
***REMOVED******REMOVED***validSlotContent***REMOVED***&&***REMOVED***validSlotContent.key;
***REMOVED******REMOVED***const***REMOVED***rendered***REMOVED***=***REMOVED***createBlock(
***REMOVED******REMOVED******REMOVED******REMOVED***Fragment,
***REMOVED******REMOVED******REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***key:***REMOVED***(slotKey***REMOVED***&&***REMOVED***!shared.isSymbol(slotKey)***REMOVED***?***REMOVED***slotKey***REMOVED***:***REMOVED***`_${name}`)***REMOVED***+***REMOVED***//***REMOVED***#7256***REMOVED***force***REMOVED***differentiate***REMOVED***fallback***REMOVED***content***REMOVED***from***REMOVED***actual***REMOVED***content
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***(!validSlotContent***REMOVED***&&***REMOVED***fallback***REMOVED***?***REMOVED***"_fb"***REMOVED***:***REMOVED***"")
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***validSlotContent***REMOVED***||***REMOVED***(fallback***REMOVED***?***REMOVED***fallback()***REMOVED***:***REMOVED***[]),
***REMOVED******REMOVED******REMOVED******REMOVED***validSlotContent***REMOVED***&&***REMOVED***slots._***REMOVED***===***REMOVED***1***REMOVED***?***REMOVED***64***REMOVED***:***REMOVED***-2
***REMOVED******REMOVED***);
***REMOVED******REMOVED***if***REMOVED***(!noSlotted***REMOVED***&&***REMOVED***rendered.scopeId)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***rendered.slotScopeIds***REMOVED***=***REMOVED***[rendered.scopeId***REMOVED***+***REMOVED***"-s"];
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(slot***REMOVED***&&***REMOVED***slot._c)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***slot._d***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***rendered;
}
function***REMOVED***ensureValidVNode(vnodes)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***vnodes.some((child)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!isVNode(child))***REMOVED***return***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(child.type***REMOVED***===***REMOVED***Comment)***REMOVED***return***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(child.type***REMOVED***===***REMOVED***Fragment***REMOVED***&&***REMOVED***!ensureValidVNode(child.children))
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***true;
***REMOVED******REMOVED***})***REMOVED***?***REMOVED***vnodes***REMOVED***:***REMOVED***null;
}

function***REMOVED***toHandlers(obj,***REMOVED***preserveCaseIfNecessary)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***ret[preserveCaseIfNecessary***REMOVED***&&***REMOVED***/[A-Z]/.test(key)***REMOVED***?***REMOVED***`on:${key}`***REMOVED***:***REMOVED***shared.toHandlerKey(key)]***REMOVED***=***REMOVED***obj[key];
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***ret;
}
...
***REMOVED******REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***shared.extend(/****REMOVED***@__PURE__***REMOVED****/***REMOVED***Object.create(null),***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***$props:***REMOVED***(i)***REMOVED***=>***REMOVED***i.props,
***REMOVED******REMOVED******REMOVED******REMOVED***$attrs:***REMOVED***(i)***REMOVED***=>***REMOVED***i.attrs,
***REMOVED******REMOVED******REMOVED******REMOVED***$slots:***REMOVED***(i)***REMOVED***=>***REMOVED***i.slots,
***REMOVED******REMOVED******REMOVED******REMOVED***$refs:***REMOVED***(i)***REMOVED***=>***REMOVED***i.refs,
...
const***REMOVED***hasSetupBinding***REMOVED***=***REMOVED***(state,***REMOVED***key)***REMOVED***=>***REMOVED***state***REMOVED***!==***REMOVED***shared.EMPTY_OBJ***REMOVED***&&***REMOVED***!state.__isScriptSetup***REMOVED***&&***REMOVED***shared.hasOwn(state,***REMOVED***key);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(data***REMOVED***!==***REMOVED***shared.EMPTY_OBJ***REMOVED***&&***REMOVED***shared.hasOwn(data,***REMOVED***key))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***(normalizedProps***REMOVED***=***REMOVED***instance.propsOptions[0])***REMOVED***&&***REMOVED***shared.hasOwn(normalizedProps,***REMOVED***key)
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(ctx***REMOVED***!==***REMOVED***shared.EMPTY_OBJ***REMOVED***&&***REMOVED***shared.hasOwn(ctx,***REMOVED***key))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***reactivity.track(instance.attrs,***REMOVED***"get",***REMOVED***"");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(ctx***REMOVED***!==***REMOVED***shared.EMPTY_OBJ***REMOVED***&&***REMOVED***shared.hasOwn(ctx,***REMOVED***key))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***globalProperties***REMOVED***=***REMOVED***appContext.config.globalProperties,***REMOVED***shared.hasOwn(globalProperties,***REMOVED***key)
***REMOVED******REMOVED******REMOVED******REMOVED***)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(data***REMOVED***!==***REMOVED***shared.EMPTY_OBJ***REMOVED***&&***REMOVED***shared.hasOwn(data,***REMOVED***key))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***data[key]***REMOVED***=***REMOVED***value;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.hasOwn(instance.props,***REMOVED***key))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***!!(accessCache[key]***REMOVED***||***REMOVED***data***REMOVED***!==***REMOVED***shared.EMPTY_OBJ***REMOVED***&&***REMOVED***key[0]***REMOVED***!==***REMOVED***"$"***REMOVED***&&***REMOVED***shared.hasOwn(data,***REMOVED***key)***REMOVED***||***REMOVED***hasSetupBinding(setupState,***REMOVED***key)***REMOVED***||***REMOVED***(normalizedProps***REMOVED***=***REMOVED***propsOptions[0])***REMOVED***&&***REMOVED***shared.hasOwn(normalizedProps,***REMOVED***key)***REMOVED***||***REMOVED***shared.hasOwn(ctx,***REMOVED***key)***REMOVED***||***REMOVED***shared.hasOwn(publicPropertiesMap,***REMOVED***key)***REMOVED***||***REMOVED***shared.hasOwn(appContext.config.globalProperties,***REMOVED***key)***REMOVED***||***REMOVED***(cssModules***REMOVED***=***REMOVED***type.__cssModules)***REMOVED***&&***REMOVED***cssModules[key]);
***REMOVED******REMOVED***},
...
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.hasOwn(descriptor,***REMOVED***"value"))***REMOVED***{
...
const***REMOVED***RuntimeCompiledPublicInstanceProxyHandlers***REMOVED***=***REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***shared.extend({},***REMOVED***PublicInstanceProxyHandlers,***REMOVED***{
***REMOVED******REMOVED***get(target,***REMOVED***key)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(key***REMOVED***===***REMOVED***Symbol.unscopables)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***PublicInstanceProxyHandlers.get(target,***REMOVED***key,***REMOVED***target);
***REMOVED******REMOVED***},
***REMOVED******REMOVED***has(_,***REMOVED***key)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***has***REMOVED***=***REMOVED***key[0]***REMOVED***!==***REMOVED***"_"***REMOVED***&&***REMOVED***!shared.isGloballyAllowed(key);
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***has;
***REMOVED******REMOVED***}
});

function***REMOVED***defineProps()***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***null;
}
function***REMOVED***defineEmits()***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***null;
}
function***REMOVED***defineExpose(exposed)***REMOVED***{
}
function***REMOVED***defineOptions(options)***REMOVED***{
}
function***REMOVED***defineSlots()***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***null;
}
function***REMOVED***defineModel()***REMOVED***{
}
function***REMOVED***withDefaults(props,***REMOVED***defaults)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***null;
}
function***REMOVED***useSlots()***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***getContext().slots;
}
function***REMOVED***useAttrs()***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***getContext().attrs;
}
function***REMOVED***getContext(calledFunctionName)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***i***REMOVED***=***REMOVED***getCurrentInstance();
***REMOVED******REMOVED***return***REMOVED***i.setupContext***REMOVED***||***REMOVED***(i.setupContext***REMOVED***=***REMOVED***createSetupContext(i));
}
function***REMOVED***normalizePropsOrEmits(props)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***shared.isArray(props)***REMOVED***?***REMOVED***props.reduce(
...
function***REMOVED***mergeDefaults(raw,***REMOVED***defaults)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***props***REMOVED***=***REMOVED***normalizePropsOrEmits(raw);
***REMOVED******REMOVED***for***REMOVED***(const***REMOVED***key***REMOVED***in***REMOVED***defaults)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(key.startsWith("__skip"))***REMOVED***continue;
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***opt***REMOVED***=***REMOVED***props[key];
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(opt)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isArray(opt)***REMOVED***||***REMOVED***shared.isFunction(opt))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***opt***REMOVED***=***REMOVED***props[key]***REMOVED***=***REMOVED***{***REMOVED***type:***REMOVED***opt,***REMOVED***default:***REMOVED***defaults[key]***REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***opt.default***REMOVED***=***REMOVED***defaults[key];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(opt***REMOVED***===***REMOVED***null)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***opt***REMOVED***=***REMOVED***props[key]***REMOVED***=***REMOVED***{***REMOVED***default:***REMOVED***defaults[key]***REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(opt***REMOVED***&&***REMOVED***defaults[`__skip_${key}`])***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***opt.skipFactory***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***props;
}
function***REMOVED***mergeModels(a,***REMOVED***b)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(!a***REMOVED***||***REMOVED***!b)***REMOVED***return***REMOVED***a***REMOVED***||***REMOVED***b;
***REMOVED******REMOVED***if***REMOVED***(shared.isArray(a)***REMOVED***&&***REMOVED***shared.isArray(b))***REMOVED***return***REMOVED***a.concat(b);
***REMOVED******REMOVED***return***REMOVED***shared.extend({},***REMOVED***normalizePropsOrEmits(a),***REMOVED***normalizePropsOrEmits(b));
}
function***REMOVED***createPropsRestProxy(props,***REMOVED***excludedKeys)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***ret***REMOVED***=***REMOVED***{};
***REMOVED******REMOVED***for***REMOVED***(const***REMOVED***key***REMOVED***in***REMOVED***props)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!excludedKeys.includes(key))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***Object.defineProperty(ret,***REMOVED***key,***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***enumerable:***REMOVED***true,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***get:***REMOVED***()***REMOVED***=>***REMOVED***props[key]
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***ret;
}
function***REMOVED***withAsyncContext(getAwaitable)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***ctx***REMOVED***=***REMOVED***getCurrentInstance();
***REMOVED******REMOVED***let***REMOVED***awaitable***REMOVED***=***REMOVED***getAwaitable();
***REMOVED******REMOVED***unsetCurrentInstance();
***REMOVED******REMOVED***if***REMOVED***(shared.isPromise(awaitable))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***awaitable***REMOVED***=***REMOVED***awaitable.catch((e)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setCurrentInstance(ctx);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***throw***REMOVED***e;
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***[awaitable,***REMOVED***()***REMOVED***=>***REMOVED***setCurrentInstance(ctx)];
}
...
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***options;
***REMOVED******REMOVED***const***REMOVED***checkDuplicateProperties***REMOVED***=***REMOVED***null;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isFunction(methodHandler))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ctx[key]***REMOVED***=***REMOVED***methodHandler.bind(publicThis);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!shared.isObject(data))***REMOVED***;***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance.data***REMOVED***=***REMOVED***reactivity.reactive(data);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***get***REMOVED***=***REMOVED***shared.isFunction(opt)***REMOVED***?***REMOVED***opt.bind(publicThis,***REMOVED***publicThis)***REMOVED***:***REMOVED***shared.isFunction(opt.get)***REMOVED***?***REMOVED***opt.get.bind(publicThis,***REMOVED***publicThis)***REMOVED***:***REMOVED***shared.NOOP;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***set***REMOVED***=***REMOVED***!shared.isFunction(opt)***REMOVED***&&***REMOVED***shared.isFunction(opt.set)***REMOVED***?***REMOVED***opt.set.bind(publicThis)***REMOVED***:***REMOVED***shared.NOOP;
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***provides***REMOVED***=***REMOVED***shared.isFunction(provideOptions)***REMOVED***?***REMOVED***provideOptions.call(publicThis)***REMOVED***:***REMOVED***provideOptions;
...
***REMOVED******REMOVED***if***REMOVED***(shared.isArray(expose))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(render***REMOVED***&&***REMOVED***instance.render***REMOVED***===***REMOVED***shared.NOOP)***REMOVED***{
...
function***REMOVED***resolveInjections(injectOptions,***REMOVED***ctx,***REMOVED***checkDuplicateProperties***REMOVED***=***REMOVED***shared.NOOP)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(shared.isArray(injectOptions))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isObject(opt))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(reactivity.isRef(injected))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***Object.defineProperty(ctx,***REMOVED***key,***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***enumerable:***REMOVED***true,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***configurable:***REMOVED***true,
...
***REMOVED******REMOVED******REMOVED******REMOVED***shared.isArray(hook)***REMOVED***?***REMOVED***hook.map((h)***REMOVED***=>***REMOVED***h.bind(instance.proxy))***REMOVED***:***REMOVED***hook.bind(instance.proxy),
...
***REMOVED******REMOVED***if***REMOVED***(shared.isString(raw))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***handler***REMOVED***=***REMOVED***ctx[raw];
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isFunction(handler))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***watch(getter,***REMOVED***handler);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isFunction(raw))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***watch(getter,***REMOVED***raw.bind(publicThis));
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isObject(raw))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isArray(raw))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***handler***REMOVED***=***REMOVED***shared.isFunction(raw.handler)***REMOVED***?***REMOVED***raw.handler.bind(publicThis)***REMOVED***:***REMOVED***ctx[raw.handler];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isFunction(handler))***REMOVED***{
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(shared.isObject(base))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(asMixin***REMOVED***&&***REMOVED***key***REMOVED***===***REMOVED***"expose")***REMOVED***;***REMOVED***else***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***(shared.extend)(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.isFunction(to)***REMOVED***?***REMOVED***to.call(this,***REMOVED***this)***REMOVED***:***REMOVED***to,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.isFunction(from)***REMOVED***?***REMOVED***from.call(this,***REMOVED***this)***REMOVED***:***REMOVED***from
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED***};
}
...
***REMOVED******REMOVED***if***REMOVED***(shared.isArray(raw))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***res***REMOVED***=***REMOVED***{};
...
***REMOVED******REMOVED***return***REMOVED***to***REMOVED***?***REMOVED***shared.extend(/****REMOVED***@__PURE__***REMOVED****/***REMOVED***Object.create(null),***REMOVED***to,***REMOVED***from)***REMOVED***:***REMOVED***from;
}
function***REMOVED***mergeEmitsOrPropsOptions(to,***REMOVED***from)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(to)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isArray(to)***REMOVED***&&***REMOVED***shared.isArray(from))***REMOVED***{
...
***REMOVED******REMOVED***const***REMOVED***merged***REMOVED***=***REMOVED***shared.extend(/****REMOVED***@__PURE__***REMOVED****/***REMOVED***Object.create(null),***REMOVED***to);
***REMOVED******REMOVED***for***REMOVED***(const***REMOVED***key***REMOVED***in***REMOVED***from)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***isNativeTag:***REMOVED***shared.NO,
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!shared.isFunction(rootComponent))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***rootComponent***REMOVED***=***REMOVED***shared.extend({},***REMOVED***rootComponent);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(rootProps***REMOVED***!=***REMOVED***null***REMOVED***&&***REMOVED***!shared.isObject(rootProps))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(installedPlugins.has(plugin))***REMOVED***;***REMOVED***else***REMOVED***if***REMOVED***(plugin***REMOVED***&&***REMOVED***shared.isFunction(plugin.install))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isFunction(plugin))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***installedPlugins.add(plugin);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isHydrate***REMOVED***&&***REMOVED***hydrate)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrate(vnode,***REMOVED***rootContainer);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(!currentInstance)***REMOVED***;***REMOVED***else***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***treatDefaultAsFactory***REMOVED***&&***REMOVED***shared.isFunction(defaultValue)***REMOVED***?***REMOVED***defaultValue.call(instance***REMOVED***&&***REMOVED***instance.proxy)***REMOVED***:***REMOVED***defaultValue;
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***;
***REMOVED******REMOVED***}
}
function***REMOVED***hasInjectionContext()***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***!!(getCurrentInstance()***REMOVED***||***REMOVED***currentApp);
}
...
***REMOVED******REMOVED******REMOVED******REMOVED***instance.props***REMOVED***=***REMOVED***isSSR***REMOVED***?***REMOVED***props***REMOVED***:***REMOVED***reactivity.shallowReactive(props);
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
...
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***instance;
***REMOVED******REMOVED***const***REMOVED***rawCurrentProps***REMOVED***=***REMOVED***reactivity.toRaw(props);
...
***REMOVED******REMOVED******REMOVED******REMOVED***(optimized***REMOVED***||***REMOVED***patchFlag***REMOVED***>***REMOVED***0)***REMOVED***&&***REMOVED***!(patchFlag***REMOVED***&***REMOVED***16)
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.hasOwn(attrs,***REMOVED***key))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***camelizedKey***REMOVED***=***REMOVED***shared.camelize(key);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***!shared.hasOwn(rawProps,***REMOVED***key)***REMOVED***&&***REMOVED***//***REMOVED***it's***REMOVED***possible***REMOVED***the***REMOVED***original***REMOVED***props***REMOVED***was***REMOVED***passed***REMOVED***in***REMOVED***as***REMOVED***kebab-case
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***and***REMOVED***converted***REMOVED***to***REMOVED***camelCase***REMOVED***(#955)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***((kebabKey***REMOVED***=***REMOVED***shared.hyphenate(key))***REMOVED***===***REMOVED***key***REMOVED***||***REMOVED***!shared.hasOwn(rawProps,***REMOVED***kebabKey)))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(options)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!rawProps***REMOVED***||***REMOVED***!shared.hasOwn(rawProps,***REMOVED***key)***REMOVED***&&***REMOVED***true)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***reactivity.trigger(instance.attrs,***REMOVED***"set",***REMOVED***"");
***REMOVED******REMOVED***}
}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isReservedProp(key))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***continue;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(options***REMOVED***&&***REMOVED***shared.hasOwn(options,***REMOVED***camelKey***REMOVED***=***REMOVED***shared.camelize(key)))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***rawCurrentProps***REMOVED***=***REMOVED***reactivity.toRaw(props);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***castValues***REMOVED***=***REMOVED***rawCastValues***REMOVED***||***REMOVED***shared.EMPTY_OBJ;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***!shared.hasOwn(castValues,***REMOVED***key)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***hasDefault***REMOVED***=***REMOVED***shared.hasOwn(opt,***REMOVED***"default");
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(opt.type***REMOVED***!==***REMOVED***Function***REMOVED***&&***REMOVED***!opt.skipFactory***REMOVED***&&***REMOVED***shared.isFunction(defaultValue))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(opt[1***REMOVED***/****REMOVED***shouldCastTrue***REMOVED****/]***REMOVED***&&***REMOVED***(value***REMOVED***===***REMOVED***""***REMOVED***||***REMOVED***value***REMOVED***===***REMOVED***shared.hyphenate(key)))***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(!shared.isFunction(comp))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.extend(normalized,***REMOVED***props);
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isObject(comp))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***cache.set(comp,***REMOVED***shared.EMPTY_ARR);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***shared.EMPTY_ARR;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(shared.isArray(raw))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***for***REMOVED***(let***REMOVED***i***REMOVED***=***REMOVED***0;***REMOVED***i***REMOVED***<***REMOVED***raw.length;***REMOVED***i++)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***normalizedKey***REMOVED***=***REMOVED***shared.camelize(raw[i]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(validatePropName(normalizedKey))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***normalized[normalizedKey]***REMOVED***=***REMOVED***shared.EMPTY_OBJ;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***normalizedKey***REMOVED***=***REMOVED***shared.camelize(key);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(validatePropName(normalizedKey))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***opt***REMOVED***=***REMOVED***raw[key];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***prop***REMOVED***=***REMOVED***normalized[normalizedKey]***REMOVED***=***REMOVED***shared.isArray(opt)***REMOVED***||***REMOVED***shared.isFunction(opt)***REMOVED***?***REMOVED***{***REMOVED***type:***REMOVED***opt***REMOVED***}***REMOVED***:***REMOVED***shared.extend({},***REMOVED***opt);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isArray(propType))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***typeName***REMOVED***=***REMOVED***shared.isFunction(type)***REMOVED***&&***REMOVED***type.name;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shouldCast***REMOVED***=***REMOVED***shared.isFunction(propType)***REMOVED***&&***REMOVED***propType.name***REMOVED***===***REMOVED***"Boolean";
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shouldCast***REMOVED***||***REMOVED***shared.hasOwn(prop,***REMOVED***"default"))***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(shared.isObject(comp))***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(key[0]***REMOVED***!==***REMOVED***"$"***REMOVED***&&***REMOVED***!shared.isReservedProp(key))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***true;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***false;
}
...
const***REMOVED***normalizeSlotValue***REMOVED***=***REMOVED***(value)***REMOVED***=>***REMOVED***shared.isArray(value)***REMOVED***?***REMOVED***value.map(normalizeVNode)***REMOVED***:***REMOVED***[normalizeVNode(value)];
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(false)***REMOVED***;
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isFunction(value))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.def(slots,***REMOVED***"_",***REMOVED***type,***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
...
***REMOVED******REMOVED***let***REMOVED***deletionComparisonTarget***REMOVED***=***REMOVED***shared.EMPTY_OBJ;
***REMOVED******REMOVED***if***REMOVED***(vnode.shapeFlag***REMOVED***&***REMOVED***32)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***type***REMOVED***=***REMOVED***children._;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(type)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(optimized***REMOVED***&&***REMOVED***type***REMOVED***===***REMOVED***1)***REMOVED***{
...
function***REMOVED***createHydrationRenderer(options)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***baseCreateRenderer(options,***REMOVED***createHydrationFunctions);
}
function***REMOVED***baseCreateRenderer(options,***REMOVED***createHydrationFns)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***target***REMOVED***=***REMOVED***shared.getGlobalThis();
...
***REMOVED******REMOVED******REMOVED******REMOVED***setScopeId:***REMOVED***hostSetScopeId***REMOVED***=***REMOVED***shared.NOOP,
***REMOVED******REMOVED******REMOVED******REMOVED***insertStaticContent:***REMOVED***hostInsertStaticContent
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***options;
***REMOVED******REMOVED***const***REMOVED***patch***REMOVED***=***REMOVED***(n1,***REMOVED***n2,***REMOVED***container,***REMOVED***anchor***REMOVED***=***REMOVED***null,***REMOVED***parentComponent***REMOVED***=***REMOVED***null,***REMOVED***parentSuspense***REMOVED***=***REMOVED***null,***REMOVED***namespace***REMOVED***=***REMOVED***void***REMOVED***0,***REMOVED***slotScopeIds***REMOVED***=***REMOVED***null,***REMOVED***optimized***REMOVED***=***REMOVED***!!n2.dynamicChildren)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(key***REMOVED***!==***REMOVED***"value"***REMOVED***&&***REMOVED***!shared.isReservedProp(key))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***child***REMOVED***=***REMOVED***children[i]***REMOVED***=***REMOVED***optimized***REMOVED***?***REMOVED***cloneIfMounted(children[i])***REMOVED***:***REMOVED***normalizeVNode(children[i]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***oldProps***REMOVED***=***REMOVED***n1.props***REMOVED***||***REMOVED***shared.EMPTY_OBJ;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***newProps***REMOVED***=***REMOVED***n2.props***REMOVED***||***REMOVED***shared.EMPTY_OBJ;
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***vnodeHook;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(oldProps***REMOVED***!==***REMOVED***shared.EMPTY_OBJ)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!shared.isReservedProp(key)***REMOVED***&&***REMOVED***!(key***REMOVED***in***REMOVED***newProps))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isReservedProp(key))***REMOVED***continue;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***#2080***REMOVED***if***REMOVED***the***REMOVED***stable***REMOVED***fragment***REMOVED***has***REMOVED***a***REMOVED***key,***REMOVED***it's***REMOVED***a***REMOVED***<template***REMOVED***v-for>***REMOVED***that***REMOVED***may
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED******REMOVED***get***REMOVED***moved***REMOVED***around.***REMOVED***Make***REMOVED***sure***REMOVED***all***REMOVED***root***REMOVED***level***REMOVED***vnodes***REMOVED***inherit***REMOVED***el.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***#2134***REMOVED***or***REMOVED***if***REMOVED***it's***REMOVED***a***REMOVED***component***REMOVED***root,***REMOVED***it***REMOVED***may***REMOVED***also***REMOVED***get***REMOVED***moved***REMOVED***around
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***as***REMOVED***the***REMOVED***component***REMOVED***is***REMOVED***being***REMOVED***moved.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2.key***REMOVED***!=***REMOVED***null***REMOVED***||***REMOVED***parentComponent***REMOVED***&&***REMOVED***n2***REMOVED***===***REMOVED***parentComponent.subTree
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***traverseStaticChildren(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n1,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***true
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***/****REMOVED***shallow***REMOVED****/
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patchChildren(
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***instance***REMOVED***=***REMOVED***(initialVNode.component***REMOVED***=***REMOVED***createComponentInstance(
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setupComponent(instance,***REMOVED***false,***REMOVED***optimized);
***REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.invokeArrayFns(bm);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(el***REMOVED***&&***REMOVED***hydrateNode)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***hydrateSubTree***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance.subTree***REMOVED***=***REMOVED***renderComponentRoot(instance);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrateNode(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance.subTree,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isAsyncWrapperVNode***REMOVED***&&***REMOVED***type.__asyncHydrate)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***type.__asyncHydrate(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***el,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrateSubTree
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydrateSubTree();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***subTree***REMOVED***=***REMOVED***instance.subTree***REMOVED***=***REMOVED***renderComponentRoot(instance);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.invokeArrayFns(bu);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***toggleRecurse(instance,***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***nextTree***REMOVED***=***REMOVED***renderComponentRoot(instance);
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***effect***REMOVED***=***REMOVED***instance.effect***REMOVED***=***REMOVED***new***REMOVED***reactivity.ReactiveEffect(componentUpdateFn);
...
***REMOVED******REMOVED******REMOVED******REMOVED***reactivity.pauseTracking();
***REMOVED******REMOVED******REMOVED******REMOVED***flushPreFlushCbs(instance);
***REMOVED******REMOVED******REMOVED******REMOVED***reactivity.resetTracking();
***REMOVED******REMOVED***};
...
***REMOVED******REMOVED******REMOVED******REMOVED***c1***REMOVED***=***REMOVED***c1***REMOVED***||***REMOVED***shared.EMPTY_ARR;
***REMOVED******REMOVED******REMOVED******REMOVED***c2***REMOVED***=***REMOVED***c2***REMOVED***||***REMOVED***shared.EMPTY_ARR;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***nextChild***REMOVED***=***REMOVED***c2[i]***REMOVED***=***REMOVED***optimized***REMOVED***?***REMOVED***cloneIfMounted(c2[i])***REMOVED***:***REMOVED***normalizeVNode(c2[i]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***n2***REMOVED***=***REMOVED***c2[i]***REMOVED***=***REMOVED***optimized***REMOVED***?***REMOVED***cloneIfMounted(c2[i])***REMOVED***:***REMOVED***normalizeVNode(c2[i]);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***n2***REMOVED***=***REMOVED***c2[e2]***REMOVED***=***REMOVED***optimized***REMOVED***?***REMOVED***cloneIfMounted(c2[e2])***REMOVED***:***REMOVED***normalizeVNode(c2[e2]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isSameVNodeType(n1,***REMOVED***n2))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n1,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***c2[i]***REMOVED***=***REMOVED***optimized***REMOVED***?***REMOVED***cloneIfMounted(c2[i])***REMOVED***:***REMOVED***normalizeVNode(c2[i]),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***nextChild***REMOVED***=***REMOVED***c2[i]***REMOVED***=***REMOVED***optimized***REMOVED***?***REMOVED***cloneIfMounted(c2[i])***REMOVED***:***REMOVED***normalizeVNode(c2[i]);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***increasingNewIndexSequence***REMOVED***=***REMOVED***moved***REMOVED***?***REMOVED***getSequence(newIndexToOldIndexMap)***REMOVED***:***REMOVED***shared.EMPTY_ARR;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.invokeArrayFns(bum);
***REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED***let***REMOVED***hydrateNode;
***REMOVED******REMOVED***if***REMOVED***(createHydrationFns)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***[hydrate,***REMOVED***hydrateNode]***REMOVED***=***REMOVED***createHydrationFns(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***internals
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***createApp:***REMOVED***createAppAPI(render,***REMOVED***hydrate)
***REMOVED******REMOVED***};
}
...
***REMOVED******REMOVED***if***REMOVED***(shared.isArray(ch1)***REMOVED***&&***REMOVED***shared.isArray(ch2))***REMOVED***{
...
function***REMOVED***watchEffect(effect,***REMOVED***options)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***doWatch(effect,***REMOVED***null,***REMOVED***options);
}
function***REMOVED***watchPostEffect(effect,***REMOVED***options)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***doWatch(
***REMOVED******REMOVED******REMOVED******REMOVED***effect,
***REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED***{***REMOVED***flush:***REMOVED***"post"***REMOVED***}
***REMOVED******REMOVED***);
}
function***REMOVED***watchSyncEffect(effect,***REMOVED***options)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***doWatch(
***REMOVED******REMOVED******REMOVED******REMOVED***effect,
***REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED***{***REMOVED***flush:***REMOVED***"sync"***REMOVED***}
***REMOVED******REMOVED***);
}
...
function***REMOVED***doWatch(source,***REMOVED***cb,***REMOVED***options***REMOVED***=***REMOVED***shared.EMPTY_OBJ)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***immediate,***REMOVED***deep,***REMOVED***flush,***REMOVED***once***REMOVED***}***REMOVED***=***REMOVED***options;
***REMOVED******REMOVED***const***REMOVED***baseWatchOptions***REMOVED***=***REMOVED***shared.extend({},***REMOVED***options);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***watchStopHandle.stop***REMOVED***=***REMOVED***shared.NOOP;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***watchStopHandle.resume***REMOVED***=***REMOVED***shared.NOOP;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***watchStopHandle.pause***REMOVED***=***REMOVED***shared.NOOP;
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***watchHandle***REMOVED***=***REMOVED***reactivity.watch(source,***REMOVED***cb,***REMOVED***baseWatchOptions);
***REMOVED******REMOVED***if***REMOVED***(isInSSRComponentSetup)***REMOVED***{
...
***REMOVED******REMOVED***const***REMOVED***getter***REMOVED***=***REMOVED***shared.isString(source)***REMOVED***?***REMOVED***source.includes(".")***REMOVED***?***REMOVED***createPathGetter(publicThis,***REMOVED***source)***REMOVED***:***REMOVED***()***REMOVED***=>***REMOVED***publicThis[source]***REMOVED***:***REMOVED***source.bind(publicThis,***REMOVED***publicThis);
***REMOVED******REMOVED***let***REMOVED***cb;
***REMOVED******REMOVED***if***REMOVED***(shared.isFunction(value))***REMOVED***{
...
function***REMOVED***useModel(props,***REMOVED***name,***REMOVED***options***REMOVED***=***REMOVED***shared.EMPTY_OBJ)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***i***REMOVED***=***REMOVED***getCurrentInstance();
***REMOVED******REMOVED***const***REMOVED***camelizedName***REMOVED***=***REMOVED***shared.camelize(name);
***REMOVED******REMOVED***const***REMOVED***hyphenatedName***REMOVED***=***REMOVED***shared.hyphenate(name);
***REMOVED******REMOVED***const***REMOVED***modifiers***REMOVED***=***REMOVED***getModelModifiers(props,***REMOVED***camelizedName);
***REMOVED******REMOVED***const***REMOVED***res***REMOVED***=***REMOVED***reactivity.customRef((track,***REMOVED***trigger)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***localValue;
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***prevSetValue***REMOVED***=***REMOVED***shared.EMPTY_OBJ;
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***prevEmittedValue;
***REMOVED******REMOVED******REMOVED******REMOVED***watchSyncEffect(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***propValue***REMOVED***=***REMOVED***props[camelizedName];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.hasChanged(localValue,***REMOVED***propValue))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***localValue***REMOVED***=***REMOVED***propValue;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***trigger();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***});
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***options.get***REMOVED***?***REMOVED***options.get(localValue)***REMOVED***:***REMOVED***localValue;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***set(value)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***emittedValue***REMOVED***=***REMOVED***options.set***REMOVED***?***REMOVED***options.set(value)***REMOVED***:***REMOVED***value;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!shared.hasChanged(emittedValue,***REMOVED***localValue)***REMOVED***&&***REMOVED***!(prevSetValue***REMOVED***!==***REMOVED***shared.EMPTY_OBJ***REMOVED***&&***REMOVED***shared.hasChanged(value,***REMOVED***prevSetValue)))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***rawProps***REMOVED***=***REMOVED***i.vnode.props;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!(rawProps***REMOVED***&&***REMOVED***//***REMOVED***check***REMOVED***if***REMOVED***parent***REMOVED***has***REMOVED***passed***REMOVED***v-model
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***(name***REMOVED***in***REMOVED***rawProps***REMOVED***||***REMOVED***camelizedName***REMOVED***in***REMOVED***rawProps***REMOVED***||***REMOVED***hyphenatedName***REMOVED***in***REMOVED***rawProps)***REMOVED***&&***REMOVED***(`onUpdate:${name}`***REMOVED***in***REMOVED***rawProps***REMOVED***||***REMOVED***`onUpdate:${camelizedName}`***REMOVED***in***REMOVED***rawProps***REMOVED***||***REMOVED***`onUpdate:${hyphenatedName}`***REMOVED***in***REMOVED***rawProps)))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***localValue***REMOVED***=***REMOVED***value;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***trigger();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***i.emit(`update:${name}`,***REMOVED***emittedValue);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.hasChanged(value,***REMOVED***emittedValue)***REMOVED***&&***REMOVED***shared.hasChanged(value,***REMOVED***prevSetValue)***REMOVED***&&***REMOVED***!shared.hasChanged(emittedValue,***REMOVED***prevEmittedValue))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***trigger();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***prevSetValue***REMOVED***=***REMOVED***value;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***prevEmittedValue***REMOVED***=***REMOVED***emittedValue;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED***});
***REMOVED******REMOVED***res[Symbol.iterator]***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***i2***REMOVED***=***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***next()***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(i2***REMOVED***<***REMOVED***2)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***{***REMOVED***value:***REMOVED***i2++***REMOVED***?***REMOVED***modifiers***REMOVED***||***REMOVED***shared.EMPTY_OBJ***REMOVED***:***REMOVED***res,***REMOVED***done:***REMOVED***false***REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***{***REMOVED***done:***REMOVED***true***REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED***};
...
***REMOVED******REMOVED***return***REMOVED***modelName***REMOVED***===***REMOVED***"modelValue"***REMOVED***||***REMOVED***modelName***REMOVED***===***REMOVED***"model-value"***REMOVED***?***REMOVED***props.modelModifiers***REMOVED***:***REMOVED***props[`${modelName}Modifiers`]***REMOVED***||***REMOVED***props[`${shared.camelize(modelName)}Modifiers`]***REMOVED***||***REMOVED***props[`${shared.hyphenate(modelName)}Modifiers`];
};
...
***REMOVED******REMOVED***const***REMOVED***props***REMOVED***=***REMOVED***instance.vnode.props***REMOVED***||***REMOVED***shared.EMPTY_OBJ;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***args***REMOVED***=***REMOVED***rawArgs.map((a)***REMOVED***=>***REMOVED***shared.isString(a)***REMOVED***?***REMOVED***a.trim()***REMOVED***:***REMOVED***a);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(modifiers.number)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***args***REMOVED***=***REMOVED***rawArgs.map(shared.looseToNumber);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***let***REMOVED***handlerName;
***REMOVED******REMOVED***let***REMOVED***handler***REMOVED***=***REMOVED***props[handlerName***REMOVED***=***REMOVED***shared.toHandlerKey(event)]***REMOVED***||***REMOVED***//***REMOVED***also***REMOVED***try***REMOVED***camelCase***REMOVED***event***REMOVED***handler***REMOVED***(#2249)
***REMOVED******REMOVED***props[handlerName***REMOVED***=***REMOVED***shared.toHandlerKey(shared.camelize(event))];
***REMOVED******REMOVED***if***REMOVED***(!handler***REMOVED***&&***REMOVED***isModelListener)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***handler***REMOVED***=***REMOVED***props[handlerName***REMOVED***=***REMOVED***shared.toHandlerKey(shared.hyphenate(event))];
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.extend(normalized,***REMOVED***normalizedFromExtend);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!asMixin***REMOVED***&&***REMOVED***appContext.mixins.length)***REMOVED***{
...
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***shared.extend(normalized,***REMOVED***raw);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(shared.isObject(comp))***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(!options***REMOVED***||***REMOVED***!shared.isOn(key))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***key***REMOVED***=***REMOVED***key.slice(2).replace(/Once$/,***REMOVED***"");
***REMOVED******REMOVED***return***REMOVED***shared.hasOwn(options,***REMOVED***key[0].toLowerCase()***REMOVED***+***REMOVED***key.slice(1))***REMOVED***||***REMOVED***shared.hasOwn(options,***REMOVED***shared.hyphenate(key))***REMOVED***||***REMOVED***shared.hasOwn(options,***REMOVED***key);
}

function***REMOVED***markAttrsAccessed()***REMOVED***{
}
function***REMOVED***renderComponentRoot(instance)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***inheritAttrs
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***instance;
***REMOVED******REMOVED***const***REMOVED***prev***REMOVED***=***REMOVED***setCurrentRenderingInstance(instance);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***thisProxy***REMOVED***=***REMOVED***false***REMOVED***?***REMOVED***new***REMOVED***Proxy(proxyToUse,***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***result***REMOVED***=***REMOVED***normalizeVNode(
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***false***REMOVED***?***REMOVED***shallowReadonly(props)***REMOVED***:***REMOVED***props,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(false)***REMOVED***;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***result***REMOVED***=***REMOVED***normalizeVNode(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***render2.length***REMOVED***>***REMOVED***1***REMOVED***?***REMOVED***render2(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***false***REMOVED***?***REMOVED***shallowReadonly(props)***REMOVED***:***REMOVED***props,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***false***REMOVED***?***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***catch***REMOVED***(err)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***blockStack.length***REMOVED***=***REMOVED***0;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(propsOptions***REMOVED***&&***REMOVED***keys.some(shared.isModelListener))***REMOVED***{
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***setCurrentRenderingInstance(prev);
***REMOVED******REMOVED***return***REMOVED***result;
}
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isVNode(child))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(key***REMOVED***===***REMOVED***"class"***REMOVED***||***REMOVED***key***REMOVED***===***REMOVED***"style"***REMOVED***||***REMOVED***shared.isOn(key))***REMOVED***{
...
***REMOVED******REMOVED***for***REMOVED***(const***REMOVED***key***REMOVED***in***REMOVED***attrs)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!shared.isModelListener(key)***REMOVED***||***REMOVED***!(key.slice(9)***REMOVED***in***REMOVED***props))***REMOVED***{
...
let***REMOVED***suspenseId***REMOVED***=***REMOVED***0;
const***REMOVED***SuspenseImpl***REMOVED***=***REMOVED***{
***REMOVED******REMOVED***name:***REMOVED***"Suspense",
***REMOVED******REMOVED***//***REMOVED***In***REMOVED***order***REMOVED***to***REMOVED***make***REMOVED***Suspense***REMOVED***tree-shakable,***REMOVED***we***REMOVED***need***REMOVED***to***REMOVED***avoid***REMOVED***importing***REMOVED***it
***REMOVED******REMOVED***//***REMOVED***directly***REMOVED***in***REMOVED***the***REMOVED***renderer.***REMOVED***The***REMOVED***renderer***REMOVED***checks***REMOVED***for***REMOVED***the***REMOVED***__isSuspense***REMOVED***flag
***REMOVED******REMOVED***//***REMOVED***on***REMOVED***a***REMOVED***vnode's***REMOVED***type***REMOVED***and***REMOVED***calls***REMOVED***the***REMOVED***`process`***REMOVED***method,***REMOVED***passing***REMOVED***in***REMOVED***renderer
***REMOVED******REMOVED***//***REMOVED***internals.
***REMOVED******REMOVED***__isSuspense:***REMOVED***true,
***REMOVED******REMOVED***process(n1,***REMOVED***n2,***REMOVED***container,***REMOVED***anchor,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***namespace,***REMOVED***slotScopeIds,***REMOVED***optimized,***REMOVED***rendererInternals)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(n1***REMOVED***==***REMOVED***null)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mountSuspense(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***rendererInternals
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(parentSuspense***REMOVED***&&***REMOVED***parentSuspense.deps***REMOVED***>***REMOVED***0***REMOVED***&&***REMOVED***!n1.suspense.isInFallback)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2.suspense***REMOVED***=***REMOVED***n1.suspense;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2.suspense.vnode***REMOVED***=***REMOVED***n2;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2.el***REMOVED***=***REMOVED***n1.el;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patchSuspense(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n1,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***n2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor,
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***},
***REMOVED******REMOVED***hydrate:***REMOVED***hydrateSuspense,
***REMOVED******REMOVED***normalize:***REMOVED***normalizeSuspenseChildren
};
const***REMOVED***Suspense***REMOVED***=***REMOVED***SuspenseImpl***REMOVED***;
function***REMOVED***triggerEvent(vnode,***REMOVED***name)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***eventListener***REMOVED***=***REMOVED***vnode.props***REMOVED***&&***REMOVED***vnode.props[name];
***REMOVED******REMOVED***if***REMOVED***(shared.isFunction(eventListener))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***eventListener();
***REMOVED******REMOVED***}
}
function***REMOVED***mountSuspense(vnode,***REMOVED***container,***REMOVED***anchor,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***namespace,***REMOVED***slotScopeIds,***REMOVED***optimized,***REMOVED***rendererInternals)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***p:***REMOVED***patch,
***REMOVED******REMOVED******REMOVED******REMOVED***o:***REMOVED***{***REMOVED***createElement***REMOVED***}
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***rendererInternals;
***REMOVED******REMOVED***const***REMOVED***hiddenContainer***REMOVED***=***REMOVED***createElement("div");
***REMOVED******REMOVED***const***REMOVED***suspense***REMOVED***=***REMOVED***vnode.suspense***REMOVED***=***REMOVED***createSuspenseBoundary(
***REMOVED******REMOVED******REMOVED******REMOVED***vnode,
***REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED***hiddenContainer,
***REMOVED******REMOVED******REMOVED******REMOVED***anchor,
***REMOVED******REMOVED******REMOVED******REMOVED***namespace,
***REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED***optimized,
***REMOVED******REMOVED******REMOVED******REMOVED***rendererInternals
***REMOVED******REMOVED***);
***REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED***suspense.pendingBranch***REMOVED***=***REMOVED***vnode.ssContent,
***REMOVED******REMOVED******REMOVED******REMOVED***hiddenContainer,
***REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
...
***REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds
***REMOVED******REMOVED***);
***REMOVED******REMOVED***if***REMOVED***(suspense.deps***REMOVED***>***REMOVED***0)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***triggerEvent(vnode,***REMOVED***"onPending");
***REMOVED******REMOVED******REMOVED******REMOVED***triggerEvent(vnode,***REMOVED***"onFallback");
***REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode.ssFallback,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***fallback***REMOVED***tree***REMOVED***will***REMOVED***not***REMOVED***have***REMOVED***suspense***REMOVED***context
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***setActiveBranch(suspense,***REMOVED***vnode.ssFallback);
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***suspense.resolve(false,***REMOVED***true);
***REMOVED******REMOVED***}
}
function***REMOVED***patchSuspense(n1,***REMOVED***n2,***REMOVED***container,***REMOVED***anchor,***REMOVED***parentComponent,***REMOVED***namespace,***REMOVED***slotScopeIds,***REMOVED***optimized,***REMOVED***{***REMOVED***p:***REMOVED***patch,***REMOVED***um:***REMOVED***unmount,***REMOVED***o:***REMOVED***{***REMOVED***createElement***REMOVED***}***REMOVED***})***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***suspense***REMOVED***=***REMOVED***n2.suspense***REMOVED***=***REMOVED***n1.suspense;
***REMOVED******REMOVED***suspense.vnode***REMOVED***=***REMOVED***n2;
***REMOVED******REMOVED***n2.el***REMOVED***=***REMOVED***n1.el;
***REMOVED******REMOVED***const***REMOVED***newBranch***REMOVED***=***REMOVED***n2.ssContent;
***REMOVED******REMOVED***const***REMOVED***newFallback***REMOVED***=***REMOVED***n2.ssFallback;
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***activeBranch,***REMOVED***pendingBranch,***REMOVED***isInFallback,***REMOVED***isHydrating***REMOVED***}***REMOVED***=***REMOVED***suspense;
***REMOVED******REMOVED***if***REMOVED***(pendingBranch)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***suspense.pendingBranch***REMOVED***=***REMOVED***newBranch;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isSameVNodeType(pendingBranch,***REMOVED***newBranch))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pendingBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***newBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.hiddenContainer,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(suspense.deps***REMOVED***<=***REMOVED***0)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.resolve();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(isInFallback)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!isHydrating)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***activeBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***newFallback,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***fallback***REMOVED***tree***REMOVED***will***REMOVED***not***REMOVED***have***REMOVED***suspense***REMOVED***context
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setActiveBranch(suspense,***REMOVED***newFallback);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.pendingId***REMOVED***=***REMOVED***suspenseId++;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isHydrating)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.isHydrating***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.activeBranch***REMOVED***=***REMOVED***pendingBranch;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***unmount(pendingBranch,***REMOVED***parentComponent,***REMOVED***suspense);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.deps***REMOVED***=***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.effects.length***REMOVED***=***REMOVED***0;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.hiddenContainer***REMOVED***=***REMOVED***createElement("div");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isInFallback)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***newBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.hiddenContainer,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(suspense.deps***REMOVED***<=***REMOVED***0)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.resolve();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***activeBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***newFallback,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setActiveBranch(suspense,***REMOVED***newFallback);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(activeBranch***REMOVED***&&***REMOVED***isSameVNodeType(activeBranch,***REMOVED***newBranch))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***activeBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***newBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.resolve(true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***newBranch,
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(activeBranch***REMOVED***&&***REMOVED***isSameVNodeType(activeBranch,***REMOVED***newBranch))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***activeBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***newBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setActiveBranch(suspense,***REMOVED***newBranch);
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***triggerEvent(n2,***REMOVED***"onPending");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.pendingBranch***REMOVED***=***REMOVED***newBranch;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(newBranch.shapeFlag***REMOVED***&***REMOVED***512)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.pendingId***REMOVED***=***REMOVED***newBranch.component.suspenseId;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.pendingId***REMOVED***=***REMOVED***suspenseId++;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***newBranch,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.resolve();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***timeout,***REMOVED***pendingId***REMOVED***}***REMOVED***=***REMOVED***suspense;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(timeout***REMOVED***>***REMOVED***0)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setTimeout(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(suspense.pendingId***REMOVED***===***REMOVED***pendingId)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.fallback(newFallback);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***timeout);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(timeout***REMOVED***===***REMOVED***0)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.fallback(newFallback);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
}
function***REMOVED***createSuspenseBoundary(vnode,***REMOVED***parentSuspense,***REMOVED***parentComponent,***REMOVED***container,***REMOVED***hiddenContainer,***REMOVED***anchor,***REMOVED***namespace,***REMOVED***slotScopeIds,***REMOVED***optimized,***REMOVED***rendererInternals,***REMOVED***isHydrating***REMOVED***=***REMOVED***false)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***p:***REMOVED***patch,
***REMOVED******REMOVED******REMOVED******REMOVED***m:***REMOVED***move,
***REMOVED******REMOVED******REMOVED******REMOVED***um:***REMOVED***unmount,
***REMOVED******REMOVED******REMOVED******REMOVED***n:***REMOVED***next,
***REMOVED******REMOVED******REMOVED******REMOVED***o:***REMOVED***{***REMOVED***parentNode,***REMOVED***remove***REMOVED***}
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***rendererInternals;
***REMOVED******REMOVED***let***REMOVED***parentSuspenseId;
***REMOVED******REMOVED***const***REMOVED***isSuspensible***REMOVED***=***REMOVED***isVNodeSuspensible(vnode);
***REMOVED******REMOVED***if***REMOVED***(isSuspensible)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(parentSuspense***REMOVED***&&***REMOVED***parentSuspense.pendingBranch)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspenseId***REMOVED***=***REMOVED***parentSuspense.pendingId;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense.deps++;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***timeout***REMOVED***=***REMOVED***vnode.props***REMOVED***?***REMOVED***shared.toNumber(vnode.props.timeout)***REMOVED***:***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED***const***REMOVED***initialAnchor***REMOVED***=***REMOVED***anchor;
***REMOVED******REMOVED***const***REMOVED***suspense***REMOVED***=***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***vnode,
***REMOVED******REMOVED******REMOVED******REMOVED***parent:***REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED***namespace,
***REMOVED******REMOVED******REMOVED******REMOVED***container,
***REMOVED******REMOVED******REMOVED******REMOVED***hiddenContainer,
***REMOVED******REMOVED******REMOVED******REMOVED***deps:***REMOVED***0,
***REMOVED******REMOVED******REMOVED******REMOVED***pendingId:***REMOVED***suspenseId++,
***REMOVED******REMOVED******REMOVED******REMOVED***timeout:***REMOVED***typeof***REMOVED***timeout***REMOVED***===***REMOVED***"number"***REMOVED***?***REMOVED***timeout***REMOVED***:***REMOVED***-1,
***REMOVED******REMOVED******REMOVED******REMOVED***activeBranch:***REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED***pendingBranch:***REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED***isInFallback:***REMOVED***!isHydrating,
***REMOVED******REMOVED******REMOVED******REMOVED***isHydrating,
***REMOVED******REMOVED******REMOVED******REMOVED***isUnmounted:***REMOVED***false,
***REMOVED******REMOVED******REMOVED******REMOVED***effects:***REMOVED***[],
***REMOVED******REMOVED******REMOVED******REMOVED***resolve(resume***REMOVED***=***REMOVED***false,***REMOVED***sync***REMOVED***=***REMOVED***false)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode:***REMOVED***vnode2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***activeBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pendingBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pendingId,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***effects,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent:***REMOVED***parentComponent2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container:***REMOVED***container2
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***=***REMOVED***suspense;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***delayEnter***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(suspense.isHydrating)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.isHydrating***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(!resume)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***delayEnter***REMOVED***=***REMOVED***activeBranch***REMOVED***&&***REMOVED***pendingBranch.transition***REMOVED***&&***REMOVED***pendingBranch.transition.mode***REMOVED***===***REMOVED***"out-in";
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(delayEnter)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***activeBranch.transition.afterLeave***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(pendingId***REMOVED***===***REMOVED***suspense.pendingId)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***move(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***pendingBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor***REMOVED***===***REMOVED***initialAnchor***REMOVED***?***REMOVED***next(activeBranch)***REMOVED***:***REMOVED***anchor,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***queuePostFlushCb(effects);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(activeBranch)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(parentNode(activeBranch.el)***REMOVED***===***REMOVED***container2)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor***REMOVED***=***REMOVED***next(activeBranch);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***unmount(activeBranch,***REMOVED***parentComponent2,***REMOVED***suspense,***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!delayEnter)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***move(pendingBranch,***REMOVED***container2,***REMOVED***anchor,***REMOVED***0);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setActiveBranch(suspense,***REMOVED***pendingBranch);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.pendingBranch***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.isInFallback***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***parent***REMOVED***=***REMOVED***suspense.parent;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***hasUnresolvedAncestor***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***while***REMOVED***(parent)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(parent.pendingBranch)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parent.effects.push(...effects);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hasUnresolvedAncestor***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***break;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parent***REMOVED***=***REMOVED***parent.parent;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!hasUnresolvedAncestor***REMOVED***&&***REMOVED***!delayEnter)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***queuePostFlushCb(effects);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.effects***REMOVED***=***REMOVED***[];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isSuspensible)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(parentSuspense***REMOVED***&&***REMOVED***parentSuspense.pendingBranch***REMOVED***&&***REMOVED***parentSuspenseId***REMOVED***===***REMOVED***parentSuspense.pendingId)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense.deps--;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(parentSuspense.deps***REMOVED***===***REMOVED***0***REMOVED***&&***REMOVED***!sync)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense.resolve();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***triggerEvent(vnode2,***REMOVED***"onResolve");
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***fallback(fallbackVNode)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!suspense.pendingBranch)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***vnode:***REMOVED***vnode2,***REMOVED***activeBranch,***REMOVED***parentComponent:***REMOVED***parentComponent2,***REMOVED***container:***REMOVED***container2,***REMOVED***namespace:***REMOVED***namespace2***REMOVED***}***REMOVED***=***REMOVED***suspense;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***triggerEvent(vnode2,***REMOVED***"onFallback");
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***anchor2***REMOVED***=***REMOVED***next(activeBranch);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***mountFallback***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!suspense.isInFallback)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patch(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***fallbackVNode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***container2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***anchor2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***fallback***REMOVED***tree***REMOVED***will***REMOVED***not***REMOVED***have***REMOVED***suspense***REMOVED***context
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setActiveBranch(suspense,***REMOVED***fallbackVNode);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***delayEnter***REMOVED***=***REMOVED***fallbackVNode.transition***REMOVED***&&***REMOVED***fallbackVNode.transition.mode***REMOVED***===***REMOVED***"out-in";
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(delayEnter)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***activeBranch.transition.afterLeave***REMOVED***=***REMOVED***mountFallback;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.isInFallback***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***unmount(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***activeBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***no***REMOVED***suspense***REMOVED***so***REMOVED***unmount***REMOVED***hooks***REMOVED***fire***REMOVED***now
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***true
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***shouldRemove
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!delayEnter)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mountFallback();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***move(container2,***REMOVED***anchor2,***REMOVED***type)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.activeBranch***REMOVED***&&***REMOVED***move(suspense.activeBranch,***REMOVED***container2,***REMOVED***anchor2,***REMOVED***type);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.container***REMOVED***=***REMOVED***container2;
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***next()***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***suspense.activeBranch***REMOVED***&&***REMOVED***next(suspense.activeBranch);
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***registerDep(instance,***REMOVED***setupRenderEffect,***REMOVED***optimized2)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isInPendingSuspense***REMOVED***=***REMOVED***!!suspense.pendingBranch;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isInPendingSuspense)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.deps++;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***hydratedEl***REMOVED***=***REMOVED***instance.vnode.el;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance.asyncDep.catch((err)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***handleError(err,***REMOVED***instance,***REMOVED***0);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}).then((asyncSetupResult)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(instance.isUnmounted***REMOVED***||***REMOVED***suspense.isUnmounted***REMOVED***||***REMOVED***suspense.pendingId***REMOVED***!==***REMOVED***instance.suspenseId)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance.asyncResolved***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***vnode:***REMOVED***vnode2***REMOVED***}***REMOVED***=***REMOVED***instance;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***handleSetupResult(instance,***REMOVED***asyncSetupResult,***REMOVED***false);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(hydratedEl)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode2.el***REMOVED***=***REMOVED***hydratedEl;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***placeholder***REMOVED***=***REMOVED***!hydratedEl***REMOVED***&&***REMOVED***instance.subTree.el;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setupRenderEffect(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vnode2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***component***REMOVED***may***REMOVED***have***REMOVED***been***REMOVED***moved***REMOVED***before***REMOVED***resolve.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***if***REMOVED***this***REMOVED***is***REMOVED***not***REMOVED***a***REMOVED***hydration,***REMOVED***instance.subTree***REMOVED***will***REMOVED***be***REMOVED***the***REMOVED***comment
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***placeholder.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentNode(hydratedEl***REMOVED***||***REMOVED***instance.subTree.el),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***anchor***REMOVED***will***REMOVED***not***REMOVED***be***REMOVED***used***REMOVED***if***REMOVED***this***REMOVED***is***REMOVED***hydration,***REMOVED***so***REMOVED***only***REMOVED***need***REMOVED***to
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***consider***REMOVED***the***REMOVED***comment***REMOVED***placeholder***REMOVED***case.
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***hydratedEl***REMOVED***?***REMOVED***null***REMOVED***:***REMOVED***next(instance.subTree),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***namespace,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***optimized2
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(placeholder)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***remove(placeholder);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***updateHOCHostEl(instance,***REMOVED***vnode2.el);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isInPendingSuspense***REMOVED***&&***REMOVED***--suspense.deps***REMOVED***===***REMOVED***0)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.resolve();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***unmount(parentSuspense2,***REMOVED***doRemove)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.isUnmounted***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(suspense.activeBranch)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***unmount(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.activeBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***doRemove
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(suspense.pendingBranch)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***unmount(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***suspense.pendingBranch,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense2,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***doRemove
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***return***REMOVED***suspense;
}
function***REMOVED***hydrateSuspense(node,***REMOVED***vnode,***REMOVED***parentComponent,***REMOVED***parentSuspense,***REMOVED***namespace,***REMOVED***slotScopeIds,***REMOVED***optimized,***REMOVED***rendererInternals,***REMOVED***hydrateNode)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***suspense***REMOVED***=***REMOVED***vnode.suspense***REMOVED***=***REMOVED***createSuspenseBoundary(
***REMOVED******REMOVED******REMOVED******REMOVED***vnode,
***REMOVED******REMOVED******REMOVED******REMOVED***parentSuspense,
***REMOVED******REMOVED******REMOVED******REMOVED***parentComponent,
***REMOVED******REMOVED******REMOVED******REMOVED***node.parentNode,
***REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***eslint-disable-next-line***REMOVED***no-restricted-globals
***REMOVED******REMOVED******REMOVED******REMOVED***document.createElement("div"),
***REMOVED******REMOVED******REMOVED******REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED***namespace,
***REMOVED******REMOVED******REMOVED******REMOVED***slotScopeIds,
***REMOVED******REMOVED******REMOVED******REMOVED***optimized,
...
***REMOVED******REMOVED******REMOVED******REMOVED***true
***REMOVED******REMOVED***);
***REMOVED******REMOVED***const***REMOVED***result***REMOVED***=***REMOVED***hydrateNode(
...
function***REMOVED***normalizeSuspenseChildren(vnode)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***shapeFlag,***REMOVED***children***REMOVED***}***REMOVED***=***REMOVED***vnode;
***REMOVED******REMOVED***const***REMOVED***isSlotChildren***REMOVED***=***REMOVED***shapeFlag***REMOVED***&***REMOVED***32;
***REMOVED******REMOVED***vnode.ssContent***REMOVED***=***REMOVED***normalizeSuspenseSlot(
***REMOVED******REMOVED******REMOVED******REMOVED***isSlotChildren***REMOVED***?***REMOVED***children.default***REMOVED***:***REMOVED***children
***REMOVED******REMOVED***);
***REMOVED******REMOVED***vnode.ssFallback***REMOVED***=***REMOVED***isSlotChildren***REMOVED***?***REMOVED***normalizeSuspenseSlot(children.fallback)***REMOVED***:***REMOVED***createVNode(Comment);
}
function***REMOVED***normalizeSuspenseSlot(s)***REMOVED***{
***REMOVED******REMOVED***let***REMOVED***block;
***REMOVED******REMOVED***if***REMOVED***(shared.isFunction(s))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***trackBlock***REMOVED***=***REMOVED***isBlockTreeEnabled***REMOVED***&&***REMOVED***s._c;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(trackBlock)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***s._d***REMOVED***=***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***openBlock();
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***s***REMOVED***=***REMOVED***s();
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(trackBlock)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***s._d***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***block***REMOVED***=***REMOVED***currentBlock;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***closeBlock();
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(shared.isArray(s))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***singleChild***REMOVED***=***REMOVED***filterSingleRoot(s);
***REMOVED******REMOVED******REMOVED******REMOVED***s***REMOVED***=***REMOVED***singleChild;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***s***REMOVED***=***REMOVED***normalizeVNode(s);
***REMOVED******REMOVED***if***REMOVED***(block***REMOVED***&&***REMOVED***!s.dynamicChildren)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***s.dynamicChildren***REMOVED***=***REMOVED***block.filter((c)***REMOVED***=>***REMOVED***c***REMOVED***!==***REMOVED***s);
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isArray(fn))***REMOVED***{
...
function***REMOVED***setActiveBranch(suspense,***REMOVED***branch)***REMOVED***{
***REMOVED******REMOVED***suspense.activeBranch***REMOVED***=***REMOVED***branch;
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***vnode,***REMOVED***parentComponent***REMOVED***}***REMOVED***=***REMOVED***suspense;
***REMOVED******REMOVED***let***REMOVED***el***REMOVED***=***REMOVED***branch.el;
***REMOVED******REMOVED***while***REMOVED***(!el***REMOVED***&&***REMOVED***branch.component)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***branch***REMOVED***=***REMOVED***branch.component.subTree;
***REMOVED******REMOVED******REMOVED******REMOVED***el***REMOVED***=***REMOVED***branch.el;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***vnode.el***REMOVED***=***REMOVED***el;
***REMOVED******REMOVED***if***REMOVED***(parentComponent***REMOVED***&&***REMOVED***parentComponent.subTree***REMOVED***===***REMOVED***vnode)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***parentComponent.vnode.el***REMOVED***=***REMOVED***el;
***REMOVED******REMOVED******REMOVED******REMOVED***updateHOCHostEl(parentComponent,***REMOVED***el);
***REMOVED******REMOVED***}
}
function***REMOVED***isVNodeSuspensible(vnode)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***suspensible***REMOVED***=***REMOVED***vnode.props***REMOVED***&&***REMOVED***vnode.props.suspensible;
***REMOVED******REMOVED***return***REMOVED***suspensible***REMOVED***!=***REMOVED***null***REMOVED***&&***REMOVED***suspensible***REMOVED***!==***REMOVED***false;
}
...
const***REMOVED***blockStack***REMOVED***=***REMOVED***[];
let***REMOVED***currentBlock***REMOVED***=***REMOVED***null;
function***REMOVED***openBlock(disableTracking***REMOVED***=***REMOVED***false)***REMOVED***{
***REMOVED******REMOVED***blockStack.push(currentBlock***REMOVED***=***REMOVED***disableTracking***REMOVED***?***REMOVED***null***REMOVED***:***REMOVED***[]);
}
function***REMOVED***closeBlock()***REMOVED***{
***REMOVED******REMOVED***blockStack.pop();
***REMOVED******REMOVED***currentBlock***REMOVED***=***REMOVED***blockStack[blockStack.length***REMOVED***-***REMOVED***1]***REMOVED***||***REMOVED***null;
}
...
function***REMOVED***setupBlock(vnode)***REMOVED***{
***REMOVED******REMOVED***vnode.dynamicChildren***REMOVED***=***REMOVED***isBlockTreeEnabled***REMOVED***>***REMOVED***0***REMOVED***?***REMOVED***currentBlock***REMOVED***||***REMOVED***shared.EMPTY_ARR***REMOVED***:***REMOVED***null;
***REMOVED******REMOVED***closeBlock();
***REMOVED******REMOVED***if***REMOVED***(isBlockTreeEnabled***REMOVED***>***REMOVED***0***REMOVED***&&***REMOVED***currentBlock)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***currentBlock.push(vnode);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***vnode;
}
function***REMOVED***createElementBlock(type,***REMOVED***props,***REMOVED***children,***REMOVED***patchFlag,***REMOVED***dynamicProps,***REMOVED***shapeFlag)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***setupBlock(
***REMOVED******REMOVED******REMOVED******REMOVED***createBaseVNode(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***type,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***props,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***children,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patchFlag,
...
function***REMOVED***createBlock(type,***REMOVED***props,***REMOVED***children,***REMOVED***patchFlag,***REMOVED***dynamicProps)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***setupBlock(
***REMOVED******REMOVED******REMOVED******REMOVED***createVNode(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***type,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***props,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***children,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***patchFlag,
...
function***REMOVED***isVNode(value)***REMOVED***{
...
function***REMOVED***transformVNodeArgs(transformer)***REMOVED***{
}
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***ref***REMOVED***!=***REMOVED***null***REMOVED***?***REMOVED***shared.isString(ref)***REMOVED***||***REMOVED***reactivity.isRef(ref)***REMOVED***||***REMOVED***shared.isFunction(ref)***REMOVED***?***REMOVED***{***REMOVED***i:***REMOVED***currentRenderingInstance,***REMOVED***r:***REMOVED***ref,***REMOVED***k:***REMOVED***ref_key,***REMOVED***f:***REMOVED***!!ref_for***REMOVED***}***REMOVED***:***REMOVED***ref***REMOVED***:***REMOVED***null;
};
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(children)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***vnode.shapeFlag***REMOVED***|=***REMOVED***shared.isString(children)***REMOVED***?***REMOVED***8***REMOVED***:***REMOVED***16;
***REMOVED******REMOVED***}
...
const***REMOVED***createVNode***REMOVED***=***REMOVED***_createVNode;
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(isVNode(type))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(klass***REMOVED***&&***REMOVED***!shared.isString(klass))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***props.class***REMOVED***=***REMOVED***shared.normalizeClass(klass);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isObject(style))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(reactivity.isProxy(style)***REMOVED***&&***REMOVED***!shared.isArray(style))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***style***REMOVED***=***REMOVED***shared.extend({},***REMOVED***style);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***props.style***REMOVED***=***REMOVED***shared.normalizeStyle(style);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***shapeFlag***REMOVED***=***REMOVED***shared.isString(type)***REMOVED***?***REMOVED***1***REMOVED***:***REMOVED***isSuspense(type)***REMOVED***?***REMOVED***128***REMOVED***:***REMOVED***isTeleport(type)***REMOVED***?***REMOVED***64***REMOVED***:***REMOVED***shared.isObject(type)***REMOVED***?***REMOVED***4***REMOVED***:***REMOVED***shared.isFunction(type)***REMOVED***?***REMOVED***2***REMOVED***:***REMOVED***0;
...
***REMOVED******REMOVED***return***REMOVED***reactivity.isProxy(props)***REMOVED***||***REMOVED***isInternalObject(props)***REMOVED***?***REMOVED***shared.extend({},***REMOVED***props)***REMOVED***:***REMOVED***props;
}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mergeRef***REMOVED***&&***REMOVED***ref***REMOVED***?***REMOVED***shared.isArray(ref)***REMOVED***?***REMOVED***ref.concat(normalizeRef(extraProps))***REMOVED***:***REMOVED***[ref,***REMOVED***normalizeRef(extraProps)]***REMOVED***:***REMOVED***normalizeRef(extraProps)
***REMOVED******REMOVED******REMOVED******REMOVED***)***REMOVED***:***REMOVED***ref,
...
function***REMOVED***createStaticVNode(content,***REMOVED***numberOfNodes)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***vnode***REMOVED***=***REMOVED***createVNode(Static,***REMOVED***null,***REMOVED***content);
***REMOVED******REMOVED***vnode.staticCount***REMOVED***=***REMOVED***numberOfNodes;
***REMOVED******REMOVED***return***REMOVED***vnode;
}
function***REMOVED***createCommentVNode(text***REMOVED***=***REMOVED***"",***REMOVED***asBlock***REMOVED***=***REMOVED***false)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***asBlock***REMOVED***?***REMOVED***(openBlock(),***REMOVED***createBlock(Comment,***REMOVED***null,***REMOVED***text))***REMOVED***:***REMOVED***createVNode(Comment,***REMOVED***null,***REMOVED***text);
}
function***REMOVED***normalizeVNode(child)***REMOVED***{
...
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isArray(child))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(isVNode(child))***REMOVED***{
...
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isArray(children))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isFunction(children))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret.class***REMOVED***=***REMOVED***shared.normalizeClass([ret.class,***REMOVED***toMerge.class]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(key***REMOVED***===***REMOVED***"style")***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret.style***REMOVED***=***REMOVED***shared.normalizeStyle([ret.style,***REMOVED***toMerge.style]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isOn(key))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(incoming***REMOVED***&&***REMOVED***existing***REMOVED***!==***REMOVED***incoming***REMOVED***&&***REMOVED***!(shared.isArray(existing)***REMOVED***&&***REMOVED***existing.includes(incoming)))***REMOVED***{
...
function***REMOVED***createComponentInstance(vnode,***REMOVED***parent,***REMOVED***suspense)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***scope:***REMOVED***new***REMOVED***reactivity.EffectScope(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***true
...
***REMOVED******REMOVED******REMOVED******REMOVED***propsDefaults:***REMOVED***shared.EMPTY_OBJ,
...
***REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***state
***REMOVED******REMOVED******REMOVED******REMOVED***ctx:***REMOVED***shared.EMPTY_OBJ,
***REMOVED******REMOVED******REMOVED******REMOVED***data:***REMOVED***shared.EMPTY_OBJ,
***REMOVED******REMOVED******REMOVED******REMOVED***props:***REMOVED***shared.EMPTY_OBJ,
***REMOVED******REMOVED******REMOVED******REMOVED***attrs:***REMOVED***shared.EMPTY_OBJ,
***REMOVED******REMOVED******REMOVED******REMOVED***slots:***REMOVED***shared.EMPTY_OBJ,
***REMOVED******REMOVED******REMOVED******REMOVED***refs:***REMOVED***shared.EMPTY_OBJ,
***REMOVED******REMOVED******REMOVED******REMOVED***setupState:***REMOVED***shared.EMPTY_OBJ,
...
***REMOVED******REMOVED***};
***REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***instance.ctx***REMOVED***=***REMOVED***{***REMOVED***_:***REMOVED***instance***REMOVED***};
***REMOVED******REMOVED***}
...
{
***REMOVED******REMOVED***const***REMOVED***g***REMOVED***=***REMOVED***shared.getGlobalThis();
...
function***REMOVED***setupComponent(instance,***REMOVED***isSSR***REMOVED***=***REMOVED***false,***REMOVED***optimized***REMOVED***=***REMOVED***false)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***[
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance.props,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setupContext
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***]
***REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isAsyncSetup***REMOVED***=***REMOVED***shared.isPromise(setupResult);
***REMOVED******REMOVED******REMOVED******REMOVED***reactivity.resetTracking();
...
***REMOVED******REMOVED***if***REMOVED***(shared.isFunction(setupResult))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(shared.isObject(setupResult))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***instance.setupState***REMOVED***=***REMOVED***reactivity.proxyRefs(setupResult);
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***;
***REMOVED******REMOVED***finishComponentSetup(instance,***REMOVED***isSSR);
}
let***REMOVED***compile;
let***REMOVED***installWithProxy;
function***REMOVED***registerRuntimeCompiler(_compile)***REMOVED***{
***REMOVED******REMOVED***compile***REMOVED***=***REMOVED***_compile;
***REMOVED******REMOVED***installWithProxy***REMOVED***=***REMOVED***(i)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(i.render._rc)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***i.withProxy***REMOVED***=***REMOVED***new***REMOVED***Proxy(i.ctx,***REMOVED***RuntimeCompiledPublicInstanceProxyHandlers);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
}
const***REMOVED***isRuntimeOnly***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***!compile;
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!isSSR***REMOVED***&&***REMOVED***compile***REMOVED***&&***REMOVED***!Component.render)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***template***REMOVED***=***REMOVED***Component.template***REMOVED***||***REMOVED***resolveMergedOptions(instance).template;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(template)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***isCustomElement,***REMOVED***compilerOptions***REMOVED***}***REMOVED***=***REMOVED***instance.appContext.config;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***delimiters,***REMOVED***compilerOptions:***REMOVED***componentCompilerOptions***REMOVED***}***REMOVED***=***REMOVED***Component;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***finalCompilerOptions***REMOVED***=***REMOVED***shared.extend(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***shared.extend(
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***isCustomElement,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***delimiters
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***compilerOptions
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***componentCompilerOptions
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***Component.render***REMOVED***=***REMOVED***compile(template,***REMOVED***finalCompilerOptions);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***instance.render***REMOVED***=***REMOVED***Component.render***REMOVED***||***REMOVED***shared.NOOP;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(installWithProxy)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***installWithProxy(instance);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***reset***REMOVED***=***REMOVED***setCurrentInstance(instance);
...
***REMOVED******REMOVED***get(target,***REMOVED***key)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***reactivity.track(target,***REMOVED***"get",***REMOVED***"");
...
***REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***attrs:***REMOVED***new***REMOVED***Proxy(instance.attrs,***REMOVED***attrsProxyHandlers),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***slots:***REMOVED***instance.slots,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***emit:***REMOVED***instance.emit,
...
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***instance.exposeProxy***REMOVED***||***REMOVED***(instance.exposeProxy***REMOVED***=***REMOVED***new***REMOVED***Proxy(reactivity.proxyRefs(reactivity.markRaw(instance.exposed)),***REMOVED***{
...
***REMOVED******REMOVED***return***REMOVED***shared.isFunction(Component)***REMOVED***?***REMOVED***Component.displayName***REMOVED***||***REMOVED***Component.name***REMOVED***:***REMOVED***Component.name***REMOVED***||***REMOVED***includeInferred***REMOVED***&&***REMOVED***Component.__name;
}
function***REMOVED***isClassComponent(value)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***shared.isFunction(value)***REMOVED***&&***REMOVED***"__vccOpts"***REMOVED***in***REMOVED***value;
}

const***REMOVED***computed***REMOVED***=***REMOVED***(getterOrOptions,***REMOVED***debugOptions)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***c***REMOVED***=***REMOVED***reactivity.computed(getterOrOptions,***REMOVED***debugOptions,***REMOVED***isInSSRComponentSetup);
***REMOVED******REMOVED***return***REMOVED***c;
};

function***REMOVED***h(type,***REMOVED***propsOrChildren,***REMOVED***children)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***doCreateVNode***REMOVED***=***REMOVED***(type2,***REMOVED***props,***REMOVED***children2)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***setBlockTracking(-1);
***REMOVED******REMOVED******REMOVED******REMOVED***try***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***createVNode(type2,***REMOVED***props,***REMOVED***children2);
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***finally***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setBlockTracking(1);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***l***REMOVED***=***REMOVED***arguments.length;
***REMOVED******REMOVED***if***REMOVED***(l***REMOVED***===***REMOVED***2)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isObject(propsOrChildren)***REMOVED***&&***REMOVED***!shared.isArray(propsOrChildren))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isVNode(propsOrChildren))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***doCreateVNode(type,***REMOVED***null,***REMOVED***[propsOrChildren]);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***doCreateVNode(type,***REMOVED***propsOrChildren);
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***doCreateVNode(type,***REMOVED***null,***REMOVED***propsOrChildren);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(l***REMOVED***>***REMOVED***3)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***children***REMOVED***=***REMOVED***Array.prototype.slice.call(arguments,***REMOVED***2);
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(l***REMOVED***===***REMOVED***3***REMOVED***&&***REMOVED***isVNode(children))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***children***REMOVED***=***REMOVED***[children];
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***doCreateVNode(type,***REMOVED***propsOrChildren,***REMOVED***children);
***REMOVED******REMOVED***}
}

function***REMOVED***initCustomFormatter()***REMOVED***{
***REMOVED******REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED***}
}

function***REMOVED***withMemo(memo,***REMOVED***render,***REMOVED***cache,***REMOVED***index)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***cached***REMOVED***=***REMOVED***cache[index];
***REMOVED******REMOVED***if***REMOVED***(cached***REMOVED***&&***REMOVED***isMemoSame(cached,***REMOVED***memo))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***cached;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***ret***REMOVED***=***REMOVED***render();
***REMOVED******REMOVED***ret.memo***REMOVED***=***REMOVED***memo.slice();
***REMOVED******REMOVED***ret.cacheIndex***REMOVED***=***REMOVED***index;
***REMOVED******REMOVED***return***REMOVED***cache[index]***REMOVED***=***REMOVED***ret;
}
function***REMOVED***isMemoSame(cached,***REMOVED***memo)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***prev***REMOVED***=***REMOVED***cached.memo;
***REMOVED******REMOVED***if***REMOVED***(prev.length***REMOVED***!=***REMOVED***memo.length)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***for***REMOVED***(let***REMOVED***i***REMOVED***=***REMOVED***0;***REMOVED***i***REMOVED***<***REMOVED***prev.length;***REMOVED***i++)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.hasChanged(prev[i],***REMOVED***memo[i]))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(isBlockTreeEnabled***REMOVED***>***REMOVED***0***REMOVED***&&***REMOVED***currentBlock)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***currentBlock.push(cached);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***true;
}

const***REMOVED***version***REMOVED***=***REMOVED***"3.5.21";
const***REMOVED***warn$1***REMOVED***=***REMOVED***shared.NOOP;
const***REMOVED***ErrorTypeStrings***REMOVED***=***REMOVED***ErrorTypeStrings$1***REMOVED***;
const***REMOVED***devtools***REMOVED***=***REMOVED***void***REMOVED***0;
const***REMOVED***setDevtoolsHook***REMOVED***=***REMOVED***shared.NOOP;
...
const***REMOVED***resolveFilter***REMOVED***=***REMOVED***null;
const***REMOVED***compatUtils***REMOVED***=***REMOVED***null;
const***REMOVED***DeprecationTypes***REMOVED***=***REMOVED***null;

exports.EffectScope***REMOVED***=***REMOVED***reactivity.EffectScope;
exports.ReactiveEffect***REMOVED***=***REMOVED***reactivity.ReactiveEffect;
exports.TrackOpTypes***REMOVED***=***REMOVED***reactivity.TrackOpTypes;
exports.TriggerOpTypes***REMOVED***=***REMOVED***reactivity.TriggerOpTypes;
exports.customRef***REMOVED***=***REMOVED***reactivity.customRef;
exports.effect***REMOVED***=***REMOVED***reactivity.effect;
exports.effectScope***REMOVED***=***REMOVED***reactivity.effectScope;
exports.getCurrentScope***REMOVED***=***REMOVED***reactivity.getCurrentScope;
exports.getCurrentWatcher***REMOVED***=***REMOVED***reactivity.getCurrentWatcher;
exports.isProxy***REMOVED***=***REMOVED***reactivity.isProxy;
exports.isReactive***REMOVED***=***REMOVED***reactivity.isReactive;
exports.isReadonly***REMOVED***=***REMOVED***reactivity.isReadonly;
exports.isRef***REMOVED***=***REMOVED***reactivity.isRef;
exports.isShallow***REMOVED***=***REMOVED***reactivity.isShallow;
exports.markRaw***REMOVED***=***REMOVED***reactivity.markRaw;
exports.onScopeDispose***REMOVED***=***REMOVED***reactivity.onScopeDispose;
exports.onWatcherCleanup***REMOVED***=***REMOVED***reactivity.onWatcherCleanup;
exports.proxyRefs***REMOVED***=***REMOVED***reactivity.proxyRefs;
exports.reactive***REMOVED***=***REMOVED***reactivity.reactive;
exports.readonly***REMOVED***=***REMOVED***reactivity.readonly;
exports.ref***REMOVED***=***REMOVED***reactivity.ref;
exports.shallowReactive***REMOVED***=***REMOVED***reactivity.shallowReactive;
exports.shallowReadonly***REMOVED***=***REMOVED***reactivity.shallowReadonly;
exports.shallowRef***REMOVED***=***REMOVED***reactivity.shallowRef;
exports.stop***REMOVED***=***REMOVED***reactivity.stop;
exports.toRaw***REMOVED***=***REMOVED***reactivity.toRaw;
exports.toRef***REMOVED***=***REMOVED***reactivity.toRef;
exports.toRefs***REMOVED***=***REMOVED***reactivity.toRefs;
exports.toValue***REMOVED***=***REMOVED***reactivity.toValue;
exports.triggerRef***REMOVED***=***REMOVED***reactivity.triggerRef;
exports.unref***REMOVED***=***REMOVED***reactivity.unref;
exports.camelize***REMOVED***=***REMOVED***shared.camelize;
exports.capitalize***REMOVED***=***REMOVED***shared.capitalize;
exports.normalizeClass***REMOVED***=***REMOVED***shared.normalizeClass;
exports.normalizeProps***REMOVED***=***REMOVED***shared.normalizeProps;
exports.normalizeStyle***REMOVED***=***REMOVED***shared.normalizeStyle;
exports.toDisplayString***REMOVED***=***REMOVED***shared.toDisplayString;
exports.toHandlerKey***REMOVED***=***REMOVED***shared.toHandlerKey;
exports.BaseTransition***REMOVED***=***REMOVED***BaseTransition;
exports.BaseTransitionPropsValidators***REMOVED***=***REMOVED***BaseTransitionPropsValidators;
exports.Comment***REMOVED***=***REMOVED***Comment;
exports.DeprecationTypes***REMOVED***=***REMOVED***DeprecationTypes;
exports.ErrorCodes***REMOVED***=***REMOVED***ErrorCodes;
exports.ErrorTypeStrings***REMOVED***=***REMOVED***ErrorTypeStrings;
exports.Fragment***REMOVED***=***REMOVED***Fragment;
exports.KeepAlive***REMOVED***=***REMOVED***KeepAlive;
exports.Static***REMOVED***=***REMOVED***Static;
exports.Suspense***REMOVED***=***REMOVED***Suspense;
exports.Teleport***REMOVED***=***REMOVED***Teleport;
exports.Text***REMOVED***=***REMOVED***Text;
exports.assertNumber***REMOVED***=***REMOVED***assertNumber;
exports.callWithAsyncErrorHandling***REMOVED***=***REMOVED***callWithAsyncErrorHandling;
exports.callWithErrorHandling***REMOVED***=***REMOVED***callWithErrorHandling;
exports.cloneVNode***REMOVED***=***REMOVED***cloneVNode;
exports.compatUtils***REMOVED***=***REMOVED***compatUtils;
exports.computed***REMOVED***=***REMOVED***computed;
exports.createBlock***REMOVED***=***REMOVED***createBlock;
exports.createCommentVNode***REMOVED***=***REMOVED***createCommentVNode;
exports.createElementBlock***REMOVED***=***REMOVED***createElementBlock;
exports.createElementVNode***REMOVED***=***REMOVED***createBaseVNode;
exports.createHydrationRenderer***REMOVED***=***REMOVED***createHydrationRenderer;
exports.createPropsRestProxy***REMOVED***=***REMOVED***createPropsRestProxy;
exports.createRenderer***REMOVED***=***REMOVED***createRenderer;
exports.createSlots***REMOVED***=***REMOVED***createSlots;
exports.createStaticVNode***REMOVED***=***REMOVED***createStaticVNode;
exports.createTextVNode***REMOVED***=***REMOVED***createTextVNode;
exports.createVNode***REMOVED***=***REMOVED***createVNode;
exports.defineAsyncComponent***REMOVED***=***REMOVED***defineAsyncComponent;
exports.defineComponent***REMOVED***=***REMOVED***defineComponent;
exports.defineEmits***REMOVED***=***REMOVED***defineEmits;
exports.defineExpose***REMOVED***=***REMOVED***defineExpose;
exports.defineModel***REMOVED***=***REMOVED***defineModel;
exports.defineOptions***REMOVED***=***REMOVED***defineOptions;
exports.defineProps***REMOVED***=***REMOVED***defineProps;
exports.defineSlots***REMOVED***=***REMOVED***defineSlots;
exports.devtools***REMOVED***=***REMOVED***devtools;
exports.getCurrentInstance***REMOVED***=***REMOVED***getCurrentInstance;
exports.getTransitionRawChildren***REMOVED***=***REMOVED***getTransitionRawChildren;
exports.guardReactiveProps***REMOVED***=***REMOVED***guardReactiveProps;
exports.h***REMOVED***=***REMOVED***h;
exports.handleError***REMOVED***=***REMOVED***handleError;
exports.hasInjectionContext***REMOVED***=***REMOVED***hasInjectionContext;
exports.hydrateOnIdle***REMOVED***=***REMOVED***hydrateOnIdle;
exports.hydrateOnInteraction***REMOVED***=***REMOVED***hydrateOnInteraction;
exports.hydrateOnMediaQuery***REMOVED***=***REMOVED***hydrateOnMediaQuery;
exports.hydrateOnVisible***REMOVED***=***REMOVED***hydrateOnVisible;
exports.initCustomFormatter***REMOVED***=***REMOVED***initCustomFormatter;
exports.inject***REMOVED***=***REMOVED***inject;
exports.isMemoSame***REMOVED***=***REMOVED***isMemoSame;
exports.isRuntimeOnly***REMOVED***=***REMOVED***isRuntimeOnly;
exports.isVNode***REMOVED***=***REMOVED***isVNode;
exports.mergeDefaults***REMOVED***=***REMOVED***mergeDefaults;
exports.mergeModels***REMOVED***=***REMOVED***mergeModels;
exports.mergeProps***REMOVED***=***REMOVED***mergeProps;
exports.nextTick***REMOVED***=***REMOVED***nextTick;
exports.onActivated***REMOVED***=***REMOVED***onActivated;
exports.onBeforeMount***REMOVED***=***REMOVED***onBeforeMount;
exports.onBeforeUnmount***REMOVED***=***REMOVED***onBeforeUnmount;
exports.onBeforeUpdate***REMOVED***=***REMOVED***onBeforeUpdate;
exports.onDeactivated***REMOVED***=***REMOVED***onDeactivated;
exports.onErrorCaptured***REMOVED***=***REMOVED***onErrorCaptured;
exports.onMounted***REMOVED***=***REMOVED***onMounted;
exports.onRenderTracked***REMOVED***=***REMOVED***onRenderTracked;
exports.onRenderTriggered***REMOVED***=***REMOVED***onRenderTriggered;
exports.onServerPrefetch***REMOVED***=***REMOVED***onServerPrefetch;
exports.onUnmounted***REMOVED***=***REMOVED***onUnmounted;
exports.onUpdated***REMOVED***=***REMOVED***onUpdated;
exports.openBlock***REMOVED***=***REMOVED***openBlock;
exports.popScopeId***REMOVED***=***REMOVED***popScopeId;
exports.provide***REMOVED***=***REMOVED***provide;
exports.pushScopeId***REMOVED***=***REMOVED***pushScopeId;
exports.queuePostFlushCb***REMOVED***=***REMOVED***queuePostFlushCb;
exports.registerRuntimeCompiler***REMOVED***=***REMOVED***registerRuntimeCompiler;
exports.renderList***REMOVED***=***REMOVED***renderList;
exports.renderSlot***REMOVED***=***REMOVED***renderSlot;
exports.resolveComponent***REMOVED***=***REMOVED***resolveComponent;
exports.resolveDirective***REMOVED***=***REMOVED***resolveDirective;
exports.resolveDynamicComponent***REMOVED***=***REMOVED***resolveDynamicComponent;
exports.resolveFilter***REMOVED***=***REMOVED***resolveFilter;
exports.resolveTransitionHooks***REMOVED***=***REMOVED***resolveTransitionHooks;
exports.setBlockTracking***REMOVED***=***REMOVED***setBlockTracking;
exports.setDevtoolsHook***REMOVED***=***REMOVED***setDevtoolsHook;
exports.setTransitionHooks***REMOVED***=***REMOVED***setTransitionHooks;
exports.ssrContextKey***REMOVED***=***REMOVED***ssrContextKey;
exports.ssrUtils***REMOVED***=***REMOVED***ssrUtils;
exports.toHandlers***REMOVED***=***REMOVED***toHandlers;
exports.transformVNodeArgs***REMOVED***=***REMOVED***transformVNodeArgs;
exports.useAttrs***REMOVED***=***REMOVED***useAttrs;
exports.useId***REMOVED***=***REMOVED***useId;
exports.useModel***REMOVED***=***REMOVED***useModel;
exports.useSSRContext***REMOVED***=***REMOVED***useSSRContext;
exports.useSlots***REMOVED***=***REMOVED***useSlots;
exports.useTemplateRef***REMOVED***=***REMOVED***useTemplateRef;
exports.useTransitionState***REMOVED***=***REMOVED***useTransitionState;
exports.version***REMOVED***=***REMOVED***version;
exports.warn***REMOVED***=***REMOVED***warn$1;
exports.watch***REMOVED***=***REMOVED***watch;
exports.watchEffect***REMOVED***=***REMOVED***watchEffect;
exports.watchPostEffect***REMOVED***=***REMOVED***watchPostEffect;
exports.watchSyncEffect***REMOVED***=***REMOVED***watchSyncEffect;
exports.withAsyncContext***REMOVED***=***REMOVED***withAsyncContext;
exports.withCtx***REMOVED***=***REMOVED***withCtx;
exports.withDefaults***REMOVED***=***REMOVED***withDefaults;
exports.withDirectives***REMOVED***=***REMOVED***withDirectives;
exports.withMemo***REMOVED***=***REMOVED***withMemo;
exports.withScopeId***REMOVED***=***REMOVED***withScopeId;
