...
**/
import***REMOVED***{***REMOVED***extend,***REMOVED***hasChanged,***REMOVED***isArray,***REMOVED***isIntegerKey,***REMOVED***isSymbol,***REMOVED***isMap,***REMOVED***hasOwn,***REMOVED***makeMap,***REMOVED***isObject,***REMOVED***capitalize,***REMOVED***toRawType,***REMOVED***def,***REMOVED***isFunction,***REMOVED***EMPTY_OBJ,***REMOVED***isSet,***REMOVED***isPlainObject,***REMOVED***remove,***REMOVED***NOOP***REMOVED***}***REMOVED***from***REMOVED***'@vue/shared';
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production"))***REMOVED***{
...
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***&&***REMOVED***!failSilently)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***&&***REMOVED***activeSub***REMOVED***!==***REMOVED***this)***REMOVED***{
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***&&***REMOVED***dep.subsHead***REMOVED***===***REMOVED***link)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***&&***REMOVED***activeSub.onTrack)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***&&***REMOVED***link.dep.subsHead***REMOVED***===***REMOVED***void***REMOVED***0)***REMOVED***{
...
***REMOVED******REMOVED***!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***?***REMOVED***"Object***REMOVED***iterate"***REMOVED***:***REMOVED***""
);
const***REMOVED***MAP_KEY_ITERATE_KEY***REMOVED***=***REMOVED***Symbol(
***REMOVED******REMOVED***!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***?***REMOVED***"Map***REMOVED***keys***REMOVED***iterate"***REMOVED***:***REMOVED***""
);
const***REMOVED***ARRAY_ITERATE_KEY***REMOVED***=***REMOVED***Symbol(
***REMOVED******REMOVED***!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***?***REMOVED***"Array***REMOVED***iterate"***REMOVED***:***REMOVED***""
);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production"))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production"))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***oldTarget***REMOVED***=***REMOVED***!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***?***REMOVED***isMap(target)***REMOVED***?***REMOVED***new***REMOVED***Map(target)***REMOVED***:***REMOVED***new***REMOVED***Set(target)***REMOVED***:***REMOVED***void***REMOVED***0;
...
***REMOVED******REMOVED***if***REMOVED***(!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***&&***REMOVED***!isProxy(object))***REMOVED***{
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***get***REMOVED***value()***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***link***REMOVED***=***REMOVED***!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***?***REMOVED***this.dep.track({
...
***REMOVED******REMOVED***if***REMOVED***(!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***&&***REMOVED***debugOptions***REMOVED***&&***REMOVED***!isSSR)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***&&***REMOVED***warnInvalidSource(s);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(isFunction(source))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***&&***REMOVED***warnInvalidSource(source);
***REMOVED******REMOVED***}
