export***REMOVED***const***REMOVED***xmlReplacer***REMOVED***=***REMOVED***/["&'<>$\x80-\uFFFF]/g;
const***REMOVED***xmlCodeMap***REMOVED***=***REMOVED***new***REMOVED***Map([
...
export***REMOVED***const***REMOVED***getCodePoint***REMOVED***=***REMOVED***
...
***REMOVED******REMOVED******REMOVED******REMOVED***?***REMOVED***(str,***REMOVED***index)***REMOVED***=>***REMOVED***str.codePointAt(index)
***REMOVED******REMOVED******REMOVED******REMOVED***:***REMOVED***//***REMOVED***http://mathiasbynens.be/notes/javascript-encoding#surrogate-formulae
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***(c,***REMOVED***index)***REMOVED***=>***REMOVED***(c.charCodeAt(index)***REMOVED***&***REMOVED***0xfc00)***REMOVED***===***REMOVED***0xd800
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***?***REMOVED***(c.charCodeAt(index)***REMOVED***-***REMOVED***0xd800)***REMOVED*******REMOVED***0x400***REMOVED***+
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***c.charCodeAt(index***REMOVED***+***REMOVED***1)***REMOVED***-
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***0xdc00***REMOVED***+
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***0x10000
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***:***REMOVED***c.charCodeAt(index);
/**
...
***REMOVED****/
export***REMOVED***function***REMOVED***encodeXML(str)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***while***REMOVED***((match***REMOVED***=***REMOVED***xmlReplacer.exec(str))***REMOVED***!==***REMOVED***null)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***next***REMOVED***=***REMOVED***xmlCodeMap.get(char);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ret***REMOVED***+=***REMOVED***`${str.substring(lastIdx,***REMOVED***i)}&#x${getCodePoint(str,***REMOVED***i).toString(16)};`;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***lastIdx***REMOVED***=***REMOVED***xmlReplacer.lastIndex***REMOVED***+=***REMOVED***Number((char***REMOVED***&***REMOVED***0xfc00)***REMOVED***===***REMOVED***0xd800);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED****/
export***REMOVED***const***REMOVED***escape***REMOVED***=***REMOVED***encodeXML;
/**
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***let***REMOVED***lastIdx***REMOVED***=***REMOVED***0;
...
***REMOVED*******REMOVED***@param***REMOVED***data***REMOVED***String***REMOVED***to***REMOVED***escape.
***REMOVED****/
export***REMOVED***const***REMOVED***escapeUTF8***REMOVED***=***REMOVED***getEscaper(/[&<>'"]/g,***REMOVED***xmlCodeMap);
/**
...
***REMOVED*******REMOVED***@param***REMOVED***data***REMOVED***String***REMOVED***to***REMOVED***escape.
***REMOVED****/
export***REMOVED***const***REMOVED***escapeAttribute***REMOVED***=***REMOVED***getEscaper(/["&\u00A0]/g,***REMOVED***new***REMOVED***Map([
***REMOVED******REMOVED******REMOVED******REMOVED***[34,***REMOVED***"&quot;"],
***REMOVED******REMOVED******REMOVED******REMOVED***[38,***REMOVED***"&amp;"],
...
***REMOVED*******REMOVED***@param***REMOVED***data***REMOVED***String***REMOVED***to***REMOVED***escape.
***REMOVED****/
export***REMOVED***const***REMOVED***escapeText***REMOVED***=***REMOVED***getEscaper(/[&<>\u00A0]/g,***REMOVED***new***REMOVED***Map([
***REMOVED******REMOVED******REMOVED******REMOVED***[38,***REMOVED***"&amp;"],
***REMOVED******REMOVED******REMOVED******REMOVED***[60,***REMOVED***"&lt;"],
***REMOVED******REMOVED******REMOVED******REMOVED***[62,***REMOVED***"&gt;"],
***REMOVED******REMOVED******REMOVED******REMOVED***[160,***REMOVED***"&nbsp;"],
