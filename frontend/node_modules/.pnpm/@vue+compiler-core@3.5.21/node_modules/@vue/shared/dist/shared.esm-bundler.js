...
const***REMOVED***EMPTY_OBJ***REMOVED***=***REMOVED***!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***?***REMOVED***Object.freeze({})***REMOVED***:***REMOVED***{};
const***REMOVED***EMPTY_ARR***REMOVED***=***REMOVED***!!(process.env.NODE_ENV***REMOVED***!==***REMOVED***"production")***REMOVED***?***REMOVED***Object.freeze([])***REMOVED***:***REMOVED***[];
...
export***REMOVED***{***REMOVED***EMPTY_ARR,***REMOVED***EMPTY_OBJ,***REMOVED***NO,***REMOVED***NOOP,***REMOVED***PatchFlagNames,***REMOVED***PatchFlags,***REMOVED***ShapeFlags,***REMOVED***SlotFlags,***REMOVED***camelize,***REMOVED***capitalize,***REMOVED***cssVarNameEscapeSymbolsRE,***REMOVED***def,***REMOVED***escapeHtml,***REMOVED***escapeHtmlComment,***REMOVED***extend,***REMOVED***genCacheKey,***REMOVED***genPropsAccessExp,***REMOVED***generateCodeFrame,***REMOVED***getEscapedCssVarName,***REMOVED***getGlobalThis,***REMOVED***hasChanged,***REMOVED***hasOwn,***REMOVED***hyphenate,***REMOVED***includeBooleanAttr,***REMOVED***invokeArrayFns,***REMOVED***isArray,***REMOVED***isBooleanAttr,***REMOVED***isBuiltInDirective,***REMOVED***isDate,***REMOVED***isFunction,***REMOVED***isGloballyAllowed,***REMOVED***isGloballyWhitelisted,***REMOVED***isHTMLTag,***REMOVED***isIntegerKey,***REMOVED***isKnownHtmlAttr,***REMOVED***isKnownMathMLAttr,***REMOVED***isKnownSvgAttr,***REMOVED***isMap,***REMOVED***isMathMLTag,***REMOVED***isModelListener,***REMOVED***isObject,***REMOVED***isOn,***REMOVED***isPlainObject,***REMOVED***isPromise,***REMOVED***isRegExp,***REMOVED***isRenderableAttrValue,***REMOVED***isReservedProp,***REMOVED***isSSRSafeAttrName,***REMOVED***isSVGTag,***REMOVED***isSet,***REMOVED***isSpecialBooleanAttr,***REMOVED***isString,***REMOVED***isSymbol,***REMOVED***isVoidTag,***REMOVED***looseEqual,***REMOVED***looseIndexOf,***REMOVED***looseToNumber,***REMOVED***makeMap,***REMOVED***normalizeClass,***REMOVED***normalizeCssVarValue,***REMOVED***normalizeProps,***REMOVED***normalizeStyle,***REMOVED***objectToString,***REMOVED***parseStringStyle,***REMOVED***propsToAttrMap,***REMOVED***remove,***REMOVED***slotFlagsText,***REMOVED***stringifyStyle,***REMOVED***toDisplayString,***REMOVED***toHandlerKey,***REMOVED***toNumber,***REMOVED***toRawType,***REMOVED***toTypeString***REMOVED***};
