/**
***REMOVED*******REMOVED***A***REMOVED***specialized***REMOVED***version***REMOVED***of***REMOVED***`_.forEachRight`***REMOVED***for***REMOVED***arrays***REMOVED***without***REMOVED***support***REMOVED***for
...
***REMOVED****/
function***REMOVED***arrayEachRight(array,***REMOVED***iteratee)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(iteratee(array[length],***REMOVED***length,***REMOVED***array)***REMOVED***===***REMOVED***false)***REMOVED***{
...
module.exports***REMOVED***=***REMOVED***arrayEachRight;
