...
var***REMOVED***rsAstral***REMOVED***=***REMOVED***'['***REMOVED***+***REMOVED***rsAstralRange***REMOVED***+***REMOVED***']',
...
var***REMOVED***reOptMod***REMOVED***=***REMOVED***rsModifier***REMOVED***+***REMOVED***'?',
...
/**
***REMOVED*******REMOVED***Gets***REMOVED***the***REMOVED***size***REMOVED***of***REMOVED***a***REMOVED***Unicode***REMOVED***`string`.
***REMOVED****
***REMOVED*******REMOVED***@private
***REMOVED*******REMOVED***@param***REMOVED***{string}***REMOVED***string***REMOVED***The***REMOVED***string***REMOVED***inspect.
***REMOVED*******REMOVED***@returns***REMOVED***{number}***REMOVED***Returns***REMOVED***the***REMOVED***string***REMOVED***size.
***REMOVED****/
function***REMOVED***unicodeSize(string)***REMOVED***{
***REMOVED******REMOVED***var***REMOVED***result***REMOVED***=***REMOVED***reUnicode.lastIndex***REMOVED***=***REMOVED***0;
***REMOVED******REMOVED***while***REMOVED***(reUnicode.test(string))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***++result;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***result;
}

module.exports***REMOVED***=***REMOVED***unicodeSize;
