...
/**
***REMOVED*******REMOVED***Checks***REMOVED***if***REMOVED***a***REMOVED***hash***REMOVED***value***REMOVED***for***REMOVED***`key`***REMOVED***exists.
***REMOVED****
***REMOVED*******REMOVED***@private
***REMOVED*******REMOVED***@name***REMOVED***has
...
***REMOVED****/
function***REMOVED***hashHas(key)***REMOVED***{
***REMOVED******REMOVED***var***REMOVED***data***REMOVED***=***REMOVED***this.__data__;
***REMOVED******REMOVED***return***REMOVED***nativeCreate***REMOVED***?***REMOVED***(data[key]***REMOVED***!==***REMOVED***undefined)***REMOVED***:***REMOVED***hasOwnProperty.call(data,***REMOVED***key);
}

module.exports***REMOVED***=***REMOVED***hashHas;
