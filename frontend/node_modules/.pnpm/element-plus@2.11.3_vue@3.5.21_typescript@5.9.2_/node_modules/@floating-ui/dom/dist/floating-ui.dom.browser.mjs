...
function***REMOVED***hasWindow()***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***typeof***REMOVED***window***REMOVED***!==***REMOVED***'undefined';
}
function***REMOVED***getNodeName(node)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(isNode(node))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***(node.nodeName***REMOVED***||***REMOVED***'').toLowerCase();
***REMOVED******REMOVED***}
***REMOVED******REMOVED***//***REMOVED***Mocked***REMOVED***nodes***REMOVED***in***REMOVED***testing***REMOVED***environments***REMOVED***may***REMOVED***not***REMOVED***be***REMOVED***instances***REMOVED***of***REMOVED***Node.***REMOVED***By
***REMOVED******REMOVED***//***REMOVED***returning***REMOVED***`#document`***REMOVED***an***REMOVED***infinite***REMOVED***loop***REMOVED***won't***REMOVED***occur.
***REMOVED******REMOVED***//***REMOVED***https://github.com/floating-ui/floating-ui/issues/2317
***REMOVED******REMOVED***return***REMOVED***'#document';
}
function***REMOVED***getWindow(node)***REMOVED***{
***REMOVED******REMOVED***var***REMOVED***_node$ownerDocument;
***REMOVED******REMOVED***return***REMOVED***(node***REMOVED***==***REMOVED***null***REMOVED***||***REMOVED***(_node$ownerDocument***REMOVED***=***REMOVED***node.ownerDocument)***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_node$ownerDocument.defaultView)***REMOVED***||***REMOVED***window;
}
function***REMOVED***getDocumentElement(node)***REMOVED***{
***REMOVED******REMOVED***var***REMOVED***_ref;
***REMOVED******REMOVED***return***REMOVED***(_ref***REMOVED***=***REMOVED***(isNode(node)***REMOVED***?***REMOVED***node.ownerDocument***REMOVED***:***REMOVED***node.document)***REMOVED***||***REMOVED***window.document)***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_ref.documentElement;
}
function***REMOVED***isNode(value)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(!hasWindow())***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***value***REMOVED***instanceof***REMOVED***Node***REMOVED***||***REMOVED***value***REMOVED***instanceof***REMOVED***getWindow(value).Node;
}
function***REMOVED***isElement(value)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(!hasWindow())***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***value***REMOVED***instanceof***REMOVED***Element***REMOVED***||***REMOVED***value***REMOVED***instanceof***REMOVED***getWindow(value).Element;
}
function***REMOVED***isHTMLElement(value)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(!hasWindow())***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***value***REMOVED***instanceof***REMOVED***HTMLElement***REMOVED***||***REMOVED***value***REMOVED***instanceof***REMOVED***getWindow(value).HTMLElement;
}
function***REMOVED***isShadowRoot(value)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(!hasWindow()***REMOVED***||***REMOVED***typeof***REMOVED***ShadowRoot***REMOVED***===***REMOVED***'undefined')***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***false;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***value***REMOVED***instanceof***REMOVED***ShadowRoot***REMOVED***||***REMOVED***value***REMOVED***instanceof***REMOVED***getWindow(value).ShadowRoot;
}
const***REMOVED***invalidOverflowDisplayValues***REMOVED***=***REMOVED***/*#__PURE__*/new***REMOVED***Set(['inline',***REMOVED***'contents']);
function***REMOVED***isOverflowElement(element)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***overflow,
***REMOVED******REMOVED******REMOVED******REMOVED***overflowX,
***REMOVED******REMOVED******REMOVED******REMOVED***overflowY,
***REMOVED******REMOVED******REMOVED******REMOVED***display
***REMOVED******REMOVED***}***REMOVED***=***REMOVED***getComputedStyle$1(element);
***REMOVED******REMOVED***return***REMOVED***/auto|scroll|overlay|hidden|clip/.test(overflow***REMOVED***+***REMOVED***overflowY***REMOVED***+***REMOVED***overflowX)***REMOVED***&&***REMOVED***!invalidOverflowDisplayValues.has(display);
}
const***REMOVED***tableElements***REMOVED***=***REMOVED***/*#__PURE__*/new***REMOVED***Set(['table',***REMOVED***'td',***REMOVED***'th']);
function***REMOVED***isTableElement(element)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***tableElements.has(getNodeName(element));
}
const***REMOVED***topLayerSelectors***REMOVED***=***REMOVED***[':popover-open',***REMOVED***':modal'];
function***REMOVED***isTopLayer(element)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***topLayerSelectors.some(selector***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***try***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***element.matches(selector);
...
const***REMOVED***transformProperties***REMOVED***=***REMOVED***['transform',***REMOVED***'translate',***REMOVED***'scale',***REMOVED***'rotate',***REMOVED***'perspective'];
const***REMOVED***willChangeValues***REMOVED***=***REMOVED***['transform',***REMOVED***'translate',***REMOVED***'scale',***REMOVED***'rotate',***REMOVED***'perspective',***REMOVED***'filter'];
const***REMOVED***containValues***REMOVED***=***REMOVED***['paint',***REMOVED***'layout',***REMOVED***'strict',***REMOVED***'content'];
function***REMOVED***isContainingBlock(elementOrCss)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***webkit***REMOVED***=***REMOVED***isWebKit();
***REMOVED******REMOVED***const***REMOVED***css***REMOVED***=***REMOVED***isElement(elementOrCss)***REMOVED***?***REMOVED***getComputedStyle$1(elementOrCss)***REMOVED***:***REMOVED***elementOrCss;

***REMOVED******REMOVED***//***REMOVED***https://developer.mozilla.org/en-US/docs/Web/CSS/Containing_block#identifying_the_containing_block
***REMOVED******REMOVED***//***REMOVED***https://drafts.csswg.org/css-transforms-2/#individual-transforms
***REMOVED******REMOVED***return***REMOVED***transformProperties.some(value***REMOVED***=>***REMOVED***css[value]***REMOVED***?***REMOVED***css[value]***REMOVED***!==***REMOVED***'none'***REMOVED***:***REMOVED***false)***REMOVED***||***REMOVED***(css.containerType***REMOVED***?***REMOVED***css.containerType***REMOVED***!==***REMOVED***'normal'***REMOVED***:***REMOVED***false)***REMOVED***||***REMOVED***!webkit***REMOVED***&&***REMOVED***(css.backdropFilter***REMOVED***?***REMOVED***css.backdropFilter***REMOVED***!==***REMOVED***'none'***REMOVED***:***REMOVED***false)***REMOVED***||***REMOVED***!webkit***REMOVED***&&***REMOVED***(css.filter***REMOVED***?***REMOVED***css.filter***REMOVED***!==***REMOVED***'none'***REMOVED***:***REMOVED***false)***REMOVED***||***REMOVED***willChangeValues.some(value***REMOVED***=>***REMOVED***(css.willChange***REMOVED***||***REMOVED***'').includes(value))***REMOVED***||***REMOVED***containValues.some(value***REMOVED***=>***REMOVED***(css.contain***REMOVED***||***REMOVED***'').includes(value));
}
function***REMOVED***getContainingBlock(element)***REMOVED***{
***REMOVED******REMOVED***let***REMOVED***currentNode***REMOVED***=***REMOVED***getParentNode(element);
***REMOVED******REMOVED***while***REMOVED***(isHTMLElement(currentNode)***REMOVED***&&***REMOVED***!isLastTraversableNode(currentNode))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isContainingBlock(currentNode))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***currentNode;
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(isTopLayer(currentNode))***REMOVED***{
...
function***REMOVED***isWebKit()***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(typeof***REMOVED***CSS***REMOVED***===***REMOVED***'undefined'***REMOVED***||***REMOVED***!CSS.supports)***REMOVED***return***REMOVED***false;
***REMOVED******REMOVED***return***REMOVED***CSS.supports('-webkit-backdrop-filter',***REMOVED***'none');
}
const***REMOVED***lastTraversableNodeNames***REMOVED***=***REMOVED***/*#__PURE__*/new***REMOVED***Set(['html',***REMOVED***'body',***REMOVED***'#document']);
function***REMOVED***isLastTraversableNode(node)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***lastTraversableNodeNames.has(getNodeName(node));
}
function***REMOVED***getComputedStyle$1(element)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***getWindow(element).getComputedStyle(element);
}
function***REMOVED***getNodeScroll(element)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(isElement(element))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***scrollLeft:***REMOVED***element.scrollLeft,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***scrollTop:***REMOVED***element.scrollTop
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***scrollLeft:***REMOVED***element.scrollX,
***REMOVED******REMOVED******REMOVED******REMOVED***scrollTop:***REMOVED***element.scrollY
***REMOVED******REMOVED***};
}
function***REMOVED***getParentNode(node)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(getNodeName(node)***REMOVED***===***REMOVED***'html')***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***node;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***result***REMOVED***=
***REMOVED******REMOVED***//***REMOVED***Step***REMOVED***into***REMOVED***the***REMOVED***shadow***REMOVED***DOM***REMOVED***of***REMOVED***the***REMOVED***parent***REMOVED***of***REMOVED***a***REMOVED***slotted***REMOVED***node.
***REMOVED******REMOVED***node.assignedSlot***REMOVED***||
***REMOVED******REMOVED***//***REMOVED***DOM***REMOVED***Element***REMOVED***detected.
***REMOVED******REMOVED***node.parentNode***REMOVED***||
***REMOVED******REMOVED***//***REMOVED***ShadowRoot***REMOVED***detected.
***REMOVED******REMOVED***isShadowRoot(node)***REMOVED***&&***REMOVED***node.host***REMOVED***||
***REMOVED******REMOVED***//***REMOVED***Fallback.
***REMOVED******REMOVED***getDocumentElement(node);
***REMOVED******REMOVED***return***REMOVED***isShadowRoot(result)***REMOVED***?***REMOVED***result.host***REMOVED***:***REMOVED***result;
}
function***REMOVED***getNearestOverflowAncestor(node)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***parentNode***REMOVED***=***REMOVED***getParentNode(node);
***REMOVED******REMOVED***if***REMOVED***(isLastTraversableNode(parentNode))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***node.ownerDocument***REMOVED***?***REMOVED***node.ownerDocument.body***REMOVED***:***REMOVED***node.body;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(isHTMLElement(parentNode)***REMOVED***&&***REMOVED***isOverflowElement(parentNode))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***parentNode;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***getNearestOverflowAncestor(parentNode);
}
function***REMOVED***getOverflowAncestors(node,***REMOVED***list,***REMOVED***traverseIframes)***REMOVED***{
***REMOVED******REMOVED***var***REMOVED***_node$ownerDocument2;
***REMOVED******REMOVED***if***REMOVED***(list***REMOVED***===***REMOVED***void***REMOVED***0)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***list***REMOVED***=***REMOVED***[];
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(traverseIframes***REMOVED***===***REMOVED***void***REMOVED***0)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***traverseIframes***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***scrollableAncestor***REMOVED***=***REMOVED***getNearestOverflowAncestor(node);
***REMOVED******REMOVED***const***REMOVED***isBody***REMOVED***=***REMOVED***scrollableAncestor***REMOVED***===***REMOVED***((_node$ownerDocument2***REMOVED***=***REMOVED***node.ownerDocument)***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_node$ownerDocument2.body);
***REMOVED******REMOVED***const***REMOVED***win***REMOVED***=***REMOVED***getWindow(scrollableAncestor);
***REMOVED******REMOVED***if***REMOVED***(isBody)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***frameElement***REMOVED***=***REMOVED***getFrameElement(win);
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***list.concat(win,***REMOVED***win.visualViewport***REMOVED***||***REMOVED***[],***REMOVED***isOverflowElement(scrollableAncestor)***REMOVED***?***REMOVED***scrollableAncestor***REMOVED***:***REMOVED***[],***REMOVED***frameElement***REMOVED***&&***REMOVED***traverseIframes***REMOVED***?***REMOVED***getOverflowAncestors(frameElement)***REMOVED***:***REMOVED***[]);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***list.concat(scrollableAncestor,***REMOVED***getOverflowAncestors(scrollableAncestor,***REMOVED***[],***REMOVED***traverseIframes));
}
function***REMOVED***getFrameElement(win)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***win.parent***REMOVED***&&***REMOVED***Object.getPrototypeOf(win.parent)***REMOVED***?***REMOVED***win.frameElement***REMOVED***:***REMOVED***null;
}
...
export***REMOVED***{***REMOVED***arrow,***REMOVED***autoPlacement,***REMOVED***autoUpdate,***REMOVED***computePosition,***REMOVED***detectOverflow,***REMOVED***flip,***REMOVED***getOverflowAncestors,***REMOVED***hide,***REMOVED***inline,***REMOVED***limitShift,***REMOVED***offset,***REMOVED***platform,***REMOVED***shift,***REMOVED***size***REMOVED***};
