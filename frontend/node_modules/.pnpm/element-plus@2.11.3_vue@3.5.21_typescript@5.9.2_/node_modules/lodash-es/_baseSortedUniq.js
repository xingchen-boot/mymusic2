...
/**
***REMOVED*******REMOVED***The***REMOVED***base***REMOVED***implementation***REMOVED***of***REMOVED***`_.sortedUniq`***REMOVED***and***REMOVED***`_.sortedUniqBy`***REMOVED***without
...
***REMOVED****/
function***REMOVED***baseSortedUniq(array,***REMOVED***iteratee)***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!index***REMOVED***||***REMOVED***!eq(computed,***REMOVED***seen))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***seen***REMOVED***=***REMOVED***computed;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***result[resIndex++]***REMOVED***=***REMOVED***value***REMOVED***===***REMOVED***0***REMOVED***?***REMOVED***0***REMOVED***:***REMOVED***value;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***result;
}

export***REMOVED***default***REMOVED***baseSortedUniq;
