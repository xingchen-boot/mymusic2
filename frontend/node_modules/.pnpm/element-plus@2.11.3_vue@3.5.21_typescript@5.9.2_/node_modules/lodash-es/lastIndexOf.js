import***REMOVED***baseFindIndex***REMOVED***from***REMOVED***'./_baseFindIndex.js';
import***REMOVED***baseIsNaN***REMOVED***from***REMOVED***'./_baseIsNaN.js';
import***REMOVED***strictLastIndexOf***REMOVED***from***REMOVED***'./_strictLastIndexOf.js';
...
/**
***REMOVED*******REMOVED***This***REMOVED***method***REMOVED***is***REMOVED***like***REMOVED***`_.indexOf`***REMOVED***except***REMOVED***that***REMOVED***it***REMOVED***iterates***REMOVED***over***REMOVED***elements***REMOVED***of
***REMOVED*******REMOVED***`array`***REMOVED***from***REMOVED***right***REMOVED***to***REMOVED***left.
***REMOVED****
...
***REMOVED****
***REMOVED*******REMOVED***_.lastIndexOf([1,***REMOVED***2,***REMOVED***1,***REMOVED***2],***REMOVED***2);
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***3
***REMOVED****
***REMOVED*******REMOVED***//***REMOVED***Search***REMOVED***from***REMOVED***the***REMOVED***`fromIndex`.
***REMOVED*******REMOVED***_.lastIndexOf([1,***REMOVED***2,***REMOVED***1,***REMOVED***2],***REMOVED***2,***REMOVED***2);
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***1
***REMOVED****/
function***REMOVED***lastIndexOf(array,***REMOVED***value,***REMOVED***fromIndex)***REMOVED***{
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***var***REMOVED***index***REMOVED***=***REMOVED***length;
...
***REMOVED******REMOVED******REMOVED******REMOVED***index***REMOVED***=***REMOVED***index***REMOVED***<***REMOVED***0***REMOVED***?***REMOVED***nativeMax(length***REMOVED***+***REMOVED***index,***REMOVED***0)***REMOVED***:***REMOVED***nativeMin(index,***REMOVED***length***REMOVED***-***REMOVED***1);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***value***REMOVED***===***REMOVED***value
***REMOVED******REMOVED******REMOVED******REMOVED***?***REMOVED***strictLastIndexOf(array,***REMOVED***value,***REMOVED***index)
***REMOVED******REMOVED******REMOVED******REMOVED***:***REMOVED***baseFindIndex(array,***REMOVED***baseIsNaN,***REMOVED***index,***REMOVED***true);
}

export***REMOVED***default***REMOVED***lastIndexOf;
