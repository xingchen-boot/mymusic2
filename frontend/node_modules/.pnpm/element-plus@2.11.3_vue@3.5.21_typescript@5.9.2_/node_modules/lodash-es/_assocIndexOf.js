...
/**
***REMOVED*******REMOVED***Gets***REMOVED***the***REMOVED***index***REMOVED***at***REMOVED***which***REMOVED***the***REMOVED***`key`***REMOVED***is***REMOVED***found***REMOVED***in***REMOVED***`array`***REMOVED***of***REMOVED***key-value***REMOVED***pairs.
***REMOVED****
...
***REMOVED*******REMOVED***@param***REMOVED***{*}***REMOVED***key***REMOVED***The***REMOVED***key***REMOVED***to***REMOVED***search***REMOVED***for.
...
***REMOVED****/
function***REMOVED***assocIndexOf(array,***REMOVED***key)***REMOVED***{
***REMOVED******REMOVED***var***REMOVED***length***REMOVED***=***REMOVED***array.length;
***REMOVED******REMOVED***while***REMOVED***(length--)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(eq(array[length][0],***REMOVED***key))***REMOVED***{
...
export***REMOVED***default***REMOVED***assocIndexOf;
