import***REMOVED***{***REMOVED***computed,***REMOVED***unref,***REMOVED***shallowRef,***REMOVED***ref,***REMOVED***watch,***REMOVED***onBeforeUnmount***REMOVED***}***REMOVED***from***REMOVED***'vue';
...
const***REMOVED***usePopper***REMOVED***=***REMOVED***(referenceElementRef,***REMOVED***popperElementRef,***REMOVED***opts***REMOVED***=***REMOVED***{})***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***options***REMOVED***=***REMOVED***computed(()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***instanceRef***REMOVED***=***REMOVED***shallowRef();
***REMOVED******REMOVED***const***REMOVED***states***REMOVED***=***REMOVED***ref({
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!instanceRef.value)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED***instanceRef.value.destroy();
***REMOVED******REMOVED******REMOVED******REMOVED***instanceRef.value***REMOVED***=***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED***};
***REMOVED******REMOVED***watch(options,***REMOVED***(newOptions)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***instance***REMOVED***=***REMOVED***unref(instanceRef);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(instance)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance.setOptions(newOptions);
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***},***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***deep:***REMOVED***true
***REMOVED******REMOVED***});
***REMOVED******REMOVED***watch([referenceElementRef,***REMOVED***popperElementRef],***REMOVED***([referenceElement,***REMOVED***popperElement])***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***destroy();
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!referenceElement***REMOVED***||***REMOVED***!popperElement)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return;
***REMOVED******REMOVED******REMOVED******REMOVED***instanceRef.value***REMOVED***=***REMOVED***createPopper(referenceElement,***REMOVED***popperElement,***REMOVED***unref(options));
***REMOVED******REMOVED***});
***REMOVED******REMOVED***onBeforeUnmount(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***destroy();
***REMOVED******REMOVED***});
***REMOVED******REMOVED***return***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***state:***REMOVED***computed(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***{***REMOVED***...((_a***REMOVED***=***REMOVED***unref(instanceRef))***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_a.state)***REMOVED***||***REMOVED***{}***REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***}),
...
***REMOVED******REMOVED******REMOVED******REMOVED***update:***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***(_a***REMOVED***=***REMOVED***unref(instanceRef))***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_a.update();
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***forceUpdate:***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***(_a***REMOVED***=***REMOVED***unref(instanceRef))***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_a.forceUpdate();
***REMOVED******REMOVED******REMOVED******REMOVED***},
***REMOVED******REMOVED******REMOVED******REMOVED***instanceRef:***REMOVED***computed(()***REMOVED***=>***REMOVED***unref(instanceRef))
***REMOVED******REMOVED***};
};
function***REMOVED***deriveState(state)***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***elements***REMOVED***=***REMOVED***Object.keys(state.elements);
***REMOVED******REMOVED***const***REMOVED***styles***REMOVED***=***REMOVED***fromPairs(elements.map((element)***REMOVED***=>***REMOVED***[element,***REMOVED***state.styles[element]***REMOVED***||***REMOVED***{}]));
***REMOVED******REMOVED***const***REMOVED***attributes***REMOVED***=***REMOVED***fromPairs(elements.map((element)***REMOVED***=>***REMOVED***[element,***REMOVED***state.attributes[element]]));
***REMOVED******REMOVED***return***REMOVED***{
...
export***REMOVED***{***REMOVED***usePopper***REMOVED***};
