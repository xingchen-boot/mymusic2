import***REMOVED***{***REMOVED***createVNode,***REMOVED***render,***REMOVED***isVNode***REMOVED***}***REMOVED***from***REMOVED***'vue';
import***REMOVED***{***REMOVED***merge,***REMOVED***flatMap,***REMOVED***castArray,***REMOVED***get,***REMOVED***isNull***REMOVED***}***REMOVED***from***REMOVED***'lodash-unified';
import***REMOVED***{***REMOVED***ElTooltip***REMOVED***}***REMOVED***from***REMOVED***'../../tooltip/index.mjs';
import***REMOVED***{***REMOVED***isArray,***REMOVED***isString,***REMOVED***isFunction,***REMOVED***hasOwn,***REMOVED***isObject***REMOVED***}***REMOVED***from***REMOVED***'@vue/shared';
import***REMOVED***{***REMOVED***throwError***REMOVED***}***REMOVED***from***REMOVED***'../../../utils/error.mjs';
import***REMOVED***{***REMOVED***isUndefined,***REMOVED***isNumber,***REMOVED***isBoolean***REMOVED***}***REMOVED***from***REMOVED***'../../../utils/types.mjs';
import***REMOVED***{***REMOVED***getProp***REMOVED***}***REMOVED***from***REMOVED***'../../../utils/objects.mjs';
...
***REMOVED******REMOVED***if***REMOVED***(!sortKey***REMOVED***&&***REMOVED***!sortMethod***REMOVED***&&***REMOVED***(!sortBy***REMOVED***||***REMOVED***isArray(sortBy)***REMOVED***&&***REMOVED***!sortBy.length))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***array;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(isString(reverse))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***flatMap(castArray(sortBy),***REMOVED***(by)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isString(by))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***get(value,***REMOVED***by);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isObject(value)***REMOVED***&&***REMOVED***"$value"***REMOVED***in***REMOVED***value)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***value***REMOVED***=***REMOVED***value.$value;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***[
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***isObject(value)***REMOVED***?***REMOVED***sortKey***REMOVED***?***REMOVED***get(value,***REMOVED***sortKey)***REMOVED***:***REMOVED***null***REMOVED***:***REMOVED***value
***REMOVED******REMOVED******REMOVED******REMOVED***];
***REMOVED******REMOVED***};
...
***REMOVED******REMOVED******REMOVED******REMOVED***throwError("ElTable",***REMOVED***`No***REMOVED***column***REMOVED***matching***REMOVED***with***REMOVED***column-key:***REMOVED***${columnKey}`);
***REMOVED******REMOVED***return***REMOVED***column;
};
...
***REMOVED******REMOVED***if***REMOVED***(isString(rowKey))***REMOVED***{
...
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(isFunction(rowKey))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(hasOwn(config,***REMOVED***key))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***value***REMOVED***=***REMOVED***config[key];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!isUndefined(value))***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(!isUndefined(width))***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(!isUndefined(minWidth))***REMOVED***{
...
***REMOVED******REMOVED***if***REMOVED***(isNumber(height))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***height;
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(isString(height))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(children***REMOVED***&&***REMOVED***isArray(children))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isBoolean(newVal))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(!(tableTreeProps***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***tableTreeProps.checkStrictly)***REMOVED***&&***REMOVED***(tableTreeProps***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***tableTreeProps.children)***REMOVED***&&***REMOVED***isArray(row[tableTreeProps.children]))***REMOVED***{
...
***REMOVED******REMOVED***const***REMOVED***isNil***REMOVED***=***REMOVED***(array)***REMOVED***=>***REMOVED***!(isArray(array)***REMOVED***&&***REMOVED***array.length);
...
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***tooltipFormatterContent***REMOVED***=***REMOVED***isFunction(column***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***column.tooltipFormatter)***REMOVED***?***REMOVED***column.tooltipFormatter({
***REMOVED******REMOVED******REMOVED******REMOVED***row,
***REMOVED******REMOVED******REMOVED******REMOVED***column,
***REMOVED******REMOVED******REMOVED******REMOVED***cellValue:***REMOVED***getProp(row,***REMOVED***column.property).value
***REMOVED******REMOVED***})***REMOVED***:***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED***if***REMOVED***(isVNode(tooltipFormatterContent))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***{
...
let***REMOVED***removePopper***REMOVED***=***REMOVED***null;
...
***REMOVED******REMOVED***};
***REMOVED******REMOVED***if***REMOVED***((removePopper***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***removePopper.trigger)***REMOVED***===***REMOVED***trigger)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***comp***REMOVED***=***REMOVED***(_a***REMOVED***=***REMOVED***removePopper.vm)***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_a.component;
***REMOVED******REMOVED******REMOVED******REMOVED***merge(comp***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***comp.props,***REMOVED***mergedProps);
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***removePopper***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***removePopper();
...
***REMOVED******REMOVED***const***REMOVED***vm***REMOVED***=***REMOVED***createVNode(ElTooltip,***REMOVED***{
...
***REMOVED******REMOVED***removePopper***REMOVED***=***REMOVED***()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***currentRemovePopper***REMOVED***=***REMOVED***removePopper;
...
***REMOVED******REMOVED******REMOVED******REMOVED***removePopper***REMOVED***=***REMOVED***null;
***REMOVED******REMOVED***};
***REMOVED******REMOVED***removePopper.trigger***REMOVED***=***REMOVED***trigger***REMOVED***!=***REMOVED***null***REMOVED***?***REMOVED***trigger***REMOVED***:***REMOVED***void***REMOVED***0;
***REMOVED******REMOVED***removePopper.vm***REMOVED***=***REMOVED***vm;
***REMOVED******REMOVED***scrollContainer***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***scrollContainer.addEventListener("scroll",***REMOVED***removePopper);
}
function***REMOVED***getCurrentColumns(column)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(column.children)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***flatMap(column.children,***REMOVED***getCurrentColumns);
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
...
***REMOVED******REMOVED***return***REMOVED***offset***REMOVED***+***REMOVED***(isNull(column.realWidth)***REMOVED***||***REMOVED***Number.isNaN(column.realWidth)***REMOVED***?***REMOVED***Number(column.width)***REMOVED***:***REMOVED***column.realWidth);
}
...
export***REMOVED***{***REMOVED***compose,***REMOVED***createTablePopper,***REMOVED***ensurePosition,***REMOVED***getCell,***REMOVED***getColumnByCell,***REMOVED***getColumnById,***REMOVED***getColumnByKey,***REMOVED***getFixedColumnOffset,***REMOVED***getFixedColumnsClass,***REMOVED***getKeysMap,***REMOVED***getRowIdentity,***REMOVED***isFixedColumn,***REMOVED***mergeOptions,***REMOVED***orderBy,***REMOVED***parseHeight,***REMOVED***parseMinWidth,***REMOVED***parseWidth,***REMOVED***removePopper,***REMOVED***toggleRowStatus,***REMOVED***walkTreeNode***REMOVED***};
//#***REMOVED***sourceMappingURL=util.mjs.map
