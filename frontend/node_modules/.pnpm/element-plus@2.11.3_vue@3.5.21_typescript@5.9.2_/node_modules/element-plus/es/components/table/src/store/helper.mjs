...
import***REMOVED***useStore***REMOVED***from***REMOVED***'./index.mjs';
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***store***REMOVED***=***REMOVED***useStore();
...
***REMOVED******REMOVED***Object.keys(InitialStateMap).forEach((key)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***watch(()***REMOVED***=>***REMOVED***getArrKeysValue(props,***REMOVED***key),***REMOVED***(value)***REMOVED***=>***REMOVED***{
...
export***REMOVED***{***REMOVED***createStore***REMOVED***};
