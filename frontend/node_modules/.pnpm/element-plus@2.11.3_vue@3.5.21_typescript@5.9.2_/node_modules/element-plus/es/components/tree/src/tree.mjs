import***REMOVED***{***REMOVED***defineComponent,***REMOVED***inject,***REMOVED***ref,***REMOVED***computed,***REMOVED***watch,***REMOVED***provide,***REMOVED***getCurrentInstance,***REMOVED***resolveComponent,***REMOVED***openBlock,***REMOVED***createElementBlock,***REMOVED***normalizeClass,***REMOVED***Fragment,***REMOVED***renderList,***REMOVED***createBlock,***REMOVED***renderSlot,***REMOVED***createElementVNode,***REMOVED***toDisplayString,***REMOVED***createCommentVNode,***REMOVED***withDirectives,***REMOVED***vShow***REMOVED***}***REMOVED***from***REMOVED***'vue';
import***REMOVED***{***REMOVED***selectKey***REMOVED***}***REMOVED***from***REMOVED***'../../select/src/token.mjs';
import***REMOVED***TreeStore***REMOVED***from***REMOVED***'./model/tree-store.mjs';
import***REMOVED***{***REMOVED***getNodeKey,***REMOVED***handleCurrentChange***REMOVED***}***REMOVED***from***REMOVED***'./model/util.mjs';
import***REMOVED***ElTreeNode***REMOVED***from***REMOVED***'./tree-node.mjs';
import***REMOVED***{***REMOVED***useNodeExpandEventBroadcast***REMOVED***}***REMOVED***from***REMOVED***'./model/useNodeExpandEventBroadcast.mjs';
import***REMOVED***{***REMOVED***useDragNodeHandler***REMOVED***}***REMOVED***from***REMOVED***'./model/useDragNode.mjs';
import***REMOVED***{***REMOVED***useKeydown***REMOVED***}***REMOVED***from***REMOVED***'./model/useKeydown.mjs';
import***REMOVED***{***REMOVED***ROOT_TREE_INJECTION_KEY***REMOVED***}***REMOVED***from***REMOVED***'./tokens.mjs';
...
import***REMOVED***{***REMOVED***definePropType***REMOVED***}***REMOVED***from***REMOVED***'../../../utils/vue/props/runtime.mjs';
...
import***REMOVED***{***REMOVED***formItemContextKey***REMOVED***}***REMOVED***from***REMOVED***'../../form/src/constants.mjs';

const***REMOVED***_sfc_main***REMOVED***=***REMOVED***defineComponent({
***REMOVED******REMOVED***name:***REMOVED***"ElTree",
***REMOVED******REMOVED***components:***REMOVED***{***REMOVED***ElTreeNode***REMOVED***},
***REMOVED******REMOVED***props:***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***data:***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***type:***REMOVED***definePropType(Array),
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***type:***REMOVED***definePropType(Function)
***REMOVED******REMOVED******REMOVED******REMOVED***},
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***type:***REMOVED***iconPropType
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***},
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***ns***REMOVED***=***REMOVED***useNamespace("tree");
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***selectInfo***REMOVED***=***REMOVED***inject(selectKey,***REMOVED***null);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***store***REMOVED***=***REMOVED***ref(new***REMOVED***TreeStore({
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***root***REMOVED***=***REMOVED***ref(store.value.root);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***currentNode***REMOVED***=***REMOVED***ref(null);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***el$***REMOVED***=***REMOVED***ref(null);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***dropIndicator$***REMOVED***=***REMOVED***ref(null);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***broadcastExpanded***REMOVED***}***REMOVED***=***REMOVED***useNodeExpandEventBroadcast(props);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***{***REMOVED***dragState***REMOVED***}***REMOVED***=***REMOVED***useDragNodeHandler({
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***useKeydown({***REMOVED***el$***REMOVED***},***REMOVED***store);
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isEmpty***REMOVED***=***REMOVED***computed(()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***watch(()***REMOVED***=>***REMOVED***props.currentNodeKey,***REMOVED***(newVal)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***watch(()***REMOVED***=>***REMOVED***props.defaultCheckedKeys,***REMOVED***(newVal,***REMOVED***oldVal)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***watch(()***REMOVED***=>***REMOVED***props.defaultExpandedKeys,***REMOVED***(newVal)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***watch(()***REMOVED***=>***REMOVED***props.data,***REMOVED***(newVal)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***watch(()***REMOVED***=>***REMOVED***props.checkStrictly,***REMOVED***(newVal)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***getNodeKey$1***REMOVED***=***REMOVED***(node)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***getNodeKey(props.nodeKey,***REMOVED***node.data);
***REMOVED******REMOVED******REMOVED******REMOVED***};
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***handleCurrentChange(store,***REMOVED***ctx.emit,***REMOVED***()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***provide(ROOT_TREE_INJECTION_KEY,***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***ctx,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***props,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***store,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***root,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***currentNode,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***instance:***REMOVED***getCurrentInstance()
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***provide(formItemContextKey,***REMOVED***void***REMOVED***0);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***getNodeKey:***REMOVED***getNodeKey$1,
...
***REMOVED******REMOVED***const***REMOVED***_component_el_tree_node***REMOVED***=***REMOVED***resolveComponent("el-tree-node");
...
***REMOVED******REMOVED******REMOVED******REMOVED***(openBlock(true),***REMOVED***createElementBlock(Fragment,***REMOVED***null,***REMOVED***renderList(_ctx.root.childNodes,***REMOVED***(child)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***openBlock(),***REMOVED***createBlock(_component_el_tree_node,***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***_ctx.isEmpty***REMOVED***?***REMOVED***(openBlock(),***REMOVED***createElementBlock("div",***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***key:***REMOVED***0,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***class:***REMOVED***normalizeClass(_ctx.ns.e("empty-block"))
***REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***[
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***renderSlot(_ctx.$slots,***REMOVED***"empty",***REMOVED***{},***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***[
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***createElementVNode("span",***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***class:***REMOVED***normalizeClass(_ctx.ns.e("empty-text"))
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***toDisplayString((_a***REMOVED***=***REMOVED***_ctx.emptyText)***REMOVED***!=***REMOVED***null***REMOVED***?***REMOVED***_a***REMOVED***:***REMOVED***_ctx.t("el.tree.emptyText")),***REMOVED***3)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***];
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***})
***REMOVED******REMOVED******REMOVED******REMOVED***],***REMOVED***2))***REMOVED***:***REMOVED***createCommentVNode("v-if",***REMOVED***true),
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***class:***REMOVED***normalizeClass(_ctx.ns.e("drop-indicator"))
***REMOVED******REMOVED******REMOVED******REMOVED***},***REMOVED***null,***REMOVED***2),***REMOVED***[
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***[vShow,***REMOVED***_ctx.dragState.showDropIndicator]
***REMOVED******REMOVED******REMOVED******REMOVED***])
***REMOVED******REMOVED***],***REMOVED***2);
}
var***REMOVED***Tree***REMOVED***=***REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***_export_sfc(_sfc_main,***REMOVED***[["render",***REMOVED***_sfc_render],***REMOVED***["__file",***REMOVED***"tree.vue"]]);

export***REMOVED***{***REMOVED***Tree***REMOVED***as***REMOVED***default***REMOVED***};
