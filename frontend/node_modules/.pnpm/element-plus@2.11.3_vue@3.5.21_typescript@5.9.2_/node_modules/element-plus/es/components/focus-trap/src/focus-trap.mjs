import***REMOVED***{***REMOVED***defineComponent,***REMOVED***ref,***REMOVED***provide,***REMOVED***watch,***REMOVED***unref,***REMOVED***onMounted,***REMOVED***onBeforeUnmount,***REMOVED***nextTick,***REMOVED***renderSlot***REMOVED***}***REMOVED***from***REMOVED***'vue';
import***REMOVED***{***REMOVED***isNil***REMOVED***}***REMOVED***from***REMOVED***'lodash-unified';
import***REMOVED***{***REMOVED***useFocusReason,***REMOVED***tryFocus,***REMOVED***createFocusOutPreventedEvent,***REMOVED***getEdges,***REMOVED***focusableStack,***REMOVED***focusFirstDescendant,***REMOVED***obtainAllFocusableElements,***REMOVED***isFocusCausedByUserEvent***REMOVED***}***REMOVED***from***REMOVED***'./utils.mjs';
import***REMOVED***{***REMOVED***ON_TRAP_FOCUS_EVT,***REMOVED***ON_RELEASE_FOCUS_EVT,***REMOVED***FOCUS_TRAP_INJECTION_KEY,***REMOVED***FOCUS_AFTER_TRAPPED,***REMOVED***FOCUS_AFTER_TRAPPED_OPTS,***REMOVED***FOCUS_AFTER_RELEASED***REMOVED***}***REMOVED***from***REMOVED***'./tokens.mjs';
import***REMOVED***_export_sfc***REMOVED***from***REMOVED***'../../../_virtual/plugin-vue_export-helper.mjs';
import***REMOVED***{***REMOVED***useEscapeKeydown***REMOVED***}***REMOVED***from***REMOVED***'../../../hooks/use-escape-keydown/index.mjs';
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***forwardRef***REMOVED***=***REMOVED***ref();
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***isTabbing***REMOVED***=***REMOVED***code***REMOVED***===***REMOVED***EVENT_CODE.tab***REMOVED***&&***REMOVED***!altKey***REMOVED***&&***REMOVED***!ctrlKey***REMOVED***&&***REMOVED***!metaKey;
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***tryFocus(first,***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***e.preventDefault();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(loop)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***tryFocus(last,***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED***watch(()***REMOVED***=>***REMOVED***props.focusTrapEl,***REMOVED***(focusTrapEl)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***watch([forwardRef],***REMOVED***([forwardRef2],***REMOVED***[oldForwardRef])***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***};
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***releaseOnFocus***REMOVED***=***REMOVED***(e)***REMOVED***=>***REMOVED***emit(ON_RELEASE_FOCUS_EVT,***REMOVED***e);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***focusEvent***REMOVED***=***REMOVED***new***REMOVED***Event(FOCUS_AFTER_TRAPPED,***REMOVED***FOCUS_AFTER_TRAPPED_OPTS);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***focusFirstDescendant(obtainAllFocusableElements(trapContainer),***REMOVED***true);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!releasedEvent.defaultPrevented***REMOVED***&&***REMOVED***(focusReason.value***REMOVED***==***REMOVED***"keyboard"***REMOVED***||***REMOVED***!isFocusCausedByUserEvent()***REMOVED***||***REMOVED***trapContainer.contains(document.activeElement)))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***tryFocus(lastFocusBeforeTrapped***REMOVED***!=***REMOVED***null***REMOVED***?***REMOVED***lastFocusBeforeTrapped***REMOVED***:***REMOVED***document.body);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***watch(()***REMOVED***=>***REMOVED***props.trapped,***REMOVED***(trapped)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED***return***REMOVED***renderSlot(_ctx.$slots,***REMOVED***"default",***REMOVED***{***REMOVED***handleKeydown:***REMOVED***_ctx.onKeydown***REMOVED***});
}
var***REMOVED***ElFocusTrap***REMOVED***=***REMOVED***/****REMOVED***@__PURE__***REMOVED****/***REMOVED***_export_sfc(_sfc_main,***REMOVED***[["render",***REMOVED***_sfc_render],***REMOVED***["__file",***REMOVED***"focus-trap.vue"]]);

export***REMOVED***{***REMOVED***ElFocusTrap***REMOVED***as***REMOVED***default***REMOVED***};
//#***REMOVED***sourceMappingURL=focus-trap.mjs.map
