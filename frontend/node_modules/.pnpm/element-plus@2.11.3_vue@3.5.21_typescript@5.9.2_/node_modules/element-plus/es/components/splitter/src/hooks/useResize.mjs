...
import***REMOVED***{***REMOVED***isPct,***REMOVED***getPct,***REMOVED***isPx,***REMOVED***getPx***REMOVED***}***REMOVED***from***REMOVED***'./useSize.mjs';
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(isPct(str))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***ptg2px(getPct(str));
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***if***REMOVED***(isPx(str))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***getPx(str);
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***lazyOffset***REMOVED***=***REMOVED***ref(0);
***REMOVED******REMOVED***const***REMOVED***movingIndex***REMOVED***=***REMOVED***ref(null);
***REMOVED******REMOVED***let***REMOVED***cachePxSizes***REMOVED***=***REMOVED***[];
***REMOVED******REMOVED***let***REMOVED***updatePanelSizes***REMOVED***=***REMOVED***NOOP;
***REMOVED******REMOVED***const***REMOVED***limitSizes***REMOVED***=***REMOVED***computed(()***REMOVED***=>***REMOVED***panels.value.map((item)***REMOVED***=>***REMOVED***[item.min,***REMOVED***item.max]));
***REMOVED******REMOVED***watch(lazy,***REMOVED***()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***updatePanelSizes***REMOVED***=***REMOVED***NOOP;
***REMOVED******REMOVED******REMOVED******REMOVED***};
...
export***REMOVED***{***REMOVED***useResize***REMOVED***};
//#***REMOVED***sourceMappingURL=useResize.mjs.map
