import***REMOVED***{***REMOVED***inject,***REMOVED***computed***REMOVED***}***REMOVED***from***REMOVED***'vue';
import***REMOVED***{***REMOVED***TABLE_INJECTION_KEY***REMOVED***}***REMOVED***from***REMOVED***'../tokens.mjs';

const***REMOVED***getAllColumns***REMOVED***=***REMOVED***(columns)***REMOVED***=>***REMOVED***{
...
const***REMOVED***convertToRows***REMOVED***=***REMOVED***(originColumns)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***let***REMOVED***maxLevel***REMOVED***=***REMOVED***1;
***REMOVED******REMOVED***const***REMOVED***traverse***REMOVED***=***REMOVED***(column,***REMOVED***parent)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***traverse(column,***REMOVED***void***REMOVED***0);
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***rows***REMOVED***=***REMOVED***[];
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***allColumns***REMOVED***=***REMOVED***getAllColumns(originColumns);
...
function***REMOVED***useUtils(props)***REMOVED***{
...
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***toggleAllSelection***REMOVED***=***REMOVED***(event)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***event.stopPropagation();
***REMOVED******REMOVED******REMOVED******REMOVED***parent***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***parent.store.commit("toggleAllSelection");
***REMOVED******REMOVED***};
...
export***REMOVED***{***REMOVED***convertToRows,***REMOVED***useUtils***REMOVED***as***REMOVED***default***REMOVED***};
//#***REMOVED***sourceMappingURL=utils-helper.mjs.map
