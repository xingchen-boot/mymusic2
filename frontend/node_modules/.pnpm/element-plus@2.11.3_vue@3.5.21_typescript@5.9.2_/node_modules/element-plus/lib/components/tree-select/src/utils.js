...
***REMOVED******REMOVED***return***REMOVED***shared.isArray(val)***REMOVED***&&***REMOVED***val.length;
}
function***REMOVED***toValidArray(val)***REMOVED***{
***REMOVED******REMOVED***return***REMOVED***shared.isArray(val)***REMOVED***?***REMOVED***val***REMOVED***:***REMOVED***isValidValue(val)***REMOVED***?***REMOVED***[val]***REMOVED***:***REMOVED***[];
}
...
exports.isValidArray***REMOVED***=***REMOVED***isValidArray;
exports.isValidValue***REMOVED***=***REMOVED***isValidValue;
exports.toValidArray***REMOVED***=***REMOVED***toValidArray;
exports.treeEach***REMOVED***=***REMOVED***treeEach;
exports.treeFind***REMOVED***=***REMOVED***treeFind;
