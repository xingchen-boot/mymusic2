...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***nodes***REMOVED***=***REMOVED***(data***REMOVED***||***REMOVED***[]).map((nodeData)***REMOVED***=>***REMOVED***new***REMOVED***node["default"](nodeData,***REMOVED***this.config));
...
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***node$1***REMOVED***=***REMOVED***parentNode***REMOVED***?***REMOVED***parentNode.appendChild(nodeData)***REMOVED***:***REMOVED***new***REMOVED***node["default"](nodeData,***REMOVED***this.config);
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!parentNode)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***this.nodes.push(node$1);
***REMOVED******REMOVED******REMOVED******REMOVED***this.appendAllNodesAndLeafNodes(node$1);
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(types.isPropAbsent(value))
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***node***REMOVED***=***REMOVED***this.getFlattedNodes(leafOnly).find((node2)***REMOVED***=>***REMOVED***lodashUnified.isEqual(node2.value,***REMOVED***value)***REMOVED***||***REMOVED***lodashUnified.isEqual(node2.pathValues,***REMOVED***value));
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***null;
***REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***node_***REMOVED***=***REMOVED***this.getFlattedNodes(false).find(({***REMOVED***value,***REMOVED***level***REMOVED***})***REMOVED***=>***REMOVED***lodashUnified.isEqual(node.value,***REMOVED***value)***REMOVED***&&***REMOVED***node.level***REMOVED***===***REMOVED***level);
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***node_***REMOVED***||***REMOVED***null;
***REMOVED******REMOVED***}
}

exports["default"]***REMOVED***=***REMOVED***Store;
//#***REMOVED***sourceMappingURL=store.js.map
