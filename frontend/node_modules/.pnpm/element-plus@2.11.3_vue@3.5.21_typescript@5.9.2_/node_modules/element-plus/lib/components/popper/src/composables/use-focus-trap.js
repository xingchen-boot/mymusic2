...
const***REMOVED***usePopperContentFocusTrap***REMOVED***=***REMOVED***(props,***REMOVED***emit)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED***const***REMOVED***trapped***REMOVED***=***REMOVED***vue.ref(false);
***REMOVED******REMOVED***const***REMOVED***focusStartRef***REMOVED***=***REMOVED***vue.ref();
...
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***onFocusAfterReleased***REMOVED***=***REMOVED***(event)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(((_a***REMOVED***=***REMOVED***event.detail)***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_a.focusReason)***REMOVED***!==***REMOVED***"pointer")***REMOVED***{
...
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***onFocusInTrap***REMOVED***=***REMOVED***(event)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***focusStartRef.value***REMOVED***=***REMOVED***event.target;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***trapped.value***REMOVED***=***REMOVED***true;
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***onFocusoutPrevented***REMOVED***=***REMOVED***(event)***REMOVED***=>***REMOVED***{
...
exports.usePopperContentFocusTrap***REMOVED***=***REMOVED***usePopperContentFocusTrap;
//#***REMOVED***sourceMappingURL=use-focus-trap.js.map
