...
var***REMOVED***loading***REMOVED***=***REMOVED***require('./loading.js');
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***const***REMOVED***instance***REMOVED***=***REMOVED***loading.createLoadingComponent({
...
***REMOVED******REMOVED***vue.nextTick(()***REMOVED***=>***REMOVED***instance.visible.value***REMOVED***=***REMOVED***resolved.visible);
...
***REMOVED******REMOVED***if***REMOVED***(shared.isString(options.target))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***instance.originalPosition.value***REMOVED***=***REMOVED***style.getStyle(document.body,***REMOVED***"position");
***REMOVED******REMOVED******REMOVED******REMOVED***instance.originalOverflow.value***REMOVED***=***REMOVED***style.getStyle(document.body,***REMOVED***"overflow");
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***maskStyle[property]***REMOVED***=***REMOVED***`${options.target.getBoundingClientRect()[property]***REMOVED***+***REMOVED***document.body[scroll]***REMOVED***+***REMOVED***document.documentElement[scroll]***REMOVED***-***REMOVED***Number.parseInt(style.getStyle(document.body,***REMOVED***`margin-${property}`),***REMOVED***10)}px`;
***REMOVED******REMOVED******REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***instance.originalPosition.value***REMOVED***=***REMOVED***style.getStyle(parent,***REMOVED***"position");
***REMOVED******REMOVED***}
...
***REMOVED******REMOVED******REMOVED******REMOVED***style.addClass(parent,***REMOVED***ns.bm("parent",***REMOVED***"relative"));
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***style.removeClass(parent,***REMOVED***ns.bm("parent",***REMOVED***"relative"));
***REMOVED******REMOVED***}
***REMOVED******REMOVED***if***REMOVED***(options.fullscreen***REMOVED***&&***REMOVED***options.lock)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***style.addClass(parent,***REMOVED***ns.bm("parent",***REMOVED***"hidden"));
***REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***style.removeClass(parent,***REMOVED***ns.bm("parent",***REMOVED***"hidden"));
***REMOVED******REMOVED***}
};
Loading._context***REMOVED***=***REMOVED***null;

exports["default"]***REMOVED***=***REMOVED***Loading;
//#***REMOVED***sourceMappingURL=service.js.map
