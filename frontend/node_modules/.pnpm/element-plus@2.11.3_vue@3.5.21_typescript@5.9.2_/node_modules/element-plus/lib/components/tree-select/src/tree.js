...
var***REMOVED***index***REMOVED***=***REMOVED***require('../../tree/index.js');
var***REMOVED***treeSelectOption***REMOVED***=***REMOVED***require('./tree-select-option.js');
...
***REMOVED******REMOVED***vue.watch([()***REMOVED***=>***REMOVED***props.modelValue,***REMOVED***tree],***REMOVED***()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(props.showCheckbox)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vue.nextTick(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***treeInstance***REMOVED***=***REMOVED***tree.value;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(treeInstance***REMOVED***&&***REMOVED***!lodashUnified.isEqual(treeInstance.getCheckedKeys(),***REMOVED***utils.toValidArray(props.modelValue)))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***treeInstance.setCheckedKeys(utils.toValidArray(props.modelValue));
...
***REMOVED******REMOVED***});
***REMOVED******REMOVED***const***REMOVED***propsMap***REMOVED***=***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***({
...
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(shared.isFunction(propVal))***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***defaultExpandedParentKeys***REMOVED***=***REMOVED***utils.toValidArray(props.modelValue).map((value)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***utils.treeFind(props.data***REMOVED***||***REMOVED***[],***REMOVED***(data)***REMOVED***=>***REMOVED***getNodeValByProp("value",***REMOVED***data)***REMOVED***===***REMOVED***value,***REMOVED***(data)***REMOVED***=>***REMOVED***getNodeValByProp("children",***REMOVED***data),***REMOVED***(data,***REMOVED***index,***REMOVED***array,***REMOVED***parent)***REMOVED***=>***REMOVED***parent***REMOVED***&&***REMOVED***getNodeValByProp("value",***REMOVED***parent));
***REMOVED******REMOVED***}).filter((item)***REMOVED***=>***REMOVED***utils.isValidValue(item));
***REMOVED******REMOVED***const***REMOVED***cacheOptions***REMOVED***=***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***utils.treeEach(props.data.concat(props.cacheData),***REMOVED***(node)***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***!lodashUnified.isNil(node)***REMOVED***&&***REMOVED***types.isEmpty(node.childNodes);
***REMOVED******REMOVED******REMOVED******REMOVED***});
***REMOVED******REMOVED***};
***REMOVED******REMOVED***return***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***...lodashUnified.pick(vue.toRefs(props),***REMOVED***Object.keys(index.ElTree.props)),
***REMOVED******REMOVED******REMOVED******REMOVED***...attrs,
***REMOVED******REMOVED******REMOVED******REMOVED***nodeKey:***REMOVED***key,
***REMOVED******REMOVED******REMOVED******REMOVED***expandOnClickNode:***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED***}),
***REMOVED******REMOVED******REMOVED******REMOVED***defaultExpandedKeys:***REMOVED***vue.computed(()***REMOVED***=>***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***h(treeSelectOption["default"],***REMOVED***{
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***regexp***REMOVED***=***REMOVED***new***REMOVED***RegExp(strings.escapeStringRegexp(value),***REMOVED***"i");
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***utils.treeEach([tree.value.store.root],***REMOVED***(node)***REMOVED***=>***REMOVED***dataMap[node.key]***REMOVED***=***REMOVED***node,***REMOVED***(node)***REMOVED***=>***REMOVED***node.childNodes);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***uncachedCheckedKeys***REMOVED***=***REMOVED***params.checkedKeys;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***cachedKeys***REMOVED***=***REMOVED***props.multiple***REMOVED***?***REMOVED***utils.toValidArray(props.modelValue).filter((item)***REMOVED***=>***REMOVED***!(item***REMOVED***in***REMOVED***dataMap)***REMOVED***&&***REMOVED***!uncachedCheckedKeys.includes(item))***REMOVED***:***REMOVED***[];
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***emit(event.UPDATE_MODEL_EVENT,***REMOVED***props.multiple***REMOVED***?***REMOVED***checkedKeys***REMOVED***:***REMOVED***checkedKeys.includes(dataValue)***REMOVED***?***REMOVED***dataValue***REMOVED***:***REMOVED***void***REMOVED***0);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***emit(event.UPDATE_MODEL_EVENT,***REMOVED***cachedKeys.concat(childKeys));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***else***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***firstLeaf***REMOVED***=***REMOVED***utils.treeFind([data],***REMOVED***(data2)***REMOVED***=>***REMOVED***!utils.isValidArray(getNodeValByProp("children",***REMOVED***data2))***REMOVED***&&***REMOVED***!getNodeValByProp("disabled",***REMOVED***data2),***REMOVED***(data2)***REMOVED***=>***REMOVED***getNodeValByProp("children",***REMOVED***data2));
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***hasCheckedChild***REMOVED***=***REMOVED***utils.isValidValue(props.modelValue)***REMOVED***&&***REMOVED***!!utils.treeFind([data],***REMOVED***(data2)***REMOVED***=>***REMOVED***getNodeValByProp("value",***REMOVED***data2)***REMOVED***===***REMOVED***props.modelValue,***REMOVED***(data2)***REMOVED***=>***REMOVED***getNodeValByProp("children",***REMOVED***data2));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***emit(event.UPDATE_MODEL_EVENT,***REMOVED***firstLeafKey***REMOVED***===***REMOVED***props.modelValue***REMOVED***||***REMOVED***hasCheckedChild***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***firstLeafKey);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vue.nextTick(()***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a2;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***checkedKeys2***REMOVED***=***REMOVED***utils.toValidArray(props.modelValue);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***utils.treeEach([tree.value.store.root],***REMOVED***(node2)***REMOVED***=>***REMOVED***dataMap[node2.key]***REMOVED***=***REMOVED***node2,***REMOVED***(node2)***REMOVED***=>***REMOVED***node2.childNodes);
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***cachedKeys***REMOVED***=***REMOVED***utils.toValidArray(props.modelValue).filter((item)***REMOVED***=>***REMOVED***!(item***REMOVED***in***REMOVED***dataMap)***REMOVED***&&***REMOVED***!uncachedCheckedKeys.includes(item));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***const***REMOVED***childKeys***REMOVED***=***REMOVED***getChildCheckedKeys();
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***emit(event.UPDATE_MODEL_EVENT,***REMOVED***cachedKeys.concat(childKeys));
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***});
...
exports.useTree***REMOVED***=***REMOVED***useTree;
