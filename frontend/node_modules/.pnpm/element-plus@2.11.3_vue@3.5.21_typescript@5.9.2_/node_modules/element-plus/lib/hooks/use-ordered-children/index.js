...
***REMOVED******REMOVED***const***REMOVED***nodes***REMOVED***=***REMOVED***vnode.flattedChildren(vm.subTree).filter((n)***REMOVED***=>***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***var***REMOVED***_a;
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***vue.isVNode(n)***REMOVED***&&***REMOVED***((_a***REMOVED***=***REMOVED***n.type)***REMOVED***==***REMOVED***null***REMOVED***?***REMOVED***void***REMOVED***0***REMOVED***:***REMOVED***_a.name)***REMOVED***===***REMOVED***childComponentName***REMOVED***&&***REMOVED***!!n.component;
***REMOVED******REMOVED***});
...
***REMOVED******REMOVED***const***REMOVED***children***REMOVED***=***REMOVED***vue.shallowRef({});
***REMOVED******REMOVED***const***REMOVED***orderedChildren***REMOVED***=***REMOVED***vue.shallowRef([]);
...
***REMOVED******REMOVED******REMOVED******REMOVED***vue.triggerRef(children);
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***vue.triggerRef(children);
...
***REMOVED******REMOVED***};
***REMOVED******REMOVED***const***REMOVED***ChildrenSorter***REMOVED***=***REMOVED***vue.defineComponent({
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***slots.default***REMOVED***?***REMOVED***vue.h(IsolatedRenderer,***REMOVED***{
...
exports.useOrderedChildren***REMOVED***=***REMOVED***useOrderedChildren;
