...
import***REMOVED***nativeKeysIn***REMOVED***from***REMOVED***'./_nativeKeysIn.js';
...
/**
***REMOVED*******REMOVED***The***REMOVED***base***REMOVED***implementation***REMOVED***of***REMOVED***`_.keysIn`***REMOVED***which***REMOVED***doesn't***REMOVED***treat***REMOVED***sparse***REMOVED***arrays***REMOVED***as***REMOVED***dense.
***REMOVED****
...
***REMOVED****/
function***REMOVED***baseKeysIn(object)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(!isObject(object))***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***nativeKeysIn(object);
***REMOVED******REMOVED***}
***REMOVED******REMOVED***var***REMOVED***isProto***REMOVED***=***REMOVED***isPrototype(object),
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***result***REMOVED***=***REMOVED***[];

***REMOVED******REMOVED***for***REMOVED***(var***REMOVED***key***REMOVED***in***REMOVED***object)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***(!(key***REMOVED***==***REMOVED***'constructor'***REMOVED***&&***REMOVED***(isProto***REMOVED***||***REMOVED***!hasOwnProperty.call(object,***REMOVED***key))))***REMOVED***{
...
export***REMOVED***default***REMOVED***baseKeysIn;
