...
/**
***REMOVED*******REMOVED***Converts***REMOVED***`func`***REMOVED***to***REMOVED***its***REMOVED***source***REMOVED***code.
***REMOVED****
...
***REMOVED*******REMOVED***@returns***REMOVED***{string}***REMOVED***Returns***REMOVED***the***REMOVED***source***REMOVED***code.
***REMOVED****/
function***REMOVED***toSource(func)***REMOVED***{
***REMOVED******REMOVED***if***REMOVED***(func***REMOVED***!=***REMOVED***null)***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED***try***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***funcToString.call(func);
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***catch***REMOVED***(e)***REMOVED***{}
***REMOVED******REMOVED******REMOVED******REMOVED***try***REMOVED***{
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***return***REMOVED***(func***REMOVED***+***REMOVED***'');
***REMOVED******REMOVED******REMOVED******REMOVED***}***REMOVED***catch***REMOVED***(e)***REMOVED***{}
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***'';
}

export***REMOVED***default***REMOVED***toSource;
