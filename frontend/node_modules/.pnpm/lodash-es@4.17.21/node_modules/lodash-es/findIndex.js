...
/**
***REMOVED*******REMOVED***This***REMOVED***method***REMOVED***is***REMOVED***like***REMOVED***`_.find`***REMOVED***except***REMOVED***that***REMOVED***it***REMOVED***returns***REMOVED***the***REMOVED***index***REMOVED***of***REMOVED***the***REMOVED***first
...
***REMOVED*******REMOVED***];
***REMOVED****
***REMOVED*******REMOVED***_.findIndex(users,***REMOVED***function(o)***REMOVED***{***REMOVED***return***REMOVED***o.user***REMOVED***==***REMOVED***'barney';***REMOVED***});
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***0
***REMOVED****
***REMOVED*******REMOVED***//***REMOVED***The***REMOVED***`_.matches`***REMOVED***iteratee***REMOVED***shorthand.
***REMOVED*******REMOVED***_.findIndex(users,***REMOVED***{***REMOVED***'user':***REMOVED***'fred',***REMOVED***'active':***REMOVED***false***REMOVED***});
...
***REMOVED*******REMOVED***_.findIndex(users,***REMOVED***['active',***REMOVED***false]);
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***0
***REMOVED****
***REMOVED*******REMOVED***//***REMOVED***The***REMOVED***`_.property`***REMOVED***iteratee***REMOVED***shorthand.
***REMOVED*******REMOVED***_.findIndex(users,***REMOVED***'active');
***REMOVED*******REMOVED***//***REMOVED***=>***REMOVED***2
***REMOVED****/
function***REMOVED***findIndex(array,***REMOVED***predicate,***REMOVED***fromIndex)***REMOVED***{
...
***REMOVED******REMOVED***}
***REMOVED******REMOVED***return***REMOVED***baseFindIndex(array,***REMOVED***baseIteratee(predicate,***REMOVED***3),***REMOVED***index);
}

export***REMOVED***default***REMOVED***findIndex;
