import***REMOVED***baseSetData***REMOVED***from***REMOVED***'./_baseSetData.js';
import***REMOVED***createBind***REMOVED***from***REMOVED***'./_createBind.js';
import***REMOVED***createCurry***REMOVED***from***REMOVED***'./_createCurry.js';
import***REMOVED***createHybrid***REMOVED***from***REMOVED***'./_createHybrid.js';
import***REMOVED***createPartial***REMOVED***from***REMOVED***'./_createPartial.js';
import***REMOVED***getData***REMOVED***from***REMOVED***'./_getData.js';
import***REMOVED***mergeData***REMOVED***from***REMOVED***'./_mergeData.js';
import***REMOVED***setData***REMOVED***from***REMOVED***'./_setData.js';
import***REMOVED***setWrapToString***REMOVED***from***REMOVED***'./_setWrapToString.js';
...
export***REMOVED***default***REMOVED***createWrap;
